...
#define MyAppName "PROSOFT"
#define MyAppVersion "G.CR421"
#define MyAppPublisher "TECHNICAL APPLIED SOLUTIONS"
#define MyAppURL "http://www.dpite.com/"
#define MyAppExeName "Prosoft.exe"

[Setup]
; NOTE: The value of AppId uniquely identifies this application.
; Do not use the same AppId value in installers for other applications.
; (To generate a new GUID, click Tools | Generate GUID inside the IDE.)
AppId={{3D21B770-9157-4A81-8ADE-B2D7D7102390}
AppName={#MyAppName}
...
LicenseFile=C:\Users\mrzazz\Source\Repos\LProSoft\InvAcc\bin\finalsetup\src\licence.txt
...
[Files]                       
Source: "C:\Users\mrzazz\Source\Repos\LProSoft\InvAcc\bin\Debug\Prosoft.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "C:\Users\mrzazz\Source\Repos\LProSoft\InvAcc\bin\Debug\*"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs
...
#ifdef UseNetCoreCheck
Source: "netcorecheck.exe"; Flags: dontcopy noencryption
Source: "vers.exe"; Flags: dontcopy noencryption
Source: "netcorecheck_x64.exe"; Flags: dontcopy noencryption
#endif
...
[Run]
Filename: "{app}\{#MyAppExeName}"; Verb: runas; Description: "{cm:LaunchProgram,{#StringChange(MyAppName, '&', '&&')}}"; Flags: postinstall nowait  shellexec  runascurrentuser skipifsilent
Filename: "{app}\vers.exe"; Description: "versiong"; 
Filename:"{app}\systemreq\FRNetDemo.com.msi" ;Description: "fast report"; Verb: open; Flags: shellexec postinstall waituntilterminated runascurrentuser skipifsilent
Filename: "{app}\systemreq\crystal2007.msi" ;Description:"cr 2013"; Verb: open; Flags: shellexec postinstall waituntilterminated runascurrentuser skipifsilent
Filename: "{app}\systemreq\crystal2008.msi"; Description:"2008"; Verb: open; Flags: shellexec postinstall waituntilterminated runascurrentuser skipifsilent
Filename: "{app}\systemreq\crystal2007.msi" ;Description:"2007 runtim"; Verb: open; Flags: shellexec postinstall waituntilterminated runascurrentuser skipifsilent
  
[Registry]
Root: "HKLM"; Subkey: "SOFTWARE\Microsoft\Windows NT\CurrentVersion\AppCompatFlags\Layers"; ValueType: string; ValueName: "{app}\PROSOFT.exe"; ValueData: "RUNASADMIN"; Flags: uninsdeletekeyifempty uninsdeletevalue
...
var
  Version: String;
  PackedVersion: Int64;
begin{F564B19F-2DB0-48DF-9787-36122F2353A7}
  // https://www.microsoft.com/en-US/download/details.aspx?id=30438
  if not RegQueryStringValue(HKLM, 'SOFTWARE\Microsoft\Microsoft SQL Server\MSSQL10_50.prosoft\MSSQLServer\CurrentVersion', 'CurrentVersion', Version) or not StrToVersion(Version, PackedVersion) or (ComparePackedVersion(PackedVersion, PackVersionComponents(10, 50, 4000, 0)) < 0) then begin
    Dependency_Add('sql2008express' + Dependency_ArchSuffix + '.exe',
      '/QS /IACCEPTSQLSERVERLICENSETERMS /ACTION=INSTALL /FEATURES=SQL,TOOLS /INSTANCENAME=prosoft /SQLSVCACCOUNT="NT AUTHORITY\Network Service" /SQLSYSADMINACCOUNTS="builtin\Administrators" /INDICATEPROGRESS /TCPENABLED=1 /BROWSERSVCSTARTUPTYPE=Automatic /ERRORREPORTING=0 /SQMREPORTING=0 /SECURITYMODE=SQL /SAPWD=Prosoft@prosoft&ma89',
