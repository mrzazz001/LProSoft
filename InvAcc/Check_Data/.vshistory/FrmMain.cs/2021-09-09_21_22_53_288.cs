...
EXEC sp_msforeachtable 'DELETE ?'";
    ...
    private void CreateNewBranch(Stock_DataDataContext dbc, string vBr)
    {
        ...
        string script2 = (InvAcc.Properties.Resources.DbScript.Replace("PROSOFT", VarGeneral.DBNo.Replace("DBPROSOFT", "PROSOFT") + "_" + vBr).Replace("Path1", Application.StartupPath + "\\PROSOFT.mdf").Replace("Path2", Application.StartupPath + "\\PROSOFT_log.ldf"));
        string sqlConnectionString = "Server=" + VarGeneral.gServerName + ";Database=;UID=" + VarGeneral.UsrName + ";PWD=" + VarGeneral.Qut + VarGeneral.UsrPass + VarGeneral.Qut;
