...
#pragma warning disable CS0414 // The field 'VarGeneral.c' is assigned but its value is never used
        string c = ".";
#pragma warning restore CS0414 // The field 'VarGeneral.c' is assigned but its value is never used
        ...
        public static bool IsBackPOSButtonOn { 
            
            get {

                Stock_DataDataContext db = new Stock_DataDataContext(BranchCS);

                return VarGeneral.TString.ChkStatShow(db.SystemSettingStock().Seting, 88) ; }
        ...
        public static int Dy2(string Dat, string Tim)
        {
            ...
            if (!VarGeneral.CheckDate(Dat))
                return num1;
#pragma warning disable CS0219 // The variable 'dateTime1' is assigned but its value is never used
            DateTime dateTime1 = new DateTime();
#pragma warning restore CS0219 // The variable 'dateTime1' is assigned but its value is never used
        ...
        static int DeleteOptions = 0;
        public static int DeleteOption { get {

                if (File.Exists(Application.StartupPath + "\\Script\\deloption.dll"))
                {
                    DeleteOptions = 1;
                }
                else
        ...
        public static string TaxAccNo { get; internal set; }
        public static string DateCreated_Bills { get; internal set; }
        public static string Bill_Number { get; internal set; }
        static string _Export_Bill_Name;
        public static string Export_Bill_Name {
            get
            {
                return _Export_Bill_Name.Replace(" ", "_").Replace("/", "_");
...
set {
                _Export_Bill_Name = value;



            } }

        public static int canedit { get; internal set; }
        public static int ifdelete { get; internal set; }
        public static int ifadd { get; internal set; }

        public static char Qut = '"';
        public static char Qut2 = '"';
        internal static bool labelItem_RegVisible;
        internal static HijriGreg.HijriGregDates n;
        internal static int txtcountvalue;
        ...
        public class TString
        {
            ...
            internal static bool ChkStatShow(string emp_FilStr, object ifadd)
            {
