...
{
    public partial class FrmRepVisa : Form
    {
        ...
        private void RibunButtons()
        {
            if (VarGeneral.CurrentLang.ToString() == "0" || VarGeneral.CurrentLang.ToString() == string.Empty)
            {
                ...
                Text = "تقرير تأشيرة الخروج والعودة";
            }
            else
            {
                ...
                Text = "Visa Go and Back Report";
            }
        }
        private void FrmRepVisa_Load(object sender, EventArgs e)
        {
            try
            {
                ComponentResourceManager resources = new ComponentResourceManager(typeof(FrmRepVisa));
                if (VarGeneral.CurrentLang.ToString() == "0" || VarGeneral.CurrentLang.ToString() == string.Empty)
                {
                ...
                RibunButtons();
                FillGrid();
                var q = (from t in db.T_VisaGoBacks
                         orderby t.VisaBeginDate, t.VisaEndDate
                         where t.VisaBeginDate != string.Empty
                         select new
                         {
                             t.VisaBeginDate,
                             t.VisaEndDate
                ...
                {
                    dateTimeInput_StartVacationFrom.Text = Convert.ToDateTime(q.First().VisaBeginDate).ToString("yyyy/MM/dd");
                    dateTimeInput_EndVacationFrom.Text = Convert.ToDateTime(q.Last().VisaBeginDate).ToString("yyyy/MM/dd");
                    dateTimeInput_StartVacationTo.Text = Convert.ToDateTime(q.First().VisaEndDate).ToString("yyyy/MM/dd");
                    dateTimeInput_EndVacationTo.Text = Convert.ToDateTime(q.Last().VisaEndDate).ToString("yyyy/MM/dd");
                }
            }
        ...
        private void FrmRepVisa_KeyPress(object sender, KeyPressEventArgs e)
        {
            if (e.KeyChar == '\r')
            {
                SendKeys.Send("{Tab}");
        ...
        private void FrmRepVisa_KeyDown(object sender, KeyEventArgs e)
        {
        ...
        {
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(InvAcc.Forms.FrmRepVisa));
            ...
            base.Name = "FrmRepVisa";
            base.Load += new System.EventHandler(FrmRepVisa_Load);
            base.KeyPress += new System.Windows.Forms.KeyPressEventHandler(FrmRepVisa_KeyPress);
            base.KeyDown += new System.Windows.Forms.KeyEventHandler(FrmRepVisa_KeyDown);
