...
{
    public partial class FrmRepProject : Form
    {
        ...
        private MaskedTextBox dateTimeInput_RewardTo;
        private MaskedTextBox dateTimeInput_RewardFrom;
        ...
        {
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(InvAcc.Forms.FrmRepProject));
            ...
            dateTimeInput_RewardTo = new System.Windows.Forms.MaskedTextBox();
            dateTimeInput_RewardFrom = new System.Windows.Forms.MaskedTextBox();
            label3 = new System.Windows.Forms.Label();
            label4 = new System.Windows.Forms.Label();
            groupBox1 = new System.Windows.Forms.GroupBox();
            comboBox_Days = new DevComponents.DotNetBar.Controls.ComboBoxEx();
            ...
            groupBox_Date.Controls.Add(dateTimeInput_RewardTo);
            groupBox_Date.Controls.Add(dateTimeInput_RewardFrom);
            ...
            resources.ApplyResources(dateTimeInput_RewardTo, "dateTimeInput_RewardTo");
            dateTimeInput_RewardTo.Name = "dateTimeInput_RewardTo";
            dateTimeInput_RewardTo.Leave += new System.EventHandler(dateTimeInput_DisTo_Leave);
            dateTimeInput_RewardTo.Click += new System.EventHandler(dateTimeInput_AddTo_Click);
            resources.ApplyResources(dateTimeInput_RewardFrom, "dateTimeInput_RewardFrom");
            dateTimeInput_RewardFrom.Name = "dateTimeInput_RewardFrom";
            dateTimeInput_RewardFrom.Leave += new System.EventHandler(dateTimeInput_DisFrom_Leave);
            dateTimeInput_RewardFrom.Click += new System.EventHandler(dateTimeInput_AddFrom_Click);
            ...
            groupBox1.Controls.Add(comboBox_Days);
            resources.ApplyResources(groupBox1, "groupBox1");
            groupBox1.Name = "groupBox1";
            groupBox1.TabStop = false;
            comboBox_Days.AutoCompleteSource = System.Windows.Forms.AutoCompleteSource.ListItems;
            comboBox_Days.DisplayMember = "Text";
            comboBox_Days.DrawMode = System.Windows.Forms.DrawMode.OwnerDrawFixed;
            comboBox_Days.DropDownStyle = System.Windows.Forms.ComboBoxStyle.DropDownList;
            comboBox_Days.FormattingEnabled = true;
            resources.ApplyResources(comboBox_Days, "comboBox_Days");
            comboBox_Days.Name = "comboBox_Days";
            comboBox_Days.Style = DevComponents.DotNetBar.eDotNetBarStyle.StyleManagerControlled;
            ...
            base.Name = "FrmRepProject";
            base.Load += new System.EventHandler(FrmRepProject_Load);
            base.KeyPress += new System.Windows.Forms.KeyPressEventHandler(FrmRepProject_KeyPress);
            base.KeyDown += new System.Windows.Forms.KeyEventHandler(FrmRepProject_KeyDown);
        ...
        private void RibunButtons()
        {
            if (VarGeneral.CurrentLang.ToString() == "0" || VarGeneral.CurrentLang.ToString() == "")
            {
                ...
                Text = "فرز حسب موقع العمل - المشروع";
            }
            else
            {
        ...
        private void FrmRepProject_Load(object sender, EventArgs e)
        {
            try
            {
                ComponentResourceManager resources = new ComponentResourceManager(typeof(FrmRepProject));
                if (VarGeneral.CurrentLang.ToString() == "0" || VarGeneral.CurrentLang.ToString() == "")
                {
                ...
                FillGrid();
                FillCombo();
                dateTimeInput_RewardFrom.Text = "";
                dateTimeInput_RewardTo.Text = "";
            }
        ...
        public void FillCombo()
        {
            ...
            listDayOfWeek.Insert(0, new T_DayOfWeek());
        ...
        private void FrmRepProject_KeyPress(object sender, KeyPressEventArgs e)
        {
            if (e.KeyChar == '\r')
            {
                SendKeys.Send("{Tab}");
        ...
        private void FrmRepProject_KeyDown(object sender, KeyEventArgs e)
        {
        ...
        private void dateTimeInput_DisFrom_Leave(object sender, EventArgs e)
        {
            try
            {
                dateTimeInput_RewardFrom.Text = Convert.ToDateTime(dateTimeInput_RewardFrom.Text).ToString("yyyy/MM/dd");
            }
            catch
            {
                dateTimeInput_RewardFrom.Text = "";
        ...
        private void dateTimeInput_DisTo_Leave(object sender, EventArgs e)
        {
            try
            {
                dateTimeInput_RewardTo.Text = Convert.ToDateTime(dateTimeInput_RewardTo.Text).ToString("yyyy/MM/dd");
            }
            catch
            {
                dateTimeInput_RewardTo.Text = "";
        ...
        {
            dateTimeInput_RewardFrom.SelectAll();
        }
        private void dateTimeInput_AddTo_Click(object sender, EventArgs e)
        {
            dateTimeInput_RewardTo.SelectAll();
        }
        private void ButOk_Click(object sender, EventArgs e)
        {
            ...
            {
                VarGeneral.DebLog.writeLog("FrmRepProject_Load:", error, enable: true);
                MessageBox.Show(error.Message);
            }
        }
        private string GetSqlWhere()
        {
            ...
            QStr += ((tmpStr != "") ? (tmpStr + " )") : "");
            tmpStr = "";
            if (dateTimeInput_RewardFrom.Text != "    /  /" && dateTimeInput_RewardFrom.Text.Length == 10)
            {
                QStr = QStr + " AND ( T_AttendOperat.Date >= '" + Convert.ToDateTime(dateTimeInput_RewardFrom.Text).ToString("yyyy/MM/dd") + "' ) ";
            }
            if (dateTimeInput_RewardTo.Text != "    /  /" && dateTimeInput_RewardTo.Text.Length == 10)
            {
                QStr = QStr + " AND ( T_AttendOperat.Date <= '" + Convert.ToDateTime(dateTimeInput_RewardTo.Text).ToString("yyyy/MM/dd") + "' ) ";
            }
            if (comboBox_Days.SelectedIndex > 0)
            {
                QStr = QStr + " AND T_AttendOperat.Day = " + comboBox_Days.SelectedValue;
            }
            return QStr;
        }
