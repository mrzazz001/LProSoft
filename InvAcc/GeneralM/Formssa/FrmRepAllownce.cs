...
namespace InvAcc.Forms
{
    public partial class FrmRepAllownce : Form
    {
        ...
        {
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(InvAcc.Forms.FrmRepAllownce));
            ...
            buttonItem_SocialAllownce = new DevComponents.DotNetBar.ButtonItem();
            buttonItem_MidicalAllownce = new DevComponents.DotNetBar.ButtonItem();
            ...
            ButOk.SubItems.AddRange(new DevComponents.DotNetBar.BaseItem[2]
            {
                buttonItem_SocialAllownce,
                buttonItem_MidicalAllownce
            });
            ButOk.Symbol = "\uf0c5";
            ButOk.SymbolSize = 16f;
            ButOk.TextColor = System.Drawing.Color.White;
            buttonItem_SocialAllownce.Checked = true;
            buttonItem_SocialAllownce.GlobalItem = false;
            buttonItem_SocialAllownce.Name = "buttonItem_SocialAllownce";
            resources.ApplyResources(buttonItem_SocialAllownce, "buttonItem_SocialAllownce");
            buttonItem_SocialAllownce.Click += new System.EventHandler(buttonItem_SocialAllownce_Click);
            buttonItem_MidicalAllownce.BeginGroup = true;
            buttonItem_MidicalAllownce.GlobalItem = false;
            buttonItem_MidicalAllownce.Name = "buttonItem_MidicalAllownce";
            resources.ApplyResources(buttonItem_MidicalAllownce, "buttonItem_MidicalAllownce");
            buttonItem_MidicalAllownce.Click += new System.EventHandler(buttonItem_MidicalAllownce_Click);
            ...
            base.Name = "FrmRepAllownce";
            base.Load += new System.EventHandler(FrmRepAllownce_Load);
            base.KeyPress += new System.Windows.Forms.KeyPressEventHandler(FrmRepAllownce_KeyPress);
            base.KeyDown += new System.Windows.Forms.KeyEventHandler(FrmRepAllownce_KeyDown);
