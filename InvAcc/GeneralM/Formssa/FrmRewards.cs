    ...
    public partial class FrmRewards : Form
    {
        ...
        public T_User Permmission
        {
            ...
            set
            {
                ...
                {
                    permission = value;
                    if (!VarGeneral.TString.ChkStatShow(value.Emp_MovStr, 25))
                    {
                        IfAdd = false;
                    }
                    else
                    ...
                    if (!VarGeneral.TString.ChkStatShow(value.Emp_MovStr, 26) || switchButton_Sts.Value)
                    {
                        CanEdit = false;
                    }
                    else
                    ...
                    if (!VarGeneral.TString.ChkStatShow(value.Emp_MovStr, 27) || switchButton_Sts.Value)
                    {
                        IfDelete = false;
                    }
                    else
        ...
        {
            DGV_Main.PrimaryGrid.VirtualMode = false;
            List<T_Reward> list = db.FillReward_2(textBox_search.TextBox.Text).ToList();
        ...
        public void FillHDGV(IEnumerable<T_Reward> new_data_enum)
        {
            ...
            DGV_Main.PrimaryGrid.DataMember = "T_Reward";
        ...
        {
            PKeys.Clear();
            var qkeys = db.T_Rewards.Select((T_Reward item) => new
            {
                Code = item.Reward_No + string.Empty
            });
            int count = 0;
        ...
        {
            ComponentResourceManager resources = new ComponentResourceManager(typeof(FrmRewards));
            if (VarGeneral.CurrentLang.ToString() == "0" || VarGeneral.CurrentLang.ToString() == string.Empty)
            {
        ...
        private void RibunButtons()
        {
            if (VarGeneral.CurrentLang.ToString() == "0" || VarGeneral.CurrentLang.ToString() == string.Empty)
            {
                ...
                label38.Text = "الكود :";
                textBox_Note.WatermarkText = "ملاحظـــــــات الحوافـــز";
                Text = "كرت الحوافز والمكآفات";
            }
            else
            {
        ...
        private void FrmRewards_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    columns_Names_visible.Add("Reward_No", new ColumnDictinary("الرقم", "No", ifDefault: true, string.Empty));
                    columns_Names_visible.Add("RewardDate", new ColumnDictinary("التاريخ", "Date", ifDefault: true, string.Empty));
                    ...
                    columns_Names_visible.Add("SalDate", new ColumnDictinary("يضاف الى شهر", "ADD To Month", ifDefault: false, string.Empty));
                    columns_Names_visible.Add("RewardValue", new ColumnDictinary("القيمــة", " Value", ifDefault: true, string.Empty));
        ...
        private void textBox_ID_TextChanged(object sender, EventArgs e)
        {
            ...
            try
            {
                T_Reward newData = db.RewardEmp(no);
                if (newData == null || newData.Reward_No == 0 || string.IsNullOrEmpty(newData.Reward_ID))
                {
                    if (!Button_Add.Visible || !Button_Add.Enabled)
                    {
                        ...
                        try
                        {
                            textBox_ID.Text = data_this.Reward_No.ToString();
                        }
                        catch
                        {
                        }
                ...
                {
                    DataThis = newData;
                    int indexA = PKeys.IndexOf(string.Concat(newData.Reward_No));
                    indexA++;
                    TextBox_Index.InputTextChanged -= TextBox_Index_InputTextChanged;
        ...
        public void SetData(T_Reward value)
        {
            State = FormState.Saved;
            Button_Save.Enabled = false;
            textBox_Note.Text = value.Note;
            textBox_ID.Tag = value.Reward_ID;
            textBox_SalDate.Text = Convert.ToDateTime(value.SalDate).ToString("yyyy/MM");
            try
            {
                if (VarGeneral.CheckDate(value.RewardDate))
                {
                    dateTimeInput_warnDate.Text = Convert.ToDateTime(value.RewardDate).ToString("yyyy/MM/dd");
                }
                else
                {
            ...
            try
            {
                textBox_RewardValue.Value = value.RewardValue.Value;
            }
            catch
            {
        ...
        private T_Reward GetData()
        {
            textBox_ID.Focus();
            try
            {
                data_this.RewardValue = textBox_RewardValue.Value;
            }
            catch
            {
                data_this.RewardValue = 0.0;
            }
            try
            {
                data_this.Reward_No = int.Parse(textBox_ID.Text);
            }
            catch
            {
            }
            ...
            try
            {
                data_this.RewardDate = Convert.ToDateTime(dateTimeInput_warnDate.Text).ToString("yyyy/MM/dd");
            }
            catch
            {
                dateTimeInput_warnDate.Text = string.Empty;
                data_this.RewardDate = string.Empty;
            }
            try
            {
        ...
        private void Button_Save_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (State == FormState.New)
                {
                    ...
                    {
                        GetData();
                        data_this.Reward_ID = textBox_ID.Tag.ToString();
                        db.T_Rewards.InsertOnSubmit(data_this);
                        db.SubmitChanges();
                    }
                ...
                State = FormState.Saved;
                RefreshPKeys();
                TextBox_Index.TextBox.Text = string.Concat(PKeys.IndexOf(string.Concat(data_this.Reward_No)) + 1);
                SetReadOnly = true;
            }
            catch (Exception error)
            {
        ...
        private void Button_Delete_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (data_this != null && data_this.Reward_No != 0 && !string.IsNullOrEmpty(data_this.Reward_ID) && ifOkDelete)
                {
                    data_this = db.RewardEmp(DataThis.Reward_No);
                    db.T_Rewards.DeleteOnSubmit(DataThis);
                    db.SubmitChanges();
                    Clear();
                    RefreshPKeys();
            ...
            catch (Exception error)
            {
                ...
                MessageBox.Show(error.Message);
                DataThis = db.RewardEmp(DataThis.Reward_No);
            }
        }
        private void DGV_Main_DataBindingComplete(object sender, GridDataBindingCompleteEventArgs e)
        {
            ...
            if (dataMember != null && dataMember == "T_Reward")
            {
        ...
        private void PropBranchPanel(GridPanel panel)
        {
            ...
            panel.Columns["Reward_No"].Width = 120;
            panel.Columns["Reward_No"].Visible = columns_Names_visible["Reward_No"].IfDefault;
            panel.Columns["RewardDate"].Width = 120;
            panel.Columns["RewardDate"].Visible = columns_Names_visible["RewardDate"].IfDefault;
            ...
            panel.Columns["RewardValue"].Width = 120;
            panel.Columns["RewardValue"].Visible = columns_Names_visible["RewardValue"].IfDefault;
        ...
        private void Button_ExportTable2_Click(object sender, EventArgs e)
        {
            try
            {
                ExportExcel.ExportToExcel(DGV_Main, "تقرير الحوافز والمكآفات");
            }
            catch
            {
            }
        ...
        private void textBox_SalDate_Leave(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    textBox_SalDate.Text = string.Empty;
                }
            }
            catch
            {
        ...
        private bool ValidData()
        {
            try
            {
                ...
                T_Reward q = db.RewardEmp(int.Parse(textBox_ID.Text));
                if (!string.IsNullOrEmpty(q.Reward_ID) && State == FormState.New)
                {
                ...
                {
                    MessageBox.Show((LangArEn == 0) ? "يجب تحديد القيمة" : "Most Set Value", VarGeneral.ProdectNam, MessageBoxButtons.OK, MessageBoxIcon.Hand);
        ...
        private void InitializeComponent()
        {
            ...
            this.textBox_Note.WatermarkText = "ملاحظـــــــات الحوافز والمكآفات";
            // 
            // switchButton_Sts
            // 
            ...
            this.switchButton_Sts.TabIndex = 6732;
            // 
            // textBox_SalDate
            // 
            ...
            this.textBox_RewardValue.Anchor = ((System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Right));
            ...
            this.Text = "كــــــرت الحوافز والمكافآت";
