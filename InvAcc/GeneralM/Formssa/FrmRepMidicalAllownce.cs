...
{
    public partial class FrmRepMidicalAllownce : Form
    {
        ...
        private void RibunButtons()
        {
            ...
            else
            {
                ...
                Text = "Allownce Report of Employee";
            }
        }
        private void FrmRepMidicalAllownce_Load(object sender, EventArgs e)
        {
            try
            {
                ComponentResourceManager resources = new ComponentResourceManager(typeof(FrmRepMidicalAllownce));
                if (VarGeneral.CurrentLang.ToString() == "0" || VarGeneral.CurrentLang.ToString() == "")
                {
                ...
                var q = (from t in db.T_Emps
                         orderby t.Insurance_Date, t.Insurance_DateEnd
                         where t.Insurance_Date != ""
                         select new
                         {
                             t.Insurance_Date,
                             t.Insurance_DateEnd
                ...
                {
                    dateTimeInput_StartVacationFrom.Text = Convert.ToDateTime(q.First().Insurance_Date).ToString("yyyy/MM/dd");
                    dateTimeInput_EndVacationFrom.Text = Convert.ToDateTime(q.Last().Insurance_Date).ToString("yyyy/MM/dd");
                    dateTimeInput_StartVacationTo.Text = Convert.ToDateTime(q.First().Insurance_DateEnd).ToString("yyyy/MM/dd");
                    dateTimeInput_EndVacationTo.Text = Convert.ToDateTime(q.Last().Insurance_DateEnd).ToString("yyyy/MM/dd");
                }
            }
        ...
        private void FrmRepMidicalAllownce_KeyPress(object sender, KeyPressEventArgs e)
        {
            if (e.KeyChar == '\r')
            {
                SendKeys.Send("{Tab}");
        ...
        private void FrmRepMidicalAllownce_KeyDown(object sender, KeyEventArgs e)
        {
        ...
        private string GetSqlWhere()
        {
            ...
            {
                QStr = QStr + " AND ( Insurance_Date >= '" + Convert.ToDateTime(dateTimeInput_StartVacationFrom.Text).ToString("yyyy/MM/dd") + "' ) ";
            }
            if (dateTimeInput_StartVacationTo.Text != "    /  /" && dateTimeInput_StartVacationTo.Text.Length == 10)
            {
                QStr = QStr + " AND ( Insurance_Date <= '" + Convert.ToDateTime(dateTimeInput_StartVacationTo.Text).ToString("yyyy/MM/dd") + "' ) ";
            }
            if (dateTimeInput_EndVacationFrom.Text != "    /  /" && dateTimeInput_EndVacationFrom.Text.Length == 10)
            {
                QStr = QStr + " AND ( Insurance_DateEnd >= '" + Convert.ToDateTime(dateTimeInput_EndVacationFrom.Text).ToString("yyyy/MM/dd") + "' ) ";
            }
            if (dateTimeInput_EndVacationTo.Text != "    /  /" && dateTimeInput_EndVacationTo.Text.Length == 10)
            {
                QStr = QStr + " AND ( Insurance_DateEnd <= '" + Convert.ToDateTime(dateTimeInput_EndVacationTo.Text).ToString("yyyy/MM/dd") + "' ) ";
            }
            return QStr;
        }
        ...
        {
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(InvAcc.Forms.FrmRepMidicalAllownce));
            ...
            base.Name = "FrmRepMidicalAllownce";
            base.Load += new System.EventHandler(FrmRepMidicalAllownce_Load);
            base.KeyPress += new System.Windows.Forms.KeyPressEventHandler(FrmRepMidicalAllownce_KeyPress);
            base.KeyDown += new System.Windows.Forms.KeyEventHandler(FrmRepMidicalAllownce_KeyDown);
