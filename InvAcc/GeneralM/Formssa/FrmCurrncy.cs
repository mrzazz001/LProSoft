...
{
    public partial class FrmCurrncy : Form
    {
        ...
        private T_Curency data_this;
        private Rate_DataDataContext dbInstanceRate;
        private T_User permission = new T_User();
        protected Label labelDefCurrName;
        ...
        private void FrmInvSale_SizeChanged(object sender, EventArgs e)
        {
            ...
            if (WindowState == FormWindowState.Maximized)
                ...
                superTabControl_Main2.Width = 410;
        }
        ...
        private DoubleInput textBox_Rate;
        ...
        public T_User Permmission
        {
            ...
            set
            {
                ...
                {
                    permission = value;
                    if (!VarGeneral.TString.ChkStatShow(value.FilStr, 13))
                    {
                        IfAdd = false;
                    }
                    else
                    ...
                    if (!VarGeneral.TString.ChkStatShow(value.FilStr, 14))
                    {
                        CanEdit = false;
                    }
                    else
                    ...
                    if (!VarGeneral.TString.ChkStatShow(value.FilStr, 15))
                    {
                        IfDelete = false;
                    }
                    else
        ...
        {
            DGV_Main.PrimaryGrid.VirtualMode = false;
            List<T_Curency> list = db.Fillcurency_2(textBox_search.TextBox.Text).ToList();
        ...
        public void FillHDGV(IEnumerable<T_Curency> new_data_enum)
        {
            ...
            DGV_Main.PrimaryGrid.DataMember = "T_Curency";
        ...
        {
            PKeys.Clear();
            var qkeys = db.T_Curencies.Select((T_Curency item) => new
            {
                Code = item.Curency_No + ""
            });
            int count = 0;
        ...
        public FrmCurrncy()
        {
            ...
            {
                textBox_Rate.DisplayFormat = VarGeneral.DicemalMask;
            }
        }
        protected override void OnParentRightToLeftChanged(EventArgs e)
        {
            ComponentResourceManager resources = new ComponentResourceManager(typeof(FrmCurrncy));
            if (VarGeneral.CurrentLang.ToString() == "0" || VarGeneral.CurrentLang.ToString() == "")
            {
        ...
        private void FrmCurrncy_Load(object sender, EventArgs e)
        {
            try
            {
                ComponentResourceManager resources = new ComponentResourceManager(typeof(FrmCurrncy));
                ...
                {
                    columns_Names_visible.Add("Curency_No", new ColumnDictinary("رقم العملة", "Curency No", ifDefault: true, ""));
                    ...
                    columns_Names_visible.Add("Rate", new ColumnDictinary("سعر الصرف", "Rate", ifDefault: true, ""));
                    columns_Names_visible.Add("Symbol", new ColumnDictinary("الرمز", "Code", ifDefault: true, ""));
                }
                else
                {
                    Clear();
                ...
                try
                {
                    labelDefCurrName.Text = ((LangArEn == 0) ? db.StockCurencyID(int.Parse(VarGeneral.Settings_Sys.ImportIp.ToString())).Arb_Des : db.StockCurencyID(int.Parse(VarGeneral.Settings_Sys.ImportIp.ToString())).Eng_Des);
                    if (VarGeneral.CurrentLang.ToString() == "0" || VarGeneral.CurrentLang.ToString() == "")
                    {
                        labelDefCurrName.Location = new Point(textBox_Rate.Location.X - labelDefCurrName.Width - 2, labelDefCurrName.Location.Y);
                    }
                }
                catch
                {
                    labelDefCurrName.Visible = false;
                }
        ...
        private void textBox_ID_TextChanged(object sender, EventArgs e)
        {
            ...
            try
            {
                T_Curency newData = db.StockCurency(no.ToString());
                if (newData == null || newData.Curency_ID == 0)
                {
                    if (!Button_Add.Visible || !Button_Add.Enabled)
                    {
                        ...
                        try
                        {
                            textBox_ID.Text = data_this.Curency_No;
                        }
                        catch
                        {
                        }
                ...
                {
                    DataThis = newData;
                    int indexA = PKeys.IndexOf(newData.Curency_No ?? "");
                    indexA++;
                    TextBox_Index.InputTextChanged -= TextBox_Index_InputTextChanged;
                ...
                try
                {
                    if (data_this.Curency_ID == 1 || data_this.Curency_ID == 2)
                    {
                        IfDelete = false;
                    }
                    else
                ...
                try
                {
                    if (data_this.Curency_ID == int.Parse(VarGeneral.Settings_Sys.ImportIp))
                    {
                        textBox_Rate.IsInputReadOnly = true;
                    }
                    else
                    {
                        textBox_Rate.IsInputReadOnly = false;
                    }
                }
                catch
                {
        ...
        public void SetData(T_Curency value)
        {
            try
            {
                State = FormState.Saved;
                Button_Save.Enabled = false;
                textBox_ID.Tag = value.Curency_ID;
                textBox_NameA.Text = value.Arb_Des;
                textBox_NameE.Text = value.Eng_Des;
                textbox_Symbol.Text = value.Symbol;
                textBox_Rate.Value = value.Rate.Value;
            }
            catch (Exception error)
            {
        ...
        private T_Curency GetData()
        {
            textBox_ID.Focus();
            try
            {
                data_this.Curency_No = textBox_ID.Text;
            }
            catch
            {
            }
            ...
            try
            {
                data_this.Rate = textBox_Rate.Value;
            }
            catch
            {
            }
            try
            {
                data_this.Symbol = textbox_Symbol.Text;
            }
            catch
            {
            }
        ...
        private void Button_Save_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (textBox_Rate.Value <= 0.0)
                {
                    MessageBox.Show((LangArEn == 0) ? "لايمكن ان يكون سعر الصرف اصغر من او يساوي الصفر" : "Can not be a rate less than or equal to zero", VarGeneral.ProdectNam, MessageBoxButtons.OK, MessageBoxIcon.Hand);
                    return;
                }
                if (State == FormState.New)
                {
                    ...
                    try
                    {
                        db.T_Curencies.InsertOnSubmit(data_this);
                        db.SubmitChanges();
                    }
                    catch (SqlException ex3)
                    {
                        ...
                        data_this.Curency_No = string.Concat(max);
                        Button_Save_Click(sender, e);
                    }
                    catch (Exception)
                    {
                ...
                State = FormState.Saved;
                RefreshPKeys();
                TextBox_Index.TextBox.Text = string.Concat(PKeys.IndexOf(data_this.Curency_No ?? "") + 1);
                SetReadOnly = true;
            }
            catch (Exception error)
            {
        ...
        private void Button_Delete_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                if (data_this.Curency_ID == 1 || data_this.Curency_ID == 2 || data_this.Curency_ID == int.Parse(VarGeneral.Settings_Sys.ImportIp))
                {
                    ifOkDelete = false;
                    return;
                }
            ...
            if (data_this == null || data_this.Curency_ID == 0 || !ifOkDelete)
            {
                return;
            }
            T_GDHEAD returned = db.SelectCurencyNoByReturnNo(DataThis.Curency_ID);
            T_Snd returned2 = db.SelectCurencyNoByReturnNoSnd(DataThis.Curency_ID);
            if (returned != null && returned.CurTyp.HasValue)
            {
                MessageBox.Show((LangArEn == 0) ? "لايمكن حذف العملة .. لانه مرتبط باحد الفواتير" : "You can not delete Currncy .. because it is tied to a Bills", VarGeneral.ProdectNam, MessageBoxButtons.OK, MessageBoxIcon.Hand);
                return;
            }
            if (returned2 != null && returned2.curr.HasValue)
            {
                MessageBox.Show((LangArEn == 0) ? "لايمكن حذف العملة .. لانه مرتبط باحد سندات النزلاء" : "You can not delete Currncy .. because it is tied to a Guest", VarGeneral.ProdectNam, MessageBoxButtons.OK, MessageBoxIcon.Hand);
                return;
            }
            data_this = db.StockCurency(DataThis.Curency_No.ToString());
            try
            {
                db.T_Curencies.DeleteOnSubmit(DataThis);
                db.SubmitChanges();
            }
            catch (SqlException)
            {
        ...
        private void DGV_Main_DataBindingComplete(object sender, GridDataBindingCompleteEventArgs e)
        {
            ...
            if (dataMember != null && dataMember == "T_Curency")
            {
        ...
        private void PropBranchPanel(GridPanel panel)
        {
            ...
            panel.Columns["Curency_No"].Width = 180;
            panel.Columns["Curency_No"].Visible = columns_Names_visible["Curency_No"].IfDefault;
            panel.Columns["Rate"].Width = 90;
            panel.Columns["Rate"].Visible = columns_Names_visible["Rate"].IfDefault;
            panel.Columns["Symbol"].Width = 90;
            panel.Columns["Symbol"].Visible = columns_Names_visible["Symbol"].IfDefault;
            panel.ReadOnly = true;
        }
        ...
        private void Button_ExportTable2_Click(object sender, EventArgs e)
        {
            try
            {
                ExportExcel.ExportToExcel(DGV_Main, "تقرير العملات");
            }
            catch
            {
            }
        ...
        public void Button_Print_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                _RepShow.Tables = " T_Curency left join T_SYSSETTING on T_SYSSETTING.SYSSETTING_ID = T_Curency.CompanyID ";
                string Fields = "";
                Fields = " T_Curency.Curency_No as No, T_Curency.Arb_Des as NmA, T_Curency.Eng_Des as NmE,T_SYSSETTING.LogImg ";
                _RepShow.Rule = "";
        ...
        private void textbox_Symbol_Click(object sender, EventArgs e)
        {
            textbox_Symbol.SelectAll();
        ...
        private void InitializeComponent()
        {
            ...
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(FrmCurrncy));
            ...
            this.textBox_Rate = new DevComponents.Editors.DoubleInput();
            ...
            this.labelDefCurrName = new System.Windows.Forms.Label();
            this.netResize1.AfterControlResize += new Softgroup.NetResize.NetResize.AfterControlResizeEventHandler(this.netResize1_AfterControlResize);
            this.PanelSpecialContainer.SuspendLayout();
            this.ribbonBar1.SuspendLayout();
            ((System.ComponentModel.ISupportInitialize)(this.textBox_Rate)).BeginInit();
            ...
            this.PanelSpecialContainer.Size = new System.Drawing.Size(649, 242);
            ...
            this.ribbonBar1.Controls.Add(this.labelDefCurrName);
            ...
            this.ribbonBar1.Controls.Add(this.textBox_Rate);
            this.ribbonBar1.Controls.Add(this.textbox_Symbol);
            ...
            this.label40.Location = new System.Drawing.Point(521, 114);
            this.label40.Name = "label40";
            this.label40.Size = new System.Drawing.Size(114, 13);
            this.label40.TabIndex = 85;
            this.label40.Text = "إسم العملة - انجليزي :";
            // 
            // label36
            // 
            ...
            this.label36.Location = new System.Drawing.Point(521, 75);
            this.label36.Name = "label36";
            this.label36.Size = new System.Drawing.Size(113, 13);
            this.label36.TabIndex = 83;
            this.label36.Text = "إسم العملة - عـــربي :";
            // 
            // label38
            // 
            ...
            this.label38.Location = new System.Drawing.Point(521, 36);
            ...
            // textBox_Rate
            // 
            this.textBox_Rate.AllowEmptyState = false;
            // 
            // 
            // 
            this.textBox_Rate.BackgroundStyle.BackColor = System.Drawing.Color.FromArgb(((int)(((byte)(255)))), ((int)(((byte)(255)))), ((int)(((byte)(198)))));
            this.textBox_Rate.BackgroundStyle.Class = "DateTimeInputBackground";
            this.textBox_Rate.BackgroundStyle.CornerType = DevComponents.DotNetBar.eCornerType.Square;
            this.textBox_Rate.ButtonFreeText.Shortcut = DevComponents.DotNetBar.eShortcut.F2;
            this.textBox_Rate.DisplayFormat = "0.00";
            this.textBox_Rate.Font = new System.Drawing.Font("Tahoma", 8F, System.Drawing.FontStyle.Bold);
            this.textBox_Rate.Increment = 1D;
            this.textBox_Rate.InputHorizontalAlignment = DevComponents.Editors.eHorizontalAlignment.Center;
            this.textBox_Rate.Location = new System.Drawing.Point(170, 32);
            this.textBox_Rate.MinValue = 0D;
            this.textBox_Rate.Name = "textBox_Rate";
            this.textBox_Rate.Size = new System.Drawing.Size(69, 20);
            this.textBox_Rate.TabIndex = 4;
            this.textBox_Rate.Value = 1D;
            this.textBox_Rate.Click += new System.EventHandler(this.Button_Edit_Click);
            // 
            // textbox_Symbol
            // 
            this.textbox_Symbol.BackColor = System.Drawing.Color.FromArgb(((int)(((byte)(255)))), ((int)(((byte)(255)))), ((int)(((byte)(192)))));
            this.textbox_Symbol.ForeColor = System.Drawing.Color.Red;
            this.textbox_Symbol.Location = new System.Drawing.Point(22, 32);
            this.textbox_Symbol.Name = "textbox_Symbol";
            this.netResize1.SetResizeTextBoxMultiline(this.textbox_Symbol, false);
            this.textbox_Symbol.Size = new System.Drawing.Size(76, 20);
            this.textbox_Symbol.TabIndex = 5;
            this.textbox_Symbol.TextAlign = System.Windows.Forms.HorizontalAlignment.Center;
            this.textbox_Symbol.Click += new System.EventHandler(this.textbox_Symbol_Click);
            // 
            // textBox_NameE
            // 
            ...
            this.textBox_NameE.Location = new System.Drawing.Point(22, 110);
            ...
            this.textBox_NameE.Size = new System.Drawing.Size(496, 20);
            ...
            this.textBox_NameA.Location = new System.Drawing.Point(22, 71);
            ...
            this.textBox_NameA.Size = new System.Drawing.Size(496, 20);
            ...
            this.textBox_ID.Location = new System.Drawing.Point(381, 32);
            this.textBox_ID.Name = "textBox_ID";
            this.netResize1.SetResizeTextBoxMultiline(this.textBox_ID, false);
            this.textBox_ID.Size = new System.Drawing.Size(137, 21);
            ...
            this.dockSite5.Size = new System.Drawing.Size(649, 0);
            this.dockSite5.TabIndex = 899;
            ...
            this.dockSite6.Location = new System.Drawing.Point(0, 242);
            this.dockSite6.Name = "dockSite6";
            this.dockSite6.Size = new System.Drawing.Size(649, 0);
            this.dockSite6.TabIndex = 900;
            ...
            this.dockSite7.Size = new System.Drawing.Size(0, 242);
            this.dockSite7.TabIndex = 901;
            ...
            this.dockSite8.Location = new System.Drawing.Point(0, 242);
            this.dockSite8.Name = "dockSite8";
            this.dockSite8.Size = new System.Drawing.Size(649, 0);
            this.dockSite8.TabIndex = 906;
            ...
            this.dockSite9.Location = new System.Drawing.Point(649, 0);
            this.dockSite9.Name = "dockSite9";
            this.dockSite9.Size = new System.Drawing.Size(0, 242);
            this.dockSite9.TabIndex = 902;
            ...
            this.dockSite10.Size = new System.Drawing.Size(0, 242);
            this.dockSite10.TabIndex = 903;
            ...
            this.dockSite11.Location = new System.Drawing.Point(649, 0);
            this.dockSite11.Name = "dockSite11";
            this.dockSite11.Size = new System.Drawing.Size(0, 242);
            this.dockSite11.TabIndex = 904;
            ...
            this.dockSite12.Size = new System.Drawing.Size(649, 0);
            this.dockSite12.TabIndex = 905;
            ...
            // labelDefCurrName
            // 
            this.labelDefCurrName.BackColor = System.Drawing.Color.Transparent;
            this.labelDefCurrName.Font = new System.Drawing.Font("Tahoma", 8.25F);
            this.labelDefCurrName.ForeColor = System.Drawing.Color.FromArgb(((int)(((byte)(0)))), ((int)(((byte)(0)))), ((int)(((byte)(192)))));
            this.labelDefCurrName.ImeMode = System.Windows.Forms.ImeMode.NoControl;
            this.labelDefCurrName.Location = new System.Drawing.Point(278, 9);
            this.labelDefCurrName.Name = "labelDefCurrName";
            this.labelDefCurrName.RightToLeft = System.Windows.Forms.RightToLeft.Yes;
            this.labelDefCurrName.Size = new System.Drawing.Size(89, 13);
            this.labelDefCurrName.TabIndex = 144;
            this.labelDefCurrName.Text = "--";
            this.labelDefCurrName.TextAlign = System.Drawing.ContentAlignment.MiddleLeft;
            // 
            // FrmCurrncy
            // 
            ...
            this.Name = "FrmCurrncy";
            this.RightToLeft = System.Windows.Forms.RightToLeft.Yes;
            this.RightToLeftLayout = true;
            this.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
            this.Text = "كرت العمـــلات";
            this.Load += new System.EventHandler(this.FrmCurrncy_Load);
            ...
            ((System.ComponentModel.ISupportInitialize)(this.textBox_Rate)).EndInit();
