...
{
    public partial class FrmRepAdd : Form
    {
        ...
        private MaskedTextBox dateTimeInput_AddTo;
        private MaskedTextBox dateTimeInput_AddFrom;
        ...
        {
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(InvAcc.Forms.FrmRepAdd));
            ...
            dateTimeInput_AddTo = new System.Windows.Forms.MaskedTextBox();
            dateTimeInput_AddFrom = new System.Windows.Forms.MaskedTextBox();
            ...
            dataGridViewX_Emp.PrimaryGrid.DefaultVisualStyles.AlternateRowCellStyles.Default.Background = background5;
            ...
            dataGridViewX_Emp.PrimaryGrid.DefaultVisualStyles.ColumnHeaderStyles.Default.Background = background6;
            ...
            dataGridViewX_Job.PrimaryGrid.DefaultVisualStyles.AlternateColumnCellStyles.Default.Background = background7;
            background8.Color1 = System.Drawing.Color.White;
            background8.Color2 = System.Drawing.Color.FromArgb(255, 255, 192);
            dataGridViewX_Job.PrimaryGrid.DefaultVisualStyles.AlternateRowCellStyles.Default.Background = background8;
            ...
            dataGridViewX_Job.PrimaryGrid.DefaultVisualStyles.ColumnHeaderStyles.Default.Background = background9;
            ...
            dataGridViewX_Section.PrimaryGrid.DefaultVisualStyles.AlternateColumnCellStyles.Default.Background = background10;
            background11.Color1 = System.Drawing.Color.White;
            background11.Color2 = System.Drawing.Color.FromArgb(255, 255, 192);
            dataGridViewX_Section.PrimaryGrid.DefaultVisualStyles.AlternateRowCellStyles.Default.Background = background11;
            ...
            dataGridViewX_Section.PrimaryGrid.DefaultVisualStyles.ColumnHeaderStyles.Default.Background = background12;
            ...
            dataGridViewX_Dept.PrimaryGrid.DefaultVisualStyles.AlternateColumnCellStyles.Default.Background = background2;
            background3.Color1 = System.Drawing.Color.White;
            background3.Color2 = System.Drawing.Color.FromArgb(255, 255, 192);
            dataGridViewX_Dept.PrimaryGrid.DefaultVisualStyles.AlternateRowCellStyles.Default.Background = background3;
            ...
            dataGridViewX_Dept.PrimaryGrid.DefaultVisualStyles.ColumnHeaderStyles.Default.Background = background4;
            ...
            groupBox_Date.Controls.Add(dateTimeInput_AddTo);
            groupBox_Date.Controls.Add(dateTimeInput_AddFrom);
            ...
            resources.ApplyResources(dateTimeInput_AddTo, "dateTimeInput_AddTo");
            dateTimeInput_AddTo.Name = "dateTimeInput_AddTo";
            dateTimeInput_AddTo.Leave += new System.EventHandler(dateTimeInput_DisTo_Leave);
            dateTimeInput_AddTo.Click += new System.EventHandler(dateTimeInput_AddTo_Click);
            resources.ApplyResources(dateTimeInput_AddFrom, "dateTimeInput_AddFrom");
            dateTimeInput_AddFrom.Name = "dateTimeInput_AddFrom";
            dateTimeInput_AddFrom.Leave += new System.EventHandler(dateTimeInput_DisFrom_Leave);
            dateTimeInput_AddFrom.Click += new System.EventHandler(dateTimeInput_AddFrom_Click);
            ...
            base.Name = "FrmRepAdd";
            base.Load += new System.EventHandler(FrmRepAdd_Load);
            base.KeyPress += new System.Windows.Forms.KeyPressEventHandler(FrmRepAdd_KeyPress);
            base.KeyDown += new System.Windows.Forms.KeyEventHandler(FrmRepAdd_KeyDown);
        ...
        private void FrmRepAdd_Load(object sender, EventArgs e)
        {
            try
            {
                ComponentResourceManager resources = new ComponentResourceManager(typeof(FrmRepAdd));
                if (VarGeneral.CurrentLang.ToString() == "0" || VarGeneral.CurrentLang.ToString() == "")
                {
                ...
                RibunButtons();
                FillGrid();
                List<string> q = (from t in db.T_Adds
                                  orderby t.warnDate
                                  select t.warnDate).ToList();
                if (q.Count() == 0)
                {
                    dateTimeInput_AddFrom.Text = "";
                    dateTimeInput_AddTo.Text = "";
                }
                else
                {
                    dateTimeInput_AddFrom.Text = Convert.ToDateTime(q.First()).ToString("yyyy/MM/dd");
                    dateTimeInput_AddTo.Text = Convert.ToDateTime(q.Last()).ToString("yyyy/MM/dd");
                }
            }
        ...
        private void FrmRepAdd_KeyPress(object sender, KeyPressEventArgs e)
        {
            if (e.KeyChar == '\r')
            {
                SendKeys.Send("{Tab}");
        ...
        private void FrmRepAdd_KeyDown(object sender, KeyEventArgs e)
        {
        ...
        private void dateTimeInput_DisFrom_Leave(object sender, EventArgs e)
        {
            try
            {
                dateTimeInput_AddFrom.Text = Convert.ToDateTime(dateTimeInput_AddFrom.Text).ToString("yyyy/MM/dd");
            }
            catch
            {
                dateTimeInput_AddFrom.Text = "";
        ...
        private void dateTimeInput_DisTo_Leave(object sender, EventArgs e)
        {
            try
            {
                dateTimeInput_AddTo.Text = Convert.ToDateTime(dateTimeInput_AddTo.Text).ToString("yyyy/MM/dd");
            }
            catch
            {
                dateTimeInput_AddTo.Text = "";
        ...
        private string GetSqlWhere()
        {
            ...
            if (dateTimeInput_AddFrom.Text != "    /  /" && dateTimeInput_AddFrom.Text.Length == 10)
            {
                QStr = QStr + " AND ( warnDate >= '" + Convert.ToDateTime(dateTimeInput_AddFrom.Text).ToString("yyyy/MM/dd") + "' ) ";
            }
            if (dateTimeInput_AddTo.Text != "    /  /" && dateTimeInput_AddTo.Text.Length == 10)
            {
                QStr = QStr + " AND ( warnDate <= '" + Convert.ToDateTime(dateTimeInput_AddTo.Text).ToString("yyyy/MM/dd") + "' ) ";
            }
            return QStr;
        }
