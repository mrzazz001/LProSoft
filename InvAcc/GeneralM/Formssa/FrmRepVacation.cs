...
{
    public partial class FrmRepVacation : Form
    {
        ...
        {
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(InvAcc.Forms.FrmRepVacation));
            ...
            base.Name = "FrmRepVacation";
            base.Load += new System.EventHandler(FrmRepVacation_Load);
            base.KeyPress += new System.Windows.Forms.KeyPressEventHandler(FrmRepVacation_KeyPress);
            base.KeyDown += new System.Windows.Forms.KeyEventHandler(FrmRepVacation_KeyDown);
        ...
        private void FrmRepVacation_Load(object sender, EventArgs e)
        {
            try
            {
                ComponentResourceManager resources = new ComponentResourceManager(typeof(FrmRepVacation));
                if (VarGeneral.CurrentLang.ToString() == "0" || VarGeneral.CurrentLang.ToString() == string.Empty)
                {
                ...
                RibunButtons();
                FillGrid();
                var q = (from t in db.T_Vacations
                ...
                {
                    dateTimeInput_StartVacationFrom.Text = Convert.ToDateTime(q.First().StartDate).ToString("yyyy/MM/dd");
                    dateTimeInput_EndVacationFrom.Text = Convert.ToDateTime(q.Last().StartDate).ToString("yyyy/MM/dd");
                    dateTimeInput_StartVacationTo.Text = Convert.ToDateTime(q.First().EndDate).ToString("yyyy/MM/dd");
                    dateTimeInput_EndVacationTo.Text = Convert.ToDateTime(q.Last().EndDate).ToString("yyyy/MM/dd");
                }
            }
        ...
        private void FrmRepVacation_KeyPress(object sender, KeyPressEventArgs e)
        {
            if (e.KeyChar == '\r')
            {
                SendKeys.Send("{Tab}");
        ...
        private void FrmRepVacation_KeyDown(object sender, KeyEventArgs e)
        {
        ...
        private string GetSqlWhere()
        {
            ...
            {
                QStr = QStr + " AND ( StartDate >= '" + Convert.ToDateTime(dateTimeInput_StartVacationFrom.Text).ToString("yyyy/MM/dd") + "' ) ";
            }
            if (dateTimeInput_StartVacationTo.Text != "    /  /" && dateTimeInput_StartVacationTo.Text.Length == 10)
            {
                QStr = QStr + " AND ( StartDate <= '" + Convert.ToDateTime(dateTimeInput_StartVacationTo.Text).ToString("yyyy/MM/dd") + "' ) ";
            }
            if (dateTimeInput_EndVacationFrom.Text != "    /  /" && dateTimeInput_EndVacationFrom.Text.Length == 10)
            {
                QStr = QStr + " AND ( EndDate >= '" + Convert.ToDateTime(dateTimeInput_EndVacationFrom.Text).ToString("yyyy/MM/dd") + "' ) ";
            }
            if (dateTimeInput_EndVacationTo.Text != "    /  /" && dateTimeInput_EndVacationTo.Text.Length == 10)
            {
                QStr = QStr + " AND ( EndDate <= '" + Convert.ToDateTime(dateTimeInput_EndVacationTo.Text).ToString("yyyy/MM/dd") + "' ) ";
            }
            return QStr;
        }
