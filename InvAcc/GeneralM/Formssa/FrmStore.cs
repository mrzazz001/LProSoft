    ...
    public partial class FrmStore : Form
    {
        ...
        public T_User Permmission
        {
            ...
            set
            {
                ...
                {
                    permission = value;
                    if (!VarGeneral.TString.ChkStatShow(value.FilStr, 29))
                    {
                        IfAdd = false;
                    }
                    else
                    ...
                    if (!VarGeneral.TString.ChkStatShow(value.FilStr, 30))
                    {
                        CanEdit = false;
                    }
                    else
                    ...
                    if (!VarGeneral.TString.ChkStatShow(value.FilStr, 31))
                    {
                        IfDelete = false;
                    }
                    else
        ...
        {
            DGV_Main.PrimaryGrid.VirtualMode = false;
            List<T_Store> list = db.FillStore_2(textBox_search.TextBox.Text).ToList();
        ...
        public void FillHDGV(IEnumerable<T_Store> new_data_enum)
        {
            ...
            DGV_Main.PrimaryGrid.DataMember = "T_Store";
        ...
        {
            PKeys.Clear();
            var qkeys = db.T_Stores.Select((T_Store item) => new
            {
                Code = item.Stor_ID + string.Empty
            });
            int count = 0;
        ...
        public FrmStore()
        {
            ...
            txtNots.Click += Button_Edit_Click;
            txtTel.Click += Button_Edit_Click;
        ...
        {
            ComponentResourceManager resources = new ComponentResourceManager(typeof(FrmStore));
            if (VarGeneral.CurrentLang.ToString() == "0" || VarGeneral.CurrentLang.ToString() == string.Empty)
            {
        ...
        private void RibunButtons()
        {
            if (VarGeneral.CurrentLang.ToString() == "0" || VarGeneral.CurrentLang.ToString() == string.Empty)
            {
                ...
                txtAddr.Text = "العنوان :";
                txtCity.Text = "المدينة :";
                txtFax.Text = "فاكس :";
                txtTel.Text = string.Empty;
                txtNots.Text = "الملاحظات :";
                Text = "كرت المستودعات";
            }
            else
            {
        ...
        private void FrmStore_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    columns_Names_visible.Add("Stor_ID", new ColumnDictinary("رقم المستودع", "Store No", ifDefault: true, string.Empty));
                    ...
                    columns_Names_visible.Add("Address", new ColumnDictinary("العنوان", "Adress", ifDefault: true, string.Empty));
                    columns_Names_visible.Add("Tel", new ColumnDictinary("الهاتف", "Phone", ifDefault: true, string.Empty));
                    columns_Names_visible.Add("City", new ColumnDictinary("المدينة", "City", ifDefault: true, string.Empty));
                }
                else
                {
                    Clear();
        ...
        private void textBox_ID_TextChanged(object sender, EventArgs e)
        {
            ...
            try
            {
                T_Store newData = db.StockStore(no);
                if (newData == null || newData.Stor_ID == 0)
                {
                    if (!Button_Add.Visible || !Button_Add.Enabled)
                    {
                        ...
                        try
                        {
                            textBox_ID.Text = data_this.Stor_ID.ToString();
                        }
                        catch
                        {
                        }
                ...
                {
                    DataThis = newData;
                    int indexA = PKeys.IndexOf(string.Concat(newData.Stor_ID));
                    indexA++;
                    TextBox_Index.InputTextChanged -= TextBox_Index_InputTextChanged;
        ...
        public void SetData(T_Store value)
        {
            try
            {
                State = FormState.Saved;
        ...
        private T_Store GetData()
        {
            textBox_ID.Focus();
            try
            {
                data_this.Stor_ID = int.Parse(textBox_ID.Text);
            }
            catch
            {
            }
            ...
            try
            {
                data_this.Address = txtAddr.Text;
            }
            catch
            {
            }
        ...
        private void Button_Save_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (State == FormState.New)
                {
                    ...
                    try
                    {
                        db.T_Stores.InsertOnSubmit(data_this);
                        db.SubmitChanges();
                    }
                ...
                State = FormState.Saved;
                RefreshPKeys();
                TextBox_Index.TextBox.Text = string.Concat(PKeys.IndexOf(string.Concat(data_this.Stor_ID)) + 1);
                SetReadOnly = true;
            }
            catch (Exception error)
            {
        ...
        private void Button_Delete_Click(object sender, EventArgs e)
        {
            ...
            if (data_this == null || data_this.Stor_ID == 0 || !ifOkDelete)
            {
                return;
            }
            T_INVDET returned = db.SelectStoreNoByReturnNo(DataThis.Stor_ID);
            if (returned != null && !string.IsNullOrEmpty(returned.StoreNo.Value.ToString()))
            {
                MessageBox.Show((LangArEn == 0) ? "لايمكن حذف المستودع .. لانه مرتبط باحد الفواتير" : "You can not delete the warehouse .. because it is tied to a billing", VarGeneral.ProdectNam, MessageBoxButtons.OK, MessageBoxIcon.Hand);
                return;
            }
            T_OfferQFree returned2 = db.SelectStoreNoOfferByReturnNo(DataThis.Stor_ID);
            if (returned2 != null && !string.IsNullOrEmpty(returned2.OfferQFreeStoreNo.Value.ToString()))
            {
                MessageBox.Show((LangArEn == 0) ? "لايمكن حذف المستودع .. لانه مرتبط باحد الفواتير" : "You can not delete the warehouse .. because it is tied to a billing", VarGeneral.ProdectNam, MessageBoxButtons.OK, MessageBoxIcon.Hand);
                return;
            }
            List<T_ItemDet> vStorNo = db.T_ItemDets.Where((T_ItemDet t) => t.StoreNo == (int?)data_this.Stor_ID).ToList();
            if (vStorNo.Count > 0)
            {
                MessageBox.Show((LangArEn == 0) ? "لايمكن حذف المستودع .. لانه مرتبط باحد الأ\u064bصناف التجميعية" : "You can not delete the warehouse .. because it is tied to Item", VarGeneral.ProdectNam, MessageBoxButtons.OK, MessageBoxIcon.Hand);
                return;
            }
            List<T_StoreMnd> vStorMnd = db.T_StoreMnds.Where((T_StoreMnd t) => t.storeNo == (int?)data_this.Stor_ID).ToList();
            if (vStorMnd.Count > 0)
            {
            ...
            try
            {
                List<T_User> vStoreByUser = dbc.T_Users.Where((T_User t) => t.DefStores.Value == data_this.Stor_ID).ToList();
                if (vStoreByUser.Count > 0)
                {
                    MessageBox.Show((LangArEn == 0) ? "لايمكن حذف المستودع .. لانه مرتبط باحد المستخدمين" : "You can not delete the warehouse .. because it is tied to Users", VarGeneral.ProdectNam, MessageBoxButtons.OK, MessageBoxIcon.Hand);
                    return;
                }
            }
            catch
            ...
            data_this = db.StockStore(DataThis.Stor_ID);
            try
            {
                if (VarGeneral.UserID == 1 && MessageBox.Show("هل أنت متاكد من حذف جميع اصناف المستودع [" + Code + "]؟ \n Are you sure that you want to delete the record [" + Code + "]?", VarGeneral.ProdectNam, MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
                {
                    db.ExecuteCommand("DELETE FROM [dbo].[T_STKSQTY] WHERE storeNo = " + data_this.Stor_ID);
                    db.ExecuteCommand("DELETE FROM [dbo].[T_QTYEXP] WHERE storeNo = " + data_this.Stor_ID);
                    db.ExecuteCommand("DELETE FROM [dbo].[T_StoreMnd] WHERE storeNo = " + data_this.Stor_ID);
                }
                db.T_Stores.DeleteOnSubmit(DataThis);
                db.SubmitChanges();
            }
            catch (SqlException)
            {
        ...
        private void DGV_Main_DataBindingComplete(object sender, GridDataBindingCompleteEventArgs e)
        {
            ...
            if (dataMember != null && dataMember == "T_Store")
            {
        ...
        private void PropBranchPanel(GridPanel panel)
        {
            ...
            panel.Columns["Stor_ID"].Width = 180;
            panel.Columns["Stor_ID"].Visible = columns_Names_visible["Stor_ID"].IfDefault;
            panel.Columns["Tel"].Width = 100;
            panel.Columns["Tel"].Visible = columns_Names_visible["Tel"].IfDefault;
            panel.Columns["Address"].Width = 100;
            panel.Columns["Address"].Visible = columns_Names_visible["Address"].IfDefault;
            panel.Columns["City"].Width = 100;
        ...
        private void Button_ExportTable2_Click(object sender, EventArgs e)
        {
            try
            {
                ExportExcel.ExportToExcel(DGV_Main, "تقرير المستودعات");
            }
            catch
            {
            }
        ...
        public void Button_Print_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                _RepShow.Tables = " T_Store left join T_SYSSETTING on T_SYSSETTING.SYSSETTING_ID = T_Store.CompanyID ";
                string Fields = string.Empty;
                VarGeneral.HeaderRep[0] = Text;
                VarGeneral.HeaderRep[1] = string.Empty;
                VarGeneral.HeaderRep[2] = string.Empty;
                Fields = " T_Store.Stor_ID as No, T_Store.Arb_Des as NmA, T_Store.Eng_Des as NmE,T_SYSSETTING.LogImg ";
        ...
        private void InitializeComponent()
        {
            ...
            this.panelEx2.MinimumSize = new System.Drawing.Size(659, 259);
            this.panelEx2.Name = "panelEx2";
            this.panelEx2.Size = new System.Drawing.Size(659, 259);
            ...
            this.ribbonBar1.Controls.Add(this.txtAddr);
            this.ribbonBar1.Controls.Add(this.label4);
            this.ribbonBar1.Dock = System.Windows.Forms.DockStyle.Fill;
            this.ribbonBar1.LicenseKey = "F962CEC7-CD8F-4911-A9E9-CAB39962FC1F";
            this.ribbonBar1.Location = new System.Drawing.Point(0, 0);
            this.ribbonBar1.Name = "ribbonBar1";
            this.ribbonBar1.Size = new System.Drawing.Size(659, 208);
            ...
            this.textBox_NameE.Location = new System.Drawing.Point(33, 64);
            ...
            this.textBox_NameE.Size = new System.Drawing.Size(448, 20);
            ...
            this.label40.Location = new System.Drawing.Point(485, 68);
            this.label40.Name = "label40";
            this.label40.Size = new System.Drawing.Size(131, 13);
            this.label40.TabIndex = 85;
            this.label40.Text = "إسم المستودع - انجليزي :";
            // 
            // textBox_NameA
            // 
            ...
            this.textBox_NameA.Location = new System.Drawing.Point(33, 37);
            ...
            this.textBox_NameA.Size = new System.Drawing.Size(448, 20);
            ...
            this.label36.Location = new System.Drawing.Point(485, 41);
            this.label36.Name = "label36";
            this.label36.Size = new System.Drawing.Size(121, 13);
            this.label36.TabIndex = 83;
            this.label36.Text = "إسم المستودع - عربي :";
            // 
            // textBox_ID
            // 
            ...
            this.textBox_ID.Location = new System.Drawing.Point(331, 10);
            ...
            this.label38.Location = new System.Drawing.Point(485, 14);
            this.label38.Name = "label38";
            this.label38.Size = new System.Drawing.Size(45, 13);
            this.label38.TabIndex = 81;
            this.label38.Text = "الرمـــز :";
            // 
            // txtNots
            // 
            this.txtNots.Location = new System.Drawing.Point(33, 147);
            this.txtNots.MaxLength = 100;
            this.txtNots.Multiline = true;
            this.txtNots.Name = "txtNots";
            this.netResize1.SetResizeTextBoxMultiline(this.txtNots, false);
            this.txtNots.Size = new System.Drawing.Size(448, 36);
            this.txtNots.TabIndex = 8;
            // 
            // label8
            // 
            this.label8.AutoSize = true;
            this.label8.ImeMode = System.Windows.Forms.ImeMode.NoControl;
            this.label8.Location = new System.Drawing.Point(485, 149);
            this.label8.Name = "label8";
            this.label8.Size = new System.Drawing.Size(97, 13);
            this.label8.TabIndex = 110;
            this.label8.Text = "ملاحظــــــــــــــات :";
            // 
            // txtFax
            // 
            this.txtFax.Location = new System.Drawing.Point(204, 118);
            ...
            // txtTel
            // 
            this.txtTel.Location = new System.Drawing.Point(380, 118);
            ...
            this.label6.Location = new System.Drawing.Point(485, 122);
            this.label6.Name = "label6";
            this.label6.Size = new System.Drawing.Size(78, 13);
            this.label6.TabIndex = 108;
            this.label6.Text = "الهاتــــــــــــف :";
            // 
            // txtCity
            // 
            this.txtCity.Location = new System.Drawing.Point(33, 118);
            ...
            // txtAddr
            // 
            this.txtAddr.Location = new System.Drawing.Point(180, 91);
            this.txtAddr.MaxLength = 100;
            this.txtAddr.Name = "txtAddr";
            this.netResize1.SetResizeTextBoxMultiline(this.txtAddr, false);
            this.txtAddr.Size = new System.Drawing.Size(301, 20);
            ...
            this.label4.Text = "العنــــــــــــــوان :";
            ...
            this.ribbonBar_Tasks.Location = new System.Drawing.Point(0, 208);
            ...
            this.panel1.Size = new System.Drawing.Size(649, 273);
            ...
            this.barRightDockSite.Size = new System.Drawing.Size(0, 273);
            ...
            this.dockSite1.Size = new System.Drawing.Size(0, 273);
            ...
            this.dockSite2.Size = new System.Drawing.Size(0, 273);
