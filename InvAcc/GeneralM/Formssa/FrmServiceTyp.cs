...
{
    public partial class FrmServiceTyp : Form
    {
        ...
        public T_User Permmission
        {
            ...
            set
            {
                ...
                {
                    permission = value;
                    if (!VarGeneral.TString.ChkStatShow(value.FilStr, 9))
                    {
                        IfAdd = false;
                    }
                    else
                    ...
                    if (!VarGeneral.TString.ChkStatShow(value.FilStr, 10))
                    {
                        CanEdit = false;
                    }
                    else
                    ...
                    if (!VarGeneral.TString.ChkStatShow(value.FilStr, 11))
                    {
                        IfDelete = false;
                    }
                    else
        ...
        {
            DGV_Main.PrimaryGrid.VirtualMode = false;
            List<T_sertyp> list = db.FillServTyp_2(textBox_search.TextBox.Text).ToList();
        ...
        public void FillHDGV(IEnumerable<T_sertyp> new_data_enum)
        {
            ...
            DGV_Main.PrimaryGrid.DataMember = "T_sertyp";
        ...
        {
            PKeys.Clear();
            var qkeys = from item in db.T_sertyps
                        where item.Serv_No != "0"
                        select new
                        {
                            Code = item.Serv_No + string.Empty
                        };
            int count = 0;
        ...
        {
            ComponentResourceManager resources = new ComponentResourceManager(typeof(FrmServiceTyp));
            if (VarGeneral.CurrentLang.ToString() == "0" || VarGeneral.CurrentLang.ToString() == string.Empty)
            {
        ...
        private void RibunButtons()
        {
            ...
            else
            {
                ...
                Text = "Sevices Types Card";
            }
        }
        private void FrmServiceTyp_Load(object sender, EventArgs e)
        {
            try
            {
                ComponentResourceManager resources = new ComponentResourceManager(typeof(FrmServiceTyp));
                ...
                {
                    columns_Names_visible.Add("Serv_No", new ColumnDictinary("رقم الخدمة", "Services No", ifDefault: true, string.Empty));
        ...
        private void textBox_ID_TextChanged(object sender, EventArgs e)
        {
            ...
            try
            {
                T_sertyp newData = db.StockServType(no.ToString());
                if (newData == null || newData.Serv_ID == 0)
                {
                    if (!Button_Add.Visible || !Button_Add.Enabled)
                    {
                        ...
                        try
                        {
                            textBox_ID.Text = data_this.Serv_No;
                        }
                        catch
                        {
                        }
                ...
                {
                    DataThis = newData;
                    int indexA = PKeys.IndexOf(newData.Serv_No ?? string.Empty);
                    indexA++;
                    TextBox_Index.InputTextChanged -= TextBox_Index_InputTextChanged;
        ...
        public void SetData(T_sertyp value)
        {
            try
            {
                State = FormState.Saved;
                Button_Save.Enabled = false;
                textBox_ID.Tag = value.Serv_ID;
                ...
                try
                {
                    ...
                    {
                        txtServiceAcc.Text = value.accno;
                        txtServiceAccName.Text = ((LangArEn == 0) ? db.StockAccDefWithOutBalance(value.accno).Arb_Des : db.StockAccDefWithOutBalance(value.accno).Eng_Des);
                    }
                    else
                    {
                        txtServiceAcc.Text = string.Empty;
                        txtServiceAccName.Text = string.Empty;
                    }
                }
                catch
                {
        ...
        private T_sertyp GetData()
        {
            textBox_ID.Focus();
            try
            {
                data_this.Serv_No = textBox_ID.Text;
            }
            catch
            {
            }
            ...
            data_this.accno = txtServiceAcc.Text;
        ...
        private void Button_Save_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (State == FormState.New)
                {
                    ...
                    try
                    {
                        db.T_sertyps.InsertOnSubmit(data_this);
                        db.SubmitChanges();
                    }
                    catch (SqlException ex3)
                    {
                        ...
                        data_this.Serv_No = string.Concat(max);
                        Button_Save_Click(sender, e);
                    }
                    catch (Exception)
                    {
                ...
                State = FormState.Saved;
                RefreshPKeys();
                TextBox_Index.TextBox.Text = string.Concat(PKeys.IndexOf(data_this.Serv_No ?? string.Empty) + 1);
                SetReadOnly = true;
            }
            catch (Exception error)
            {
        ...
        private void Button_Delete_Click(object sender, EventArgs e)
        {
            ...
            if (data_this == null || data_this.Serv_ID == 0 || !ifOkDelete)
            {
                return;
            }
            T_tran returned = db.SelectServTypeByReturnNo(DataThis.Serv_ID);
            if (returned != null && returned.typ.HasValue)
            {
                MessageBox.Show((LangArEn == 0) ? "لايمكن حذف النوع .. لانه مرتبط باحد خدمات النزلاء" : "The type can not be deleted ... because it is related to a guest service", VarGeneral.ProdectNam, MessageBoxButtons.OK, MessageBoxIcon.Hand);
                return;
            }
            data_this = db.StockServType(DataThis.Serv_No.ToString());
            try
            {
                db.T_sertyps.DeleteOnSubmit(DataThis);
                db.SubmitChanges();
            }
            catch (SqlException)
            {
        ...
        private void DGV_Main_DataBindingComplete(object sender, GridDataBindingCompleteEventArgs e)
        {
            ...
            if (dataMember != null && dataMember == "T_sertyp")
            {
        ...
        private void PropBranchPanel(GridPanel panel)
        {
            ...
            panel.Columns["Serv_No"].Width = 200;
            panel.Columns["Serv_No"].Visible = columns_Names_visible["Serv_No"].IfDefault;
            panel.ReadOnly = true;
        }
        ...
        private void Button_ExportTable2_Click(object sender, EventArgs e)
        {
            try
            {
                ExportExcel.ExportToExcel(DGV_Main, "تقرير أنواع الخدمات");
            }
            catch
            {
            }
        ...
        public void Button_Print_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                _RepShow.Tables = " T_sertyp left join T_SYSSETTING on T_SYSSETTING.SYSSETTING_ID = T_sertyp.CompanyID ";
                string Fields = string.Empty;
                Fields = " T_sertyp.Serv_No as No, T_sertyp.Arb_Des as NmA, T_sertyp.Eng_Des as NmE,T_SYSSETTING.LogImg ";
        ...
        private void InitializeComponent()
        {
            ...
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(InvAcc.Forms.FrmServiceTyp));
            ...
            txtServiceAccName = new DevComponents.DotNetBar.Controls.TextBoxX();
            txtServiceAcc = new DevComponents.DotNetBar.Controls.TextBoxX();
            ...
            panel2.Controls.Add(txtServiceAccName);
            panel2.Controls.Add(txtServiceAcc);
            panel2.Controls.Add(textBox_NameE);
            ...
            panel2.Name = "panel2";
            txtServiceAccName.BackColor = System.Drawing.Color.White;
            txtServiceAccName.Border.CornerType = DevComponents.DotNetBar.eCornerType.Square;
            resources.ApplyResources(txtServiceAccName, "txtServiceAccName");
            txtServiceAccName.ForeColor = System.Drawing.Color.FromArgb(192, 0, 0);
            txtServiceAccName.Name = "txtServiceAccName";
            txtServiceAccName.ReadOnly = true;
            txtServiceAccName.Click += new System.EventHandler(txtServiceAccName_Click);
            txtServiceAcc.BackColor = System.Drawing.SystemColors.Control;
            txtServiceAcc.Border.CornerType = DevComponents.DotNetBar.eCornerType.Square;
            txtServiceAcc.ButtonCustom.Visible = true;
            resources.ApplyResources(txtServiceAcc, "txtServiceAcc");
            txtServiceAcc.ForeColor = System.Drawing.SystemColors.ControlText;
            txtServiceAcc.Name = "txtServiceAcc";
            txtServiceAcc.ReadOnly = true;
            txtServiceAcc.ButtonCustomClick += new System.EventHandler(txtServiceAcc_ButtonCustomClick);
            txtServiceAcc.Click += new System.EventHandler(txtServiceAcc_Click);
            ...
            label72.BackColor = System.Drawing.Color.Gainsboro;
            ...
            base.Name = "FrmServiceTyp";
            base.Load += new System.EventHandler(FrmServiceTyp_Load);
