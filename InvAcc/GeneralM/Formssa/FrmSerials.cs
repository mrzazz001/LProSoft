...
{
    public partial class FrmSerials : Form
    {
        ...
        private T_ItemSerial data_this;
        ...
        public void Button_Search_Click(object sender, EventArgs e)
        {
            ...
            VarGeneral.SFrmTyp = "T_ItemSerial";
            frm.TopMost = true;
            frm.ShowDialog();
            if (frm.SerachNo != "")
            {
        ...
        {
            DGV_Main.PrimaryGrid.VirtualMode = false;
            List<T_ItemSerial> list = db.FillItemSerial_2(textBox_search.TextBox.Text).ToList();
        ...
        public void FillHDGV(IEnumerable<T_ItemSerial> new_data_enum)
        {
            ...
            DGV_Main.PrimaryGrid.DataMember = "T_ItemSerial";
        ...
        public void Clear()
        {
            ...
            textBox_ID.Focus();
            checkBox_SerialStatus.Value = false;
            textBox_itemNo.Text = vitemNo;
            SetReadOnly = false;
        }
        ...
        private void Frm_KeyDown(object sender, KeyEventArgs e)
        {
            ...
            else
            {
                ...
                try
                {
                    if (int.Parse(Label_Count.Text) > 1)
                    {
        ...
        {
            PKeys.Clear();
            var qkeys = from item in db.T_ItemSerials
                        where item.ItmNo == vitemNo
                        orderby item.id
                        select new
                        {
                            Code = item.SerialKey + ""
        ...
        public FrmSerials()
        {
            ...
            controls.Add(checkBox_SerialStatus);
            Button_Close.Click += Button_Close_Click;
            textBox_ID.Click += Button_Edit_Click;
            checkBox_SerialStatus.Click += Button_Edit_Click;
        ...
        {
            ComponentResourceManager resources = new ComponentResourceManager(typeof(FrmSerials));
            if (VarGeneral.CurrentLang.ToString() == "0" || VarGeneral.CurrentLang.ToString() == "")
            {
        ...
        private void RibunButtons()
        {
            ...
            else
            {
                ...
                checkBox_SerialStatus.OffText = "Not Used";
                checkBox_SerialStatus.OnText = "It's Used";
                Text = "Serials Card";
            }
        }
        private void FrmSerials_Load(object sender, EventArgs e)
        {
            try
            {
                if (!string.IsNullOrEmpty(vitemNo))
                {
                    ...
                    {
                        columns_Names_visible.Add("SerialKey", new ColumnDictinary("رقم السيريال", "Serial No", ifDefault: true, ""));
                        columns_Names_visible.Add("ItmNo", new ColumnDictinary("رقم الصنف", "Item No", ifDefault: true, ""));
                    }
                    else
                    {
                        Clear();
        ...
        private void textBox_ID_TextChanged(object sender, EventArgs e)
        {
            try
            {
                T_ItemSerial newData = db.StockItemSerial(textBox_ID.Text);
                if (newData == null || newData.id == 0)
                {
                    if (!Button_Add.Visible || !Button_Add.Enabled)
                    {
                        ...
                        try
                        {
                            textBox_ID.Text = data_this.SerialKey;
                        }
                        catch
                        {
                        }
                ...
                {
                    DataThis = newData;
                    int indexA = PKeys.IndexOf(newData.SerialKey ?? "");
                    indexA++;
                    TextBox_Index.InputTextChanged -= TextBox_Index_InputTextChanged;
        ...
        public void SetData(T_ItemSerial value)
        {
            try
            {
                State = FormState.Saved;
                ...
                textBox_itemNo.Text = value.ItmNo;
                checkBox_SerialStatus.Value = value.SerialStatus.Value;
            }
            catch (Exception error)
            {
        ...
        private T_ItemSerial GetData()
        {
            textBox_ID.Focus();
            try
            {
                data_this.SerialKey = textBox_ID.Text;
            }
            catch
            {
            }
            try
            {
                data_this.ItmNo = textBox_itemNo.Text;
            }
            catch
            {
            }
        ...
        private void Button_Save_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                textBox_ID.Focus();
                if (textBox_ID.Text == "" || textBox_itemNo.Text == "")
                {
                    MessageBox.Show((LangArEn == 0) ? "لايمكن ان يكون رقم الصنف او رقم السيريال فارغا" : "Can not be a number or name is empty", VarGeneral.ProdectNam, MessageBoxButtons.OK, MessageBoxIcon.Hand);
                    return;
                }
                if (State == FormState.New)
                {
                    GetData();
                    data_this.SerialStatus = false;
                    try
                    {
                        db.T_ItemSerials.InsertOnSubmit(data_this);
                        db.SubmitChanges();
                    }
                    catch (SqlException ex3)
                    {
                        if (ex3.Number == 2627)
                        {
                            MessageBox.Show("رقم السيريال مستخدم من قبل", VarGeneral.ProdectNam, MessageBoxButtons.OK, MessageBoxIcon.Question);
                        }
                        return;
                    }
                    catch (Exception)
                ...
                State = FormState.Saved;
                RefreshPKeys();
                TextBox_Index.TextBox.Text = string.Concat(PKeys.IndexOf(data_this.SerialKey ?? "") + 1);
                SetReadOnly = true;
            }
            catch (Exception error)
            {
        ...
        private void Button_Delete_Click(object sender, EventArgs e)
        {
            ...
            data_this = db.StockItemSerial(DataThis.SerialKey.ToString());
            if (data_this.SerialStatus.Value)
            {
                MessageBox.Show((LangArEn == 0) ? "لايمكن حذف السيريال .. لانه مرتبط باحد الفواتير" : "You can not delete Serial .. because it is tied to a Invoices", VarGeneral.ProdectNam, MessageBoxButtons.OK, MessageBoxIcon.Hand);
                return;
            }
            try
            {
                db.T_ItemSerials.DeleteOnSubmit(DataThis);
                db.SubmitChanges();
            }
            catch (SqlException)
            {
        ...
        private void DGV_Main_DataBindingComplete(object sender, GridDataBindingCompleteEventArgs e)
        {
            ...
            if (dataMember != null && dataMember == "T_ItemSerial")
            {
        ...
        private void PropBranchPanel(GridPanel panel)
        {
            ...
            panel.Columns["ItmNo"].Width = 250;
            panel.Columns["ItmNo"].Visible = columns_Names_visible["ItmNo"].IfDefault;
            panel.Columns["SerialKey"].Width = 300;
            panel.Columns["SerialKey"].Visible = columns_Names_visible["SerialKey"].IfDefault;
            panel.ReadOnly = true;
        }
        ...
        private void Button_ExportTable2_Click(object sender, EventArgs e)
        {
            try
            {
                ExportExcel.ExportToExcel(DGV_Main, "تقرير سيريالات الأصناف");
            }
            catch
            {
            }
        ...
        public void Button_Print_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                _RepShow.Tables = " T_Items INNER JOIN  T_ItemSerial ON T_Items.Itm_No = T_ItemSerial.ItmNo INNER JOIN T_SYSSETTING ON T_Items.CompanyID = T_SYSSETTING.SYSSETTING_ID ";
                string Fields = "";
                Fields = " T_ItemSerial.SerialKey as NmA , T_ItemSerial.ItmNo as No, case when T_ItemSerial.SerialStatus = 0 then 'غير مستخدم' else 'غير مستخدم' end as NmE,T_SYSSETTING.LogImg ";
                _RepShow.Rule = "";
        ...
        private void InitializeComponent()
        {
            ...
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(FrmSerials));
            ...
            this.checkBox_SerialStatus = new DevComponents.DotNetBar.Controls.SwitchButton();
            ...
            this.ribbonBar1.Controls.Add(this.checkBox_SerialStatus);
            ...
            this.ribbonBar1.Controls.Add(this.textBox_itemNo);
            ...
            // 
            // checkBox_SerialStatus
            // 
            // 
            // 
            // 
            this.checkBox_SerialStatus.BackgroundStyle.CornerType = DevComponents.DotNetBar.eCornerType.Square;
            this.checkBox_SerialStatus.IsReadOnly = true;
            this.checkBox_SerialStatus.Location = new System.Drawing.Point(-210, 114);
            this.checkBox_SerialStatus.Name = "checkBox_SerialStatus";
            this.checkBox_SerialStatus.OffText = "غير مستخدم";
            this.checkBox_SerialStatus.OnText = "مستخدم";
            this.checkBox_SerialStatus.Size = new System.Drawing.Size(176, 31);
            this.checkBox_SerialStatus.Style = DevComponents.DotNetBar.eDotNetBarStyle.StyleManagerControlled;
            this.checkBox_SerialStatus.TabIndex = 87;
            // 
            // textBox_ID
            // 
            this.textBox_ID.BackColor = System.Drawing.Color.FromArgb(((int)(((byte)(255)))), ((int)(((byte)(224)))), ((int)(((byte)(192)))));
            this.textBox_ID.BorderStyle = System.Windows.Forms.BorderStyle.FixedSingle;
            this.textBox_ID.Font = new System.Drawing.Font("Tahoma", 9F, System.Drawing.FontStyle.Bold);
            this.textBox_ID.Location = new System.Drawing.Point(68, 94);
            this.textBox_ID.Name = "textBox_ID";
            this.textBox_ID.Size = new System.Drawing.Size(395, 22);
            ...
            this.label38.Location = new System.Drawing.Point(470, 98);
            this.label38.Name = "label38";
            this.label38.Size = new System.Drawing.Size(74, 13);
            this.label38.TabIndex = 81;
            this.label38.Text = "رقم السيريال :";
            // 
            // label36
            // 
            ...
            this.label36.Text = "رقم الصنف :";
            // 
            // textBox_itemNo
            // 
            this.textBox_itemNo.BorderStyle = System.Windows.Forms.BorderStyle.FixedSingle;
            this.textBox_itemNo.Font = new System.Drawing.Font("Tahoma", 8F);
            this.textBox_itemNo.ForeColor = System.Drawing.Color.Black;
            this.textBox_itemNo.Location = new System.Drawing.Point(287, 55);
            this.textBox_itemNo.MaxLength = 30;
            this.textBox_itemNo.Name = "textBox_itemNo";
            this.textBox_itemNo.ReadOnly = true;
            this.textBox_itemNo.Size = new System.Drawing.Size(176, 20);
            ...
            this.Name = "FrmSerials";
            this.RightToLeft = System.Windows.Forms.RightToLeft.Yes;
            this.RightToLeftLayout = true;
            this.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
            this.Text = "كرت السيريالات";
            this.Load += new System.EventHandler(this.FrmSerials_Load);
