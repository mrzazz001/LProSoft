...
{
    public partial class FMStockAdjustment : Form
    {
        ...
        public T_User Permmission
        {
            ...
            set
            {
                ...
                if (!VarGeneral.TString.ChkStatShow(value.InvStr, 64) || switchButton_Lock.Value)
                {
            ...
            try
            {
                ...
                if ((_InvSetting.InvpRINTERInfo.nTyp.Substring(0, 1) == "1" && !VarGeneral.TString.ChkStatShow(permission.StopBanner, 2)) || (_InvSetting.InvpRINTERInfo.nTyp.Substring(0, 1) == "0" && VarGeneral.TString.ChkStatShow(permission.StopBanner, 2)))
                {
                    ...
                    try
                    {
                        ...
                        if (VarGeneral.TString.ChkStatShow(Permmission.PeaperTyp, 12))
                        {
                            if (frm.Repvalue == "OpenQtyEqual")
                            {
                                frm.RepCashier = "InvoiceCachier";
                            }
                            else
        ...
        private void ArbEng()
        {
            if (VarGeneral.CurrentLang.ToString() == "0" || VarGeneral.CurrentLang.ToString() == "")
            {
                ...
                FlxInv.Cols[33].Visible = VarGeneral.TString.ChkStatShow(_SysSetting.LineGiftSts, 24);
        ...
        {
            ComponentResourceManager resources = new ComponentResourceManager(typeof(FMStockAdjustment));
            if (VarGeneral.CurrentLang.ToString() == "0" || VarGeneral.CurrentLang.ToString() == "")
            {
        ...
        private void FMStockAdjustment_Load(object sender, EventArgs e)
        {
            try
            {
        ...
        private void FMStockAdjustment_KeyUp(object sender, KeyEventArgs e)
        {
        ...
        private bool SaveData()
        {
            ...
            try
            {
                ...
                {
                    VarGeneral.DebLog.writeLog("LinesInv_Save_StockAdjustment:", ex3, enable: true);
        ...
        private void CreateCostGaidDis(string AccCrdt_Cost, string AccDbt_Cost)
        {
            ...
            using (Stock_DataDataContext dbc = new Stock_DataDataContext(VarGeneral.BranchCS))
            {
                ...
                db_.AddParameter("gdNo", DbType.String, textBox_ID.Text);
                db_.AddParameter("gdDes", DbType.String, "سند بقيمة الخصم لفاتورة تسوية البضاعة رقم : " + textBox_ID.Text);
                db_.AddParameter("gdDesE", DbType.String, "Discount Value To Settlement goods Invoice No : " + textBox_ID.Text);
        ...
        private void CreateCostGaidTax(string AccCrdt_Cost, string AccDbt_Cost)
        {
            ...
            using (Stock_DataDataContext dbc = new Stock_DataDataContext(VarGeneral.BranchCS))
            {
                ...
                db_.AddParameter("gdNo", DbType.String, textBox_ID.Text);
                db_.AddParameter("gdDes", DbType.String, "سند بقيمة الضريبة لفاتورة تسوية البضاعة رقم : " + textBox_ID.Text);
                db_.AddParameter("gdDesE", DbType.String, "Tax Value To Settlement goods Invoice No : " + textBox_ID.Text);
                db_.AddParameter("recptTyp", DbType.String, "1");
                db_.AddParameter("AccNo", DbType.String, AccCrdt_Cost);
                db_.AddParameter("AccName", DbType.String, "");
        ...
        private void button_AllItems_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                List<T_Item> q = new List<T_Item>();
                try
                {
                    q = db.ExecuteQuery<T_Item>("select * from T_Items order by  CONVERT(INT, LEFT(T_Items.Itm_No, PATINDEX('%[^0-9]%', T_Items.Itm_No + 'z')-1))", new object[0]).ToList();
                }
                catch
                {
                    q = db.ExecuteQuery<T_Item>("select * from T_Items order by T_Items.Itm_No ", new object[0]).ToList();
                }
                if (q.Count > 0)
                {
                    FlxInv.Clear(ClearFlags.Content, 1, 1, FlxInv.Rows.Count - 1, 38);
            ...
            {
                VarGeneral.DebLog.writeLog("button_AllItems_Click:", error, enable: true);
                MessageBox.Show(error.Message);
            }
            StockAdjust = false;
        }
        private void button_SomeItems_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (frm.vSts_Op && !string.IsNullOrEmpty(frm.List_Cat))
                {
                    ...
                    try
                    {
                        q = db.ExecuteQuery<T_Item>("select * from T_Items where 1 = 1 " + frm.List_Cat + " order by  CONVERT(INT, LEFT(T_Items.Itm_No, PATINDEX('%[^0-9]%', T_Items.Itm_No + 'z')-1))", new object[0]).ToList();
                    }
                    catch
                    {
                        q = db.ExecuteQuery<T_Item>("select * from T_Items where 1 = 1 " + frm.List_Cat + " order by T_Items.Itm_No ", new object[0]).ToList();
                    }
                    if (q.Count > 0)
                    {
                        FlxInv.Clear(ClearFlags.Content, 1, 1, FlxInv.Rows.Count - 1, 38);
            ...
            {
                VarGeneral.DebLog.writeLog("button_SomeItems_Click:", error, enable: true);
                MessageBox.Show(error.Message);
            }
            StockAdjust = false;
        }
        ...
        private void InitializeComponent()
        {
            ...
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(FMStockAdjustment));
            ...
            this.switchButton_Lock.Location = new System.Drawing.Point(677, 6);
            ...
            this.FlxDat.Location = new System.Drawing.Point(424, 145);
            ...
            this.superTabControl_Info.Location = new System.Drawing.Point(280, 312);
            ...
            this.superTabControl_Info.Size = new System.Drawing.Size(986, 131);
        ...
        System.Drawing.Color.White};
            ...
            this.superTabControlPanel3.Size = new System.Drawing.Size(986, 106);
            ...
            this.FlxStkQty.Location = new System.Drawing.Point(732, 3);
            this.FlxStkQty.Name = "FlxStkQty";
            this.FlxStkQty.Rows.DefaultSize = 19;
            this.FlxStkQty.Size = new System.Drawing.Size(251, 100);
            ...
            this.txtUnit.Location = new System.Drawing.Point(451, 65);
            ...
            this.txtLPrice.Location = new System.Drawing.Point(451, 45);
            ...
            this.txtLCost.Location = new System.Drawing.Point(451, 25);
            ...
            this.txtVCost.Location = new System.Drawing.Point(451, 5);
            ...
            this.dataGridView_ItemDet.Size = new System.Drawing.Size(722, 100);
        ...
        System.Drawing.Color.White};
            ...
            this.superTabControlPanel1.Size = new System.Drawing.Size(986, 106);
            ...
            this.txtCredit1.Size = new System.Drawing.Size(705, 16);
            ...
            this.txtDebit1.Size = new System.Drawing.Size(705, 16);
            ...
            this.labelC1.Location = new System.Drawing.Point(913, 49);
            ...
            this.labelD1.Location = new System.Drawing.Point(914, 20);
        ...
        System.Drawing.Color.White};
            ...
            this.superTabControlPanel2.Size = new System.Drawing.Size(986, 106);
            ...
            this.label_LockeName.Size = new System.Drawing.Size(132, 106);
            ...
            this.textBox_Usr.Location = new System.Drawing.Point(588, 52);
        ...
        System.Drawing.Color.Empty};
            ...
            this.superTabControlPanel4.Size = new System.Drawing.Size(986, 106);
            ...
            this.txtRemark.Size = new System.Drawing.Size(986, 106);
        ...
        System.Drawing.Color.Empty};
            ...
            this.superTabControlPanel5.Size = new System.Drawing.Size(986, 106);
            ...
            this.superTabControl_CostSts.Size = new System.Drawing.Size(986, 106);
        ...
        System.Drawing.Color.White};
            ...
            this.superTabControlPanel6.Size = new System.Drawing.Size(986, 82);
            ...
            this.label34.Location = new System.Drawing.Point(892, 34);
            ...
            this.label35.Location = new System.Drawing.Point(892, 11);
            ...
            this.txtCredit5.Location = new System.Drawing.Point(116, 33);
            ...
            this.txtCredit5.Size = new System.Drawing.Size(770, 14);
        ...
        System.Drawing.Color.White};
            ...
            this.superTabControlPanel7.Size = new System.Drawing.Size(986, 106);
            ...
            this.label31.Location = new System.Drawing.Point(837, 6);
            ...
            this.label37.Location = new System.Drawing.Point(662, 33);
            ...
            this.label38.Location = new System.Drawing.Point(662, 10);
            ...
            this.txtCredit6.Size = new System.Drawing.Size(540, 14);
            ...
            this.txtDebit6.Size = new System.Drawing.Size(540, 14);
            ...
            this.label39.Location = new System.Drawing.Point(736, 6);
            ...
            this.txtTotDis.Location = new System.Drawing.Point(837, 29);
            ...
            this.txtTotDisLoc.Location = new System.Drawing.Point(736, 29);
        ...
        System.Drawing.Color.Empty};
            ...
            this.txtTime.Location = new System.Drawing.Point(677, 33);
            this.txtTime.Mask = "##:##";
            this.txtTime.Name = "txtTime";
            this.txtTime.Size = new System.Drawing.Size(193, 20);
            ...
            this.textBox_ID.Location = new System.Drawing.Point(799, 9);
            ...
            this.textBox_ID.Size = new System.Drawing.Size(391, 21);
            ...
            this.Label2.Location = new System.Drawing.Point(1196, 37);
            ...
            this.FlxInv.Location = new System.Drawing.Point(6, 105);
            ...
            this.FlxInv.Size = new System.Drawing.Size(1269, 201);
            ...
            this.checkBox_Chash.Location = new System.Drawing.Point(-71, 20);
            ...
            this.txtHDate.Location = new System.Drawing.Point(876, 33);
            this.txtHDate.Mask = "0000/00/00";
            this.txtHDate.Name = "txtHDate";
            this.txtHDate.Size = new System.Drawing.Size(175, 20);
            ...
            this.label33.Location = new System.Drawing.Point(178, 91);
            this.label33.Name = "label33";
            this.label33.Size = new System.Drawing.Size(84, 21);
            this.label33.TabIndex = 1151;
            this.label33.Text = "قيمه الضرايبه :";
            ...
            this.groupPanel_Items.Location = new System.Drawing.Point(6, 107);
            ...
            this.groupPanel_Items.TabIndex = 1587;
            ...
            this.txtGDate.Location = new System.Drawing.Point(1057, 33);
            this.txtGDate.Mask = "0000/00/00";
            this.txtGDate.Name = "txtGDate";
            this.txtGDate.Size = new System.Drawing.Size(133, 20);
            ...
            this.doubleInput_Rate.Location = new System.Drawing.Point(677, 57);
            ...
            this.CmbCostC.Location = new System.Drawing.Point(13, 10);
            this.CmbCostC.Name = "CmbCostC";
            this.CmbCostC.Size = new System.Drawing.Size(549, 20);
            ...
            this.CmbCurr.Location = new System.Drawing.Point(737, 57);
            this.CmbCurr.Name = "CmbCurr";
            this.CmbCurr.Size = new System.Drawing.Size(453, 20);
            ...
            this.CmbLegate.Location = new System.Drawing.Point(14, 34);
            this.CmbLegate.Name = "CmbLegate";
            this.CmbLegate.Size = new System.Drawing.Size(548, 20);
            ...
            this.txtRef.Location = new System.Drawing.Point(677, 81);
            ...
            this.txtRef.Size = new System.Drawing.Size(513, 21);
            ...
            this.label15.Location = new System.Drawing.Point(568, 13);
            ...
            this.label19.Location = new System.Drawing.Point(1196, 61);
            ...
            this.label18.Location = new System.Drawing.Point(568, 37);
            ...
            this.label7.Location = new System.Drawing.Point(1196, 85);
            ...
            this.CmbInvPrice.Location = new System.Drawing.Point(13, 58);
            this.CmbInvPrice.Name = "CmbInvPrice";
            this.CmbInvPrice.Size = new System.Drawing.Size(549, 20);
            ...
            this.superTabControl_Main1.Size = new System.Drawing.Size(811, 51);
        ...
        System.Drawing.Color.Empty};
            ...
            this.superTabControl_Main2.Location = new System.Drawing.Point(811, 0);
        ...
        System.Drawing.Color.Empty};
            ...
            this.Name = "FMStockAdjustment";
            this.RightToLeft = System.Windows.Forms.RightToLeft.Yes;
            this.RightToLeftLayout = true;
            this.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
            this.Text = "تسوية البضاعة";
            this.Load += new System.EventHandler(this.FMStockAdjustment_Load);
            this.Shown += new System.EventHandler(this.FrmInvSale_Shown);
            this.SizeChanged += new System.EventHandler(this.FrmInvSale_SizeChanged);
            this.KeyDown += new System.Windows.Forms.KeyEventHandler(this.Frm_KeyDown);
            this.KeyPress += new System.Windows.Forms.KeyPressEventHandler(this.Frm_KeyPress);
            this.KeyUp += new System.Windows.Forms.KeyEventHandler(this.FMStockAdjustment_KeyUp);
