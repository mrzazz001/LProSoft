...
{
    public partial class FrmAinNatural : Form
    {
        ...
        private T_AinNatural data_this;
        ...
        private void InitializeComponent()
        {
            ...
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(FrmAinNatural));
            ...
            this.panelEx2.MinimumSize = new System.Drawing.Size(649, 205);
            this.panelEx2.Name = "panelEx2";
            this.panelEx2.Size = new System.Drawing.Size(649, 205);
            ...
            this.ribbonBar1.Size = new System.Drawing.Size(649, 154);
            ...
            this.ribbonBar_Tasks.Location = new System.Drawing.Point(0, 154);
            ...
            this.barBottomDockSite.Location = new System.Drawing.Point(0, 218);
            ...
            this.barLeftDockSite.Size = new System.Drawing.Size(0, 218);
            ...
            this.barRightDockSite.Size = new System.Drawing.Size(0, 218);
            ...
            this.dockSite4.Location = new System.Drawing.Point(0, 218);
            ...
            this.dockSite1.Size = new System.Drawing.Size(0, 218);
            ...
            this.dockSite2.Size = new System.Drawing.Size(0, 218);
            ...
            this.Name = "FrmAinNatural";
            this.RightToLeft = System.Windows.Forms.RightToLeft.Yes;
            this.RightToLeftLayout = true;
            this.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
            this.Text = "كــــــرت طبيعة العيون";
            this.Load += new System.EventHandler(this.FrmAinNatural_Load);
        ...
        {
            DGV_Main.PrimaryGrid.VirtualMode = false;
            List<T_AinNatural> list = db.FillAinNatural_2(textBox_search.TextBox.Text).ToList();
        ...
        public void FillHDGV(IEnumerable<T_AinNatural> new_data_enum)
        {
            ...
            DGV_Main.PrimaryGrid.DataMember = "T_AinNatural";
        ...
        {
            PKeys.Clear();
            var qkeys = db.T_AinNaturals.Select((T_AinNatural item) => new
            {
                Code = item.AinNatural_No + ""
            });
            int count = 0;
        ...
        {
            ComponentResourceManager resources = new ComponentResourceManager(typeof(FrmAinNatural));
            if (VarGeneral.CurrentLang.ToString() == "0" || VarGeneral.CurrentLang.ToString() == "")
            {
        ...
        private void RibunButtons()
        {
            if (VarGeneral.CurrentLang.ToString() == "0" || VarGeneral.CurrentLang.ToString() == "")
            {
                ...
                textBox_Note.WatermarkText = "ملاحظـــــــات";
                Text = "كرت طبيعة العيون";
            }
            else
            {
                ...
                Text = "Eyes Natural Card";
            }
        }
        private void FrmAinNatural_Load(object sender, EventArgs e)
        {
            try
            {
                ComponentResourceManager resources = new ComponentResourceManager(typeof(FrmAinNatural));
        ...
        private void textBox_ID_TextChanged(object sender, EventArgs e)
        {
            ...
            try
            {
                T_AinNatural newData = db.AinNaturalEmp(no);
                if (newData == null || newData.AinNatural_No == 0 || string.IsNullOrEmpty(newData.AinNatural_ID))
                {
                    if (!Button_Add.Visible || !Button_Add.Enabled)
                    {
                        ...
                        try
                        {
                            textBox_ID.Text = data_this.AinNatural_No.ToString();
                        }
                        catch
                        {
                        }
                ...
                {
                    DataThis = newData;
                    int indexA = PKeys.IndexOf(string.Concat(newData.AinNatural_No));
                    indexA++;
                    TextBox_Index.InputTextChanged -= TextBox_Index_InputTextChanged;
                ...
                try
                {
                    if (data_this.AinNatural_No == 1 || data_this.AinNatural_No == 2)
                    {
                        IfDelete = false;
                        CanEdit = false;
                    }
        ...
        public void SetData(T_AinNatural value)
        {
            try
            {
                State = FormState.Saved;
                ...
                textBox_ID.Tag = value.AinNatural_ID;
                Permmission = dbc.Get_PermissionID(VarGeneral.UserID);
            }
            catch (Exception error)
            {
        ...
        private T_AinNatural GetData()
        {
            textBox_ID.Focus();
            try
            {
                data_this.AinNatural_No = int.Parse(textBox_ID.Text);
            }
            catch
            {
            }
        ...
        private void Button_Save_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (State == FormState.New)
                {
                    ...
                    try
                    {
                        data_this.AinNatural_ID = textBox_ID.Tag.ToString();
                        db.T_AinNaturals.InsertOnSubmit(data_this);
                        db.SubmitChanges();
                    }
                ...
                State = FormState.Saved;
                RefreshPKeys();
                TextBox_Index.TextBox.Text = string.Concat(PKeys.IndexOf(string.Concat(data_this.AinNatural_No)) + 1);
                SetReadOnly = true;
            }
            catch (Exception error)
            {
        ...
        private void DGV_Main_DataBindingComplete(object sender, GridDataBindingCompleteEventArgs e)
        {
            ...
            if (dataMember != null && dataMember == "T_AinNatural")
            {
        ...
        private void PropBranchPanel(GridPanel panel)
        {
            ...
            panel.Columns["AinNatural_No"].Width = 120;
            panel.Columns["AinNatural_No"].Visible = columns_Names_visible["AinNatural_No"].IfDefault;
            panel.ReadOnly = true;
        }
        ...
        private void Button_ExportTable2_Click(object sender, EventArgs e)
        {
            try
            {
                ExportExcel.ExportToExcel(DGV_Main, "تقرير طبيعة العيون");
            }
            catch
            {
            }
        ...
        public void Button_Print_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                string Fields = "";
                Fields = " T_AinNatural.AinNatural_No as No, T_AinNatural.NameA as NmA, T_AinNatural.NameE as NmE,(select T_SYSSETTING.LogImg from T_SYSSETTING) as LogImg ";
                _RepShow.Rule = "";
