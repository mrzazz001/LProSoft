...
{
    public partial class FrmRepDiscount : Form
    {
        ...
        private MaskedTextBox dateTimeInput_DisTo;
        private MaskedTextBox dateTimeInput_DisFrom;
        ...
        private void FrmRepDiscount_Load(object sender, EventArgs e)
        {
            try
            {
                ComponentResourceManager resources = new ComponentResourceManager(typeof(FrmRepDiscount));
                if (VarGeneral.CurrentLang.ToString() == "0" || VarGeneral.CurrentLang.ToString() == "")
                {
                ...
                RibunButtons();
                FillGrid();
                List<string> q = (from t in db.T_SalDiscounts
                                  orderby t.warnDate
                                  where t.warnDate != ""
                                  select t.warnDate).ToList();
                if (q.Count == 0)
                {
                    dateTimeInput_DisFrom.Text = "";
                    dateTimeInput_DisTo.Text = "";
                }
                else
                {
                    dateTimeInput_DisFrom.Text = Convert.ToDateTime(q.First()).ToString("yyyy/MM/dd");
                    dateTimeInput_DisTo.Text = Convert.ToDateTime(q.Last()).ToString("yyyy/MM/dd");
                }
            }
        ...
        private void FrmRepDiscount_KeyPress(object sender, KeyPressEventArgs e)
        {
            if (e.KeyChar == '\r')
            {
                SendKeys.Send("{Tab}");
        ...
        private void FrmRepDiscount_KeyDown(object sender, KeyEventArgs e)
        {
        ...
        private void dateTimeInput_DisFrom_Leave(object sender, EventArgs e)
        {
            try
            {
                dateTimeInput_DisFrom.Text = Convert.ToDateTime(dateTimeInput_DisFrom.Text).ToString("yyyy/MM/dd");
            }
            catch
            {
                dateTimeInput_DisFrom.Text = "";
        ...
        private void dateTimeInput_DisTo_Leave(object sender, EventArgs e)
        {
            try
            {
                dateTimeInput_DisTo.Text = Convert.ToDateTime(dateTimeInput_DisTo.Text).ToString("yyyy/MM/dd");
            }
            catch
            {
                dateTimeInput_DisTo.Text = "";
        ...
        private string GetSqlWhere()
        {
            ...
            if (dateTimeInput_DisFrom.Text != "    /  /" && dateTimeInput_DisFrom.Text.Length == 10)
            {
                QStr = QStr + " AND ( warnDate >= '" + Convert.ToDateTime(dateTimeInput_DisFrom.Text).ToString("yyyy/MM/dd") + "' ) ";
            }
            if (dateTimeInput_DisTo.Text != "    /  /" && dateTimeInput_DisTo.Text.Length == 10)
            {
                QStr = QStr + " AND ( warnDate <= '" + Convert.ToDateTime(dateTimeInput_DisTo.Text).ToString("yyyy/MM/dd") + "' ) ";
            }
            return QStr;
        }
        ...
        {
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(InvAcc.Forms.FrmRepDiscount));
            ...
            dateTimeInput_DisTo = new System.Windows.Forms.MaskedTextBox();
            dateTimeInput_DisFrom = new System.Windows.Forms.MaskedTextBox();
            ...
            groupBox_Date.Controls.Add(dateTimeInput_DisTo);
            groupBox_Date.Controls.Add(dateTimeInput_DisFrom);
            ...
            resources.ApplyResources(dateTimeInput_DisTo, "dateTimeInput_DisTo");
            dateTimeInput_DisTo.Name = "dateTimeInput_DisTo";
            dateTimeInput_DisTo.Leave += new System.EventHandler(dateTimeInput_DisTo_Leave);
            dateTimeInput_DisTo.Click += new System.EventHandler(dateTimeInput_AddTo_Click);
            resources.ApplyResources(dateTimeInput_DisFrom, "dateTimeInput_DisFrom");
            dateTimeInput_DisFrom.Name = "dateTimeInput_DisFrom";
            dateTimeInput_DisFrom.Leave += new System.EventHandler(dateTimeInput_DisFrom_Leave);
            dateTimeInput_DisFrom.Click += new System.EventHandler(dateTimeInput_AddFrom_Click);
            ...
            base.Name = "FrmRepDiscount";
            base.Load += new System.EventHandler(FrmRepDiscount_Load);
            base.KeyPress += new System.Windows.Forms.KeyPressEventHandler(FrmRepDiscount_KeyPress);
            base.KeyDown += new System.Windows.Forms.KeyEventHandler(FrmRepDiscount_KeyDown);
