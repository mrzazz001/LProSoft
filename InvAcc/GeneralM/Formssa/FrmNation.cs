...
namespace InvAcc.Forms
{
    public partial class FrmNation : Form
    {
        ...
        private T_Nationality data_this;
        ...
        private void InitializeComponent()
        {
            ...
            this.PanelSpecialContainer.Size = new System.Drawing.Size(649, 317);
            ...
            this.ribbonBar1.Size = new System.Drawing.Size(649, 266);
            ...
            this.groupBox2.Location = new System.Drawing.Point(68, 132);
            this.groupBox2.Name = "groupBox2";
            this.groupBox2.Size = new System.Drawing.Size(224, 92);
            this.groupBox2.TabIndex = 6680;
            ...
            this.label8.Text = "يخصم من الراتب :";
            // 
            // textBox_CompPaying
            // 
            ...
            this.textBox_CompPaying.Font = new System.Drawing.Font("Tahoma", 8.25F, System.Drawing.FontStyle.Bold);
            this.textBox_CompPaying.ForeColor = System.Drawing.Color.FromArgb(((int)(((byte)(64)))), ((int)(((byte)(64)))), ((int)(((byte)(64)))));
            ...
            this.textBox_CompPaying.Location = new System.Drawing.Point(35, 58);
            ...
            this.textBox_CompPaying.ShowUpDown = true;
            ...
            this.textBox_SalSubtract.Font = new System.Drawing.Font("Tahoma", 8.25F, System.Drawing.FontStyle.Bold);
            this.textBox_SalSubtract.ForeColor = System.Drawing.Color.FromArgb(((int)(((byte)(64)))), ((int)(((byte)(64)))), ((int)(((byte)(64)))));
            ...
            this.textBox_SalSubtract.Location = new System.Drawing.Point(35, 22);
            ...
            this.textBox_SalSubtract.ShowUpDown = true;
            ...
            this.textBox_Note.Location = new System.Drawing.Point(298, 137);
            this.textBox_Note.Multiline = true;
            this.textBox_Note.Name = "textBox_Note";
            this.netResize1.SetResizeTextBoxMultiline(this.textBox_Note, false);
            this.textBox_Note.Size = new System.Drawing.Size(296, 89);
            ...
            this.textBox_Note.WatermarkText = "ملاحظـــــــات الجنسيـة";
            // 
            // textBox_NameE
            // 
            ...
            this.label40.Text = "إسم الجنسية - انجليزي :";
            // 
            // textBox_NameA
            // 
            ...
            this.label36.Text = "إسم الجنسية - عربـــي :";
            // 
            // textBox_ID
            // 
            ...
            this.ribbonBar_Tasks.Location = new System.Drawing.Point(0, 266);
            ...
            this.Text = "كــــــرت الجنسيـــات";
        ...
        {
            DGV_Main.PrimaryGrid.VirtualMode = false;
            List<T_Nationality> list = db.FillNation_2(textBox_search.TextBox.Text).ToList();
        ...
        public void FillHDGV(IEnumerable<T_Nationality> new_data_enum)
        {
            ...
            DGV_Main.PrimaryGrid.DataMember = "T_Nationality";
        ...
        {
            PKeys.Clear();
            var qkeys = db.T_Nationalities.Select((T_Nationality item) => new
            {
                Code = item.Nation_No + ""
            });
            int count = 0;
        ...
        public FrmNation()
        {
            ...
            textBox_SalSubtract.Click += Button_Edit_Click;
            textBox_CompPaying.Click += Button_Edit_Click;
        ...
        {
            ComponentResourceManager resources = new ComponentResourceManager(typeof(FrmNation));
            if (VarGeneral.CurrentLang.ToString() == "0" || VarGeneral.CurrentLang.ToString() == "")
            {
        ...
        private void RibunButtons()
        {
            if (VarGeneral.CurrentLang.ToString() == "0" || VarGeneral.CurrentLang.ToString() == "")
            {
                ...
                textBox_Note.WatermarkText = "ملاحظـــــــات الجنسية";
                Text = "كرت الجنسيــــات";
            }
            else
            {
        ...
        private void textBox_ID_TextChanged(object sender, EventArgs e)
        {
            ...
            try
            {
                T_Nationality newData = db.NationEmp(no);
                if (newData == null || newData.Nation_No == 0 || string.IsNullOrEmpty(newData.Nation_ID))
                {
                    if (!Button_Add.Visible || !Button_Add.Enabled)
                    {
                        ...
                        try
                        {
                            textBox_ID.Text = data_this.Nation_No.ToString();
                        }
                        catch
                        {
                        }
                ...
                {
                    DataThis = newData;
                    int indexA = PKeys.IndexOf(string.Concat(newData.Nation_No));
                    indexA++;
                    TextBox_Index.InputTextChanged -= TextBox_Index_InputTextChanged;
        ...
        public void SetData(T_Nationality value)
        {
            try
            {
                State = FormState.Saved;
                ...
                textBox_CompPaying.Text = value.CompPaying.ToString();
                textBox_SalSubtract.Text = value.SalSubtract.ToString();
                textBox_ID.Tag = value.Nation_ID;
                Permmission = dbc.Get_PermissionID(VarGeneral.UserID);
            }
            catch (Exception error)
            {
        ...
        private T_Nationality GetData()
        {
            textBox_ID.Focus();
            try
            {
                data_this.Nation_No = int.Parse(textBox_ID.Text);
            }
            catch
            {
            }
            ...
            try
            {
                data_this.CompPaying = Math.Round(float.Parse(textBox_CompPaying.Text), 2);
            }
            catch
            {
            }
            try
            {
                data_this.SalSubtract = Math.Round(float.Parse(textBox_SalSubtract.Text), 2);
            }
            catch
            {
            }
        ...
        private void Button_Save_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (State == FormState.New)
                {
                    ...
                    try
                    {
                        data_this.Nation_ID = textBox_ID.Tag.ToString();
                        db.T_Nationalities.InsertOnSubmit(data_this);
                        db.SubmitChanges();
                    }
                ...
                State = FormState.Saved;
                RefreshPKeys();
                TextBox_Index.TextBox.Text = string.Concat(PKeys.IndexOf(string.Concat(data_this.Nation_No)) + 1);
                SetReadOnly = true;
            }
            catch (Exception error)
            {
        ...
        private void Button_Delete_Click(object sender, EventArgs e)
        {
            ...
            if (data_this == null || data_this.Nation_No == 0 || string.IsNullOrEmpty(data_this.Nation_ID) || !ifOkDelete)
            {
                return;
            }
            T_Emp returned = db.SelectNationNoByReturnNo(DataThis.Nation_No);
            int num;
            if (returned != null)
            {
            ...
            if (num == 0)
            {
                MessageBox.Show((LangArEn == 0) ? "لايمكن حذف الجنسية .. لانه مرتبط باحد الموظفين" : "can not be deleted This Nationality .. because it is linked to one of the employee", VarGeneral.ProdectNam, MessageBoxButtons.OK, MessageBoxIcon.Hand);
                return;
            }
            data_this = db.NationEmp(DataThis.Nation_No);
            try
            {
                db.T_Nationalities.DeleteOnSubmit(DataThis);
                db.SubmitChanges();
            }
            catch (SqlException)
            {
        ...
        private void DGV_Main_DataBindingComplete(object sender, GridDataBindingCompleteEventArgs e)
        {
            ...
            if (dataMember != null && dataMember == "T_Nationality")
            {
        ...
        private void PropBranchPanel(GridPanel panel)
        {
            ...
            panel.Columns["Nation_No"].Width = 120;
            panel.Columns["Nation_No"].Visible = columns_Names_visible["Nation_No"].IfDefault;
            panel.Columns["Note"].Width = 350;
            panel.Columns["Note"].Visible = columns_Names_visible["Note"].IfDefault;
            panel.Columns["SalSubtract"].Width = 120;
            panel.Columns["SalSubtract"].Visible = columns_Names_visible["SalSubtract"].IfDefault;
            panel.Columns["CompPaying"].Width = 120;
            panel.Columns["CompPaying"].Visible = columns_Names_visible["CompPaying"].IfDefault;
            panel.ReadOnly = true;
        }
        ...
        private void Button_ExportTable2_Click(object sender, EventArgs e)
        {
            try
            {
                ExportExcel.ExportToExcel(DGV_Main, "تقرير الجنسيــــات");
            }
            catch
            {
            }
        ...
        public void Button_Print_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                string Fields = "";
                Fields = " T_Nationalities.Nation_No as No, T_Nationalities.NameA as NmA, T_Nationalities.NameE as NmE,(select T_SYSSETTING.LogImg from T_SYSSETTING) as LogImg ";
                _RepShow.Rule = "";
