...
{
    public partial class FrmRepID : Form
    {
        ...
        private void RibunButtons()
        {
            ...
            else
            {
                ...
                Text = "ID Report of Employee";
            }
        }
        private void FrmRepID_Load(object sender, EventArgs e)
        {
            try
            {
                ComponentResourceManager resources = new ComponentResourceManager(typeof(FrmRepID));
                if (VarGeneral.CurrentLang.ToString() == "0" || VarGeneral.CurrentLang.ToString() == "")
                {
                ...
                var q = (from t in db.T_Emps
                         orderby t.ID_Date, t.ID_DateEnd
                         where t.ID_Date != ""
                         select new
                         {
                             t.ID_Date,
                ...
                {
                    dateTimeInput_StartVacationFrom.Text = Convert.ToDateTime(q.First().ID_Date).ToString("yyyy/MM/dd");
                    dateTimeInput_EndVacationFrom.Text = Convert.ToDateTime(q.Last().ID_Date).ToString("yyyy/MM/dd");
                    dateTimeInput_StartVacationTo.Text = Convert.ToDateTime(q.First().ID_DateEnd).ToString("yyyy/MM/dd");
                    dateTimeInput_EndVacationTo.Text = Convert.ToDateTime(q.Last().ID_DateEnd).ToString("yyyy/MM/dd");
                }
            }
        ...
        private void FrmRepID_KeyPress(object sender, KeyPressEventArgs e)
        {
            if (e.KeyChar == '\r')
            {
                SendKeys.Send("{Tab}");
        ...
        private void FrmRepID_KeyDown(object sender, KeyEventArgs e)
        {
        ...
        private string GetSqlWhere()
        {
            ...
            {
                QStr = QStr + " AND ( ID_Date >= '" + Convert.ToDateTime(dateTimeInput_StartVacationFrom.Text).ToString("yyyy/MM/dd") + "' ) ";
            }
            if (dateTimeInput_StartVacationTo.Text != "    /  /" && dateTimeInput_StartVacationTo.Text.Length == 10)
            {
                QStr = QStr + " AND ( ID_Date <= '" + Convert.ToDateTime(dateTimeInput_StartVacationTo.Text).ToString("yyyy/MM/dd") + "' ) ";
            }
            if (dateTimeInput_EndVacationFrom.Text != "    /  /" && dateTimeInput_EndVacationFrom.Text.Length == 10)
            {
                QStr = QStr + " AND ( ID_DateEnd >= '" + Convert.ToDateTime(dateTimeInput_EndVacationFrom.Text).ToString("yyyy/MM/dd") + "' ) ";
            }
            if (dateTimeInput_EndVacationTo.Text != "    /  /" && dateTimeInput_EndVacationTo.Text.Length == 10)
            {
                QStr = QStr + " AND ( ID_DateEnd <= '" + Convert.ToDateTime(dateTimeInput_EndVacationTo.Text).ToString("yyyy/MM/dd") + "' ) ";
            }
            return QStr;
        }
