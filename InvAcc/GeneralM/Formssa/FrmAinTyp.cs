...
{
    public partial class FrmAinTyp : Form
    {
        ...
        private void InitializeComponent()
        {
            ...
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(FrmAinTyp));
            ...
            this.Text = "كــــــرت انواع العيون";
            this.Load += new System.EventHandler(this.FrmAinTyp_Load);
        ...
        {
            DGV_Main.PrimaryGrid.VirtualMode = false;
            List<T_AinTyp> list = db.FillAinTyp_2(textBox_search.TextBox.Text).ToList();
        ...
        public void FillHDGV(IEnumerable<T_AinTyp> new_data_enum)
        {
            ...
            DGV_Main.PrimaryGrid.DataMember = "T_AinTyp";
        ...
        {
            PKeys.Clear();
            var qkeys = db.T_AinTyps.Select((T_AinTyp item) => new
            {
                Code = item.AinTyp_No + ""
            });
            int count = 0;
        ...
        {
            ComponentResourceManager resources = new ComponentResourceManager(typeof(FrmAinTyp));
            if (VarGeneral.CurrentLang.ToString() == "0" || VarGeneral.CurrentLang.ToString() == "")
            {
        ...
        private void RibunButtons()
        {
            ...
            else
            {
                ...
                Text = "Eyes Types Card";
            }
        }
        private void FrmAinTyp_Load(object sender, EventArgs e)
        {
            try
            {
                ComponentResourceManager resources = new ComponentResourceManager(typeof(FrmAinTyp));
        ...
        private void textBox_ID_TextChanged(object sender, EventArgs e)
        {
            ...
            try
            {
                T_AinTyp newData = db.AinTypEmp(no);
                if (newData == null || newData.AinTyp_No == 0 || string.IsNullOrEmpty(newData.AinTyp_ID))
                {
                    if (!Button_Add.Visible || !Button_Add.Enabled)
                    {
                        ...
                        try
                        {
                            textBox_ID.Text = data_this.AinTyp_No.ToString();
                        }
                        catch
                        {
                        }
                ...
                {
                    DataThis = newData;
                    int indexA = PKeys.IndexOf(string.Concat(newData.AinTyp_No));
                    indexA++;
                    TextBox_Index.InputTextChanged -= TextBox_Index_InputTextChanged;
                ...
                try
                {
                    if (data_this.AinTyp_No == 1 || data_this.AinTyp_No == 2 || data_this.AinTyp_No == 3 || data_this.AinTyp_No == 4 || data_this.AinTyp_No == 5)
                    {
                        IfDelete = false;
                        CanEdit = false;
                    }
        ...
        public void SetData(T_AinTyp value)
        {
            try
            {
                State = FormState.Saved;
                ...
                textBox_ID.Tag = value.AinTyp_ID;
                Permmission = dbc.Get_PermissionID(VarGeneral.UserID);
            }
            catch (Exception error)
            {
        ...
        private T_AinTyp GetData()
        {
            textBox_ID.Focus();
            try
            {
                data_this.AinTyp_No = int.Parse(textBox_ID.Text);
            }
            catch
            {
            }
        ...
        private void Button_Save_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (State == FormState.New)
                {
                    ...
                    try
                    {
                        data_this.AinTyp_ID = textBox_ID.Tag.ToString();
                        db.T_AinTyps.InsertOnSubmit(data_this);
                        db.SubmitChanges();
                    }
                ...
                State = FormState.Saved;
                RefreshPKeys();
                TextBox_Index.TextBox.Text = string.Concat(PKeys.IndexOf(string.Concat(data_this.AinTyp_No)) + 1);
                SetReadOnly = true;
            }
            catch (Exception error)
            {
        ...
        private void DGV_Main_DataBindingComplete(object sender, GridDataBindingCompleteEventArgs e)
        {
            ...
            if (dataMember != null && dataMember == "T_AinTyp")
            {
        ...
        private void PropBranchPanel(GridPanel panel)
        {
            ...
            panel.Columns["AinTyp_No"].Width = 120;
            panel.Columns["AinTyp_No"].Visible = columns_Names_visible["AinTyp_No"].IfDefault;
            panel.ReadOnly = true;
        }
        ...
        private void Button_ExportTable2_Click(object sender, EventArgs e)
        {
            try
            {
                ExportExcel.ExportToExcel(DGV_Main, "تقرير أنواع العيون");
            }
            catch
            {
            }
        ...
        public void Button_Print_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                string Fields = "";
                Fields = " T_AinTyp.AinTyp_No as No, T_AinTyp.NameA as NmA, T_AinTyp.NameE as NmE,(select T_SYSSETTING.LogImg from T_SYSSETTING) as LogImg ";
                _RepShow.Rule = "";
