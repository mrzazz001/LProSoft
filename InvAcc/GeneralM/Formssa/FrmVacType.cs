...
namespace InvAcc.Forms
{
    public partial class FrmVacType : Form
    {
        ...
        private SwitchButton checkBox_Dis_Sal;
        private SwitchButton checkBox_Dis_VacT;
        private GroupBox groupBox5;
        private RadioButton radioButton_SalAndAllownc;
        private RadioButton radioButton_SalOnly;
        ...
        public T_User Permmission
        {
            ...
            set
            {
                ...
                {
                    permission = value;
                    if (!VarGeneral.TString.ChkStatShow(value.Emp_FilStr, 33))
                    {
                        IfAdd = false;
                    }
                    else
                    ...
                    if (!VarGeneral.TString.ChkStatShow(value.Emp_FilStr, 34))
                    {
                        CanEdit = false;
                    }
                    else
                    ...
                    if (!VarGeneral.TString.ChkStatShow(value.Emp_FilStr, 35))
                    {
                        IfDelete = false;
                    }
                    else
        ...
        {
            DGV_Main.PrimaryGrid.VirtualMode = false;
            List<T_VacTyp> list = db.FillVacTyp_2(textBox_search.TextBox.Text).ToList();
        ...
        public void FillHDGV(IEnumerable<T_VacTyp> new_data_enum)
        {
            ...
            DGV_Main.PrimaryGrid.DataMember = "T_VacTyp";
        ...
        public void Clear()
        {
            ...
            textBox_ID.Focus();
            radioButton_SalAndAllownc.Checked = true;
            SetReadOnly = false;
        }
        ...
        {
            PKeys.Clear();
            var qkeys = db.T_VacTyps.Select((T_VacTyp item) => new
            {
                Code = item.VacT_No + ""
            });
            int count = 0;
        ...
        public FrmVacType()
        {
            ...
            controls.Add(checkBox_Dis_Sal);
            controls.Add(checkBox_Dis_VacT);
            controls.Add(radioButton_SalAndAllownc);
            controls.Add(radioButton_SalOnly);
            textBox_ID.KeyPress += textBox_ID_KeyPress;
            Button_Close.Click += Button_Close_Click;
            textBox_NameA.Click += Button_Edit_Click;
            textBox_NameE.Click += Button_Edit_Click;
            radioButton_SalAndAllownc.Click += Button_Edit_Click;
            radioButton_SalOnly.Click += Button_Edit_Click;
            checkBox_Dis_VacT.Click += Button_Edit_Click;
            checkBox_Dis_Sal.Click += Button_Edit_Click;
        ...
        {
            ComponentResourceManager resources = new ComponentResourceManager(typeof(FrmVacType));
            if (VarGeneral.CurrentLang.ToString() == "0" || VarGeneral.CurrentLang.ToString() == "")
            {
        ...
        private void RibunButtons()
        {
            if (VarGeneral.CurrentLang.ToString() == "0" || VarGeneral.CurrentLang.ToString() == "")
            {
                ...
                checkBox_Dis_VacT.OnText = "يخصم من رصيد الإجازة";
                checkBox_Dis_VacT.OffText = "لا يخصم من رصيد الإجازة";
                checkBox_Dis_Sal.OnText = "يخصم من مسي\u0651ر الرواتـب";
                checkBox_Dis_Sal.OffText = "لا يخصم من مسي\u0651ر الرواتـب";
                Text = "كرت أنواع الإجازات";
            }
            else
            {
                ...
                checkBox_Dis_VacT.OnText = "Not deducted from the Vacations";
                checkBox_Dis_VacT.OffText = "Deducted from the balance Vacations";
                checkBox_Dis_Sal.OnText = "Not deducted from the salaries";
                checkBox_Dis_Sal.OffText = "Deducted from the salaries";
                Text = "Vacations Card";
            }
        }
        private void FrmVacType_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    columns_Names_visible.Add("VacT_No", new ColumnDictinary("الرقــم", "No", ifDefault: true, ""));
        ...
        private void textBox_ID_TextChanged(object sender, EventArgs e)
        {
            ...
            try
            {
                T_VacTyp newData = db.VacTypEmp(no);
                if (newData == null || newData.VacT_No == 0 || string.IsNullOrEmpty(newData.VacT_ID))
                {
                    if (!Button_Add.Visible || !Button_Add.Enabled)
                    {
                        ...
                        try
                        {
                            textBox_ID.Text = data_this.VacT_No.ToString();
                        }
                        catch
                        {
                        }
                ...
                {
                    DataThis = newData;
                    int indexA = PKeys.IndexOf(string.Concat(newData.VacT_No));
                    indexA++;
                    TextBox_Index.InputTextChanged -= TextBox_Index_InputTextChanged;
        ...
        public void SetData(T_VacTyp value)
        {
            try
            {
                State = FormState.Saved;
                ...
                checkBox_Dis_VacT.Value = value.Dis_VacT.Value;
                checkBox_Dis_Sal.Value = value.Dis_Sal.Value;
                textBox_ID.Tag = value.VacT_ID;
                if (value.Dis_Sal_Sts.Value == 0)
                {
                    radioButton_SalAndAllownc.Checked = true;
                }
                else
                {
                    radioButton_SalOnly.Checked = true;
                }
                Permmission = dbc.Get_PermissionID(VarGeneral.UserID);
            }
            catch (Exception error)
        ...
        private T_VacTyp GetData()
        {
            textBox_ID.Focus();
            try
            {
                data_this.VacT_No = int.Parse(textBox_ID.Text);
            }
            catch
            {
            }
            ...
            try
            {
                data_this.Dis_VacT = checkBox_Dis_VacT.Value;
            }
            catch
            {
            }
            try
            {
                data_this.Dis_Sal = checkBox_Dis_Sal.Value;
            }
            catch
            {
            }
            try
            {
                if (checkBox_Dis_Sal.Value)
                {
                    if (radioButton_SalAndAllownc.Checked)
                    {
                        data_this.Dis_Sal_Sts = 0;
                    }
                    else
                    {
                        data_this.Dis_Sal_Sts = 1;
                    }
                }
                else
                {
        ...
        private void Button_Save_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (State == FormState.New)
                {
                    ...
                    try
                    {
                        data_this.VacT_ID = textBox_ID.Tag.ToString();
                        db.T_VacTyps.InsertOnSubmit(data_this);
                        db.SubmitChanges();
                    }
                ...
                State = FormState.Saved;
                RefreshPKeys();
                TextBox_Index.TextBox.Text = string.Concat(PKeys.IndexOf(string.Concat(data_this.VacT_No)) + 1);
                SetReadOnly = true;
            }
            catch (Exception error)
            {
        ...
        private void ChkVac()
        {
            try
            {
                ...
                db.OpTest_VacTyp(Convert.ToDateTime(ggDate).ToString("yyyy/MM"), vValue: true);
            }
            catch
            {
            }
        ...
        private void Button_Delete_Click(object sender, EventArgs e)
        {
            ...
            if (data_this != null && data_this.VacT_No != 0 && !string.IsNullOrEmpty(data_this.VacT_ID) && ifOkDelete)
            {
                data_this = db.VacTypEmp(DataThis.VacT_No);
                try
                {
                    db.T_VacTyps.DeleteOnSubmit(DataThis);
                    db.SubmitChanges();
                }
                catch (SqlException)
                {
        ...
        private void DGV_Main_DataBindingComplete(object sender, GridDataBindingCompleteEventArgs e)
        {
            ...
            if (dataMember != null && dataMember == "T_VacTyp")
            {
        ...
        private void PropBranchPanel(GridPanel panel)
        {
            ...
            panel.Columns["VacT_No"].Width = 120;
            panel.Columns["VacT_No"].Visible = columns_Names_visible["VacT_No"].IfDefault;
            panel.ReadOnly = true;
        }
        ...
        private void Button_ExportTable2_Click(object sender, EventArgs e)
        {
            try
            {
                ExportExcel.ExportToExcel(DGV_Main, "تقرير أنواع الإجازات");
            }
            catch
            {
            }
        ...
        public void Button_Print_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                string Fields = "";
                Fields = " T_VacTyp.VacT_No as No, T_VacTyp.NameA as NmA, T_VacTyp.NameE as NmE,(select T_SYSSETTING.LogImg from T_SYSSETTING) as LogImg ";
                _RepShow.Rule = "";
        ...
        private void checkBox_Dis_Sal_ValueChanged(object sender, EventArgs e)
        {
            if (checkBox_Dis_Sal.Value)
            {
        ...
        private void InitializeComponent()
        {
            ...
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(InvAcc.Forms.FrmVacType));
            ...
            radioButton_SalOnly = new System.Windows.Forms.RadioButton();
            radioButton_SalAndAllownc = new System.Windows.Forms.RadioButton();
            checkBox_Dis_Sal = new DevComponents.DotNetBar.Controls.SwitchButton();
            checkBox_Dis_VacT = new DevComponents.DotNetBar.Controls.SwitchButton();
            ...
            ribbonBar1.Controls.Add(groupBox5);
            ribbonBar1.Controls.Add(checkBox_Dis_Sal);
            ribbonBar1.Controls.Add(checkBox_Dis_VacT);
            ...
            groupBox5.Controls.Add(radioButton_SalOnly);
            groupBox5.Controls.Add(radioButton_SalAndAllownc);
            resources.ApplyResources(groupBox5, "groupBox5");
            groupBox5.FlatStyle = System.Windows.Forms.FlatStyle.Flat;
            groupBox5.Name = "groupBox5";
            groupBox5.TabStop = false;
            resources.ApplyResources(radioButton_SalOnly, "radioButton_SalOnly");
            radioButton_SalOnly.ForeColor = System.Drawing.Color.Navy;
            radioButton_SalOnly.Name = "radioButton_SalOnly";
            radioButton_SalOnly.UseVisualStyleBackColor = true;
            resources.ApplyResources(radioButton_SalAndAllownc, "radioButton_SalAndAllownc");
            radioButton_SalAndAllownc.Checked = true;
            radioButton_SalAndAllownc.ForeColor = System.Drawing.Color.Navy;
            radioButton_SalAndAllownc.Name = "radioButton_SalAndAllownc";
            radioButton_SalAndAllownc.TabStop = true;
            radioButton_SalAndAllownc.UseVisualStyleBackColor = true;
            checkBox_Dis_Sal.BackgroundStyle.CornerType = DevComponents.DotNetBar.eCornerType.Square;
            resources.ApplyResources(checkBox_Dis_Sal, "checkBox_Dis_Sal");
            checkBox_Dis_Sal.Name = "checkBox_Dis_Sal";
            checkBox_Dis_Sal.Style = DevComponents.DotNetBar.eDotNetBarStyle.StyleManagerControlled;
            checkBox_Dis_Sal.ValueChanged += new System.EventHandler(checkBox_Dis_Sal_ValueChanged);
            checkBox_Dis_VacT.BackgroundStyle.CornerType = DevComponents.DotNetBar.eCornerType.Square;
            resources.ApplyResources(checkBox_Dis_VacT, "checkBox_Dis_VacT");
            checkBox_Dis_VacT.Name = "checkBox_Dis_VacT";
            checkBox_Dis_VacT.Style = DevComponents.DotNetBar.eDotNetBarStyle.StyleManagerControlled;
            ...
            base.Name = "FrmVacType";
            base.Load += new System.EventHandler(FrmVacType_Load);
