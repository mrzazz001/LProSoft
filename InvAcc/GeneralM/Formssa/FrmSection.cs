    ...
    public partial class FrmSection : Form
    {
        ...
        public T_User Permmission
        {
            ...
            set
            {
                ...
                {
                    permission = value;
                    if (!VarGeneral.TString.ChkStatShow(value.Emp_FilStr, 9))
                    {
                        IfAdd = false;
                    }
                    else
                    ...
                    if (!VarGeneral.TString.ChkStatShow(value.Emp_FilStr, 10))
                    {
                        CanEdit = false;
                    }
                    else
                    ...
                    if (!VarGeneral.TString.ChkStatShow(value.Emp_FilStr, 11))
                    {
                        IfDelete = false;
                    }
                    else
        ...
        {
            DGV_Main.PrimaryGrid.VirtualMode = false;
            List<T_Section> list = db.FillSection_2(textBox_search.TextBox.Text).ToList();
        ...
        public void FillHDGV(IEnumerable<T_Section> new_data_enum)
        {
            ...
            DGV_Main.PrimaryGrid.DataMember = "T_Section";
        ...
        {
            PKeys.Clear();
            var qkeys = db.T_Sections.Select((T_Section item) => new
            {
                Code = item.Section_No + ""
            });
            int count = 0;
        ...
        {
            ComponentResourceManager resources = new ComponentResourceManager(typeof(FrmSection));
            if (VarGeneral.CurrentLang.ToString() == "0" || VarGeneral.CurrentLang.ToString() == "")
            {
        ...
        private void RibunButtons()
        {
            if (VarGeneral.CurrentLang.ToString() == "0" || VarGeneral.CurrentLang.ToString() == "")
            {
                ...
                textBox_Note.WatermarkText = "ملاحظـــــــات القسم";
                Text = "كرت الأقسام";
            }
            else
            {
        ...
        private void FrmSection_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    columns_Names_visible.Add("Section_No", new ColumnDictinary("رقم القسم", "Section No", ifDefault: true, ""));
        ...
        private void textBox_ID_TextChanged(object sender, EventArgs e)
        {
            ...
            try
            {
                T_Section newData = db.SectionEmp(no);
                if (newData == null || newData.Section_No == 0 || string.IsNullOrEmpty(newData.Section_ID))
                {
                    if (!Button_Add.Visible || !Button_Add.Enabled)
                    {
                        ...
                        try
                        {
                            textBox_ID.Text = data_this.Section_No.ToString();
                        }
                        catch
                        {
                        }
                ...
                {
                    DataThis = newData;
                    int indexA = PKeys.IndexOf(string.Concat(newData.Section_No));
                    indexA++;
                    TextBox_Index.InputTextChanged -= TextBox_Index_InputTextChanged;
        ...
        public void SetData(T_Section value)
        {
            try
            {
                State = FormState.Saved;
                ...
                textBox_ID.Tag = value.Section_ID;
        ...
        private T_Section GetData()
        {
            textBox_ID.Focus();
            try
            {
                data_this.Section_No = int.Parse(textBox_ID.Text);
            }
            catch
            {
            }
        ...
        private void Button_Save_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (State == FormState.New)
                {
                    ...
                    try
                    {
                        data_this.Section_ID = textBox_ID.Tag.ToString();
                        db.T_Sections.InsertOnSubmit(data_this);
                        db.SubmitChanges();
                    }
                ...
                State = FormState.Saved;
                RefreshPKeys();
                TextBox_Index.TextBox.Text = string.Concat(PKeys.IndexOf(string.Concat(data_this.Section_No)) + 1);
                SetReadOnly = true;
            }
            catch (Exception error)
            {
        ...
        private void Button_Delete_Click(object sender, EventArgs e)
        {
            ...
            if (data_this == null || data_this.Section_No == 0 || string.IsNullOrEmpty(data_this.Section_ID) || !ifOkDelete)
            {
                return;
            }
            T_Emp returned = db.SelectSectionNoByReturnNo(DataThis.Section_No);
            int num;
            if (returned != null)
            {
            ...
            if (num == 0)
            {
                MessageBox.Show((LangArEn == 0) ? "لايمكن حذف القسم .. لانه مرتبط باحد الموظفين" : "can not be deleted This Section .. because it is linked to one of the employee", VarGeneral.ProdectNam, MessageBoxButtons.OK, MessageBoxIcon.Hand);
                return;
            }
            data_this = db.SectionEmp(DataThis.Section_No);
            try
            {
                db.T_Sections.DeleteOnSubmit(DataThis);
                db.SubmitChanges();
            }
            catch (SqlException)
            {
        ...
        private void DGV_Main_DataBindingComplete(object sender, GridDataBindingCompleteEventArgs e)
        {
            ...
            if (dataMember != null && dataMember == "T_Section")
            {
        ...
        private void PropBranchPanel(GridPanel panel)
        {
            ...
            panel.Columns["Section_No"].Width = 120;
            panel.Columns["Section_No"].Visible = columns_Names_visible["Section_No"].IfDefault;
        ...
        private void Button_ExportTable2_Click(object sender, EventArgs e)
        {
            try
            {
                ExportExcel.ExportToExcel(DGV_Main, "تقرير الأقسام");
            }
            catch
            {
            }
        ...
        public void Button_Print_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                string Fields = "";
                Fields = " T_Section.Section_No as No, T_Section.NameA as NmA, T_Section.NameE as NmE,(select T_SYSSETTING.LogImg from T_SYSSETTING) as LogImg ";
                _RepShow.Rule = "";
        ...
        private void InitializeComponent()
        {
            ...
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(InvAcc.Forms.FrmSection));
            ...
            textBox_BossName = new System.Windows.Forms.TextBox();
            ...
            textBox_Fax = new System.Windows.Forms.TextBox();
            ...
            panelEx2.MinimumSize = new System.Drawing.Size(649, 286);
            ...
            ribbonBar1.Controls.Add(textBox_Fax);
            ...
            textBox_BossName.BorderStyle = System.Windows.Forms.BorderStyle.FixedSingle;
            resources.ApplyResources(textBox_BossName, "textBox_BossName");
            textBox_BossName.Name = "textBox_BossName";
            ...
            label5.Name = "label5";
            textBox_Phone.BorderStyle = System.Windows.Forms.BorderStyle.FixedSingle;
            ...
            textBox_Fax.BorderStyle = System.Windows.Forms.BorderStyle.FixedSingle;
            resources.ApplyResources(textBox_Fax, "textBox_Fax");
            textBox_Fax.Name = "textBox_Fax";
            ...
            base.Name = "FrmSection";
            base.Load += new System.EventHandler(FrmSection_Load);
