...
{
    public partial class FrmInsuranceHealth : Form
    {
        ...
        private void InitializeComponent()
        {
            ...
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(InvAcc.Forms.FrmInsuranceHealth));
            ...
            base.Name = "FrmInsuranceHealth";
            base.Load += new System.EventHandler(FrmInsuranceHealth_Load);
        ...
        {
            DGV_Main.PrimaryGrid.VirtualMode = false;
            List<T_Insurance> list = db.FillInsurance_2(textBox_search.TextBox.Text).ToList();
        ...
        public void FillHDGV(IEnumerable<T_Insurance> new_data_enum)
        {
            ...
            DGV_Main.PrimaryGrid.DataMember = "T_Insurance";
        ...
        {
            PKeys.Clear();
            var qkeys = db.T_Insurances.Select((T_Insurance item) => new
            {
                Code = item.Insurance_No + ""
            });
            int count = 0;
        ...
        {
            ComponentResourceManager resources = new ComponentResourceManager(typeof(FrmInsuranceHealth));
            if (VarGeneral.CurrentLang.ToString() == "0" || VarGeneral.CurrentLang.ToString() == "")
            {
        ...
        private void RibunButtons()
        {
            if (VarGeneral.CurrentLang.ToString() == "0" || VarGeneral.CurrentLang.ToString() == "")
            {
                ...
                textBox_Note.WatermarkText = "ملاحظـــــــات الشركة";
                Text = "كرت شركات التأمين الصحي";
            }
            else
            {
                ...
                Text = "Insurance Company Card";
            }
        }
        private void FrmInsuranceHealth_Load(object sender, EventArgs e)
        {
            try
            {
                ComponentResourceManager resources = new ComponentResourceManager(typeof(FrmInsuranceHealth));
                ...
                {
                    columns_Names_visible.Add("Insurance_No", new ColumnDictinary("رقم الشركة", "Company No", ifDefault: true, ""));
        ...
        private void textBox_ID_TextChanged(object sender, EventArgs e)
        {
            ...
            try
            {
                T_Insurance newData = db.InsuranceEmp(no);
                if (newData == null || newData.Insurance_No == 0 || string.IsNullOrEmpty(newData.Insurance_ID))
                {
                    if (!Button_Add.Visible || !Button_Add.Enabled)
                    {
                        ...
                        try
                        {
                            textBox_ID.Text = data_this.Insurance_No.ToString();
                        }
                        catch
                        {
                        }
                ...
                {
                    DataThis = newData;
                    int indexA = PKeys.IndexOf(string.Concat(newData.Insurance_No));
                    indexA++;
                    TextBox_Index.InputTextChanged -= TextBox_Index_InputTextChanged;
        ...
        public void SetData(T_Insurance value)
        {
            try
            {
                State = FormState.Saved;
                ...
                textBox_ID.Tag = value.Insurance_ID;
                Permmission = dbc.Get_PermissionID(VarGeneral.UserID);
            }
            catch (Exception error)
            {
        ...
        private T_Insurance GetData()
        {
            textBox_ID.Focus();
            try
            {
                data_this.Insurance_No = int.Parse(textBox_ID.Text);
            }
            catch
            {
            }
        ...
        private void Button_Save_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (State == FormState.New)
                {
                    ...
                    try
                    {
                        data_this.Insurance_ID = textBox_ID.Tag.ToString();
                        db.T_Insurances.InsertOnSubmit(data_this);
                        db.SubmitChanges();
                    }
                ...
                State = FormState.Saved;
                RefreshPKeys();
                TextBox_Index.TextBox.Text = string.Concat(PKeys.IndexOf(string.Concat(data_this.Insurance_No)) + 1);
                SetReadOnly = true;
            }
            catch (Exception error)
            {
        ...
        private void Button_Delete_Click(object sender, EventArgs e)
        {
            ...
            if (data_this == null || data_this.Insurance_No == 0 || string.IsNullOrEmpty(data_this.Insurance_ID) || !ifOkDelete)
            {
                return;
            }
            T_Emp returned = db.SelectInsuranceNoByReturnNo(DataThis.Insurance_No);
            int num;
            if (returned != null)
            {
            ...
            if (num == 0)
            {
                MessageBox.Show((LangArEn == 0) ? "لايمكن حذف شركة التأمين .. لانه مرتبط باحد الموظفين" : "can not be deleted This Company .. because it is linked to one of the employee", VarGeneral.ProdectNam, MessageBoxButtons.OK, MessageBoxIcon.Hand);
                return;
            }
            data_this = db.InsuranceEmp(DataThis.Insurance_No);
            try
            {
                db.T_Insurances.DeleteOnSubmit(DataThis);
                db.SubmitChanges();
            }
            catch (SqlException)
            {
        ...
        private void DGV_Main_DataBindingComplete(object sender, GridDataBindingCompleteEventArgs e)
        {
            ...
            if (dataMember != null && dataMember == "T_Insurance")
            {
        ...
        private void PropBranchPanel(GridPanel panel)
        {
            ...
            panel.Columns["Insurance_No"].Width = 120;
            panel.Columns["Insurance_No"].Visible = columns_Names_visible["Insurance_No"].IfDefault;
        ...
        private void Button_ExportTable2_Click(object sender, EventArgs e)
        {
            try
            {
                ExportExcel.ExportToExcel(DGV_Main, "تقرير شركات التأمين الصحي");
            }
            catch
            {
            }
        ...
        public void Button_Print_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                string Fields = "";
                Fields = " T_Insurance.Insurance_No as No, T_Insurance.NameA as NmA, T_Insurance.NameE as NmE,(select T_SYSSETTING.LogImg from T_SYSSETTING) as LogImg ";
                _RepShow.Rule = "";
