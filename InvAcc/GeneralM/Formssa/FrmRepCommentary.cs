...
{
    public partial class FrmRepCommentary : Form
    {
        ...
        {
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(InvAcc.Forms.FrmRepCommentary));
            ...
            base.Name = "FrmRepCommentary";
            base.Load += new System.EventHandler(FrmRepCommentary_Load);
            base.KeyPress += new System.Windows.Forms.KeyPressEventHandler(FrmRepCommentary_KeyPress);
            base.KeyDown += new System.Windows.Forms.KeyEventHandler(FrmRepCommentary_KeyDown);
        ...
        private void RibunButtons()
        {
            if (VarGeneral.CurrentLang.ToString() == "0" || VarGeneral.CurrentLang.ToString() == "")
            {
                ...
                Text = "تقرير رسوم واتعاب التعقـــيب";
            }
            else
            {
                ...
                Text = "Commentary Report";
            }
        }
        private void FrmRepCommentary_Load(object sender, EventArgs e)
        {
            try
            {
                ComponentResourceManager resources = new ComponentResourceManager(typeof(FrmRepCommentary));
                if (VarGeneral.CurrentLang.ToString() == "0" || VarGeneral.CurrentLang.ToString() == "")
                {
                ...
                RibunButtons();
                FillGrid();
                List<string> q = (from t in db.T_Commentaries
                                  orderby t.warnDate
        ...
        private void FrmRepCommentary_KeyPress(object sender, KeyPressEventArgs e)
        {
            if (e.KeyChar == '\r')
            {
                SendKeys.Send("{Tab}");
        ...
        private void FrmRepCommentary_KeyDown(object sender, KeyEventArgs e)
        {
