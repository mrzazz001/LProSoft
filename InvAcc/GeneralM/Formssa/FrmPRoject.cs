    ...
    public partial class FrmPRoject : Form
    {
        ...
        public T_User Permmission
        {
            ...
            set
            {
                ...
                {
                    permission = value;
                    if (!VarGeneral.TString.ChkStatShow(value.Emp_FilStr, 21))
                    {
                        IfAdd = false;
                    }
                    else
                    ...
                    if (!VarGeneral.TString.ChkStatShow(value.Emp_FilStr, 22))
                    {
                        CanEdit = false;
                    }
                    else
                    ...
                    if (!VarGeneral.TString.ChkStatShow(value.Emp_FilStr, 23))
                    {
                        IfDelete = false;
                    }
                    else
        ...
        {
            DGV_Main.PrimaryGrid.VirtualMode = false;
            List<T_Project> list = db.FillPRoject_2(textBox_search.TextBox.Text).ToList();
        ...
        public void FillHDGV(IEnumerable<T_Project> new_data_enum)
        {
            ...
            DGV_Main.PrimaryGrid.DataMember = "T_Project";
        ...
        {
            PKeys.Clear();
            var qkeys = db.T_Projects.Select((T_Project item) => new
            {
                Code = item.Project_No + string.Empty
            });
            int count = 0;
        ...
        {
            ComponentResourceManager resources = new ComponentResourceManager(typeof(FrmPRoject));
            if (VarGeneral.CurrentLang.ToString() == "0" || VarGeneral.CurrentLang.ToString() == string.Empty)
            {
        ...
        private void RibunButtons()
        {
            if (VarGeneral.CurrentLang.ToString() == "0" || VarGeneral.CurrentLang.ToString() == string.Empty)
            {
                ...
                textBox_Note.WatermarkText = "ملاحظـــــــات المــــوقــع";
                Text = "كــــــرت مواقع العمــل - المشــــاريع";
            }
            else
            {
        ...
        private void FrmPRoject_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    columns_Names_visible.Add("Project_No", new ColumnDictinary("رقم الموقع", "Project No", ifDefault: true, string.Empty));
                    ...
                    columns_Names_visible.Add("Note", new ColumnDictinary("الملاحظات", "Note", ifDefault: false, string.Empty));
                }
                else
                {
                    Clear();
        ...
        private void textBox_ID_TextChanged(object sender, EventArgs e)
        {
            ...
            try
            {
                T_Project newData = db.PRojectEmp(no);
                if (newData == null || newData.Project_No == 0 || string.IsNullOrEmpty(newData.Project_ID))
                {
                    if (!Button_Add.Visible || !Button_Add.Enabled)
                    {
                        ...
                        try
                        {
                            textBox_ID.Text = data_this.Project_No.ToString();
                        }
                        catch
                        {
                        }
                ...
                {
                    DataThis = newData;
                    int indexA = PKeys.IndexOf(string.Concat(newData.Project_No));
                    indexA++;
                    TextBox_Index.InputTextChanged -= TextBox_Index_InputTextChanged;
        ...
        public void SetData(T_Project value)
        {
            try
            {
                State = FormState.Saved;
                ...
                textBox_ID.Tag = value.Project_ID;
        ...
        private T_Project GetData()
        {
            textBox_ID.Focus();
            try
            {
                data_this.Project_No = int.Parse(textBox_ID.Text);
            }
            catch
            {
            }
        ...
        private void Button_Save_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (State == FormState.New)
                {
                    ...
                    try
                    {
                        data_this.Project_ID = textBox_ID.Tag.ToString();
                        db.T_Projects.InsertOnSubmit(data_this);
                        db.SubmitChanges();
                    }
                ...
                State = FormState.Saved;
                RefreshPKeys();
                TextBox_Index.TextBox.Text = string.Concat(PKeys.IndexOf(string.Concat(data_this.Project_No)) + 1);
                SetReadOnly = true;
            }
            catch (Exception error)
            {
        ...
        private void Button_Delete_Click(object sender, EventArgs e)
        {
            ...
            if (data_this == null || data_this.Project_No == 0 || string.IsNullOrEmpty(data_this.Project_ID) || !ifOkDelete)
            {
                return;
            }
            T_Emp returned = db.SelectSPRojectNoByReturnNo(DataThis.Project_No);
            int num;
            if (returned != null)
            {
                int? projectNo = returned.ProjectNo;
                num = ((projectNo.Value == 0 && projectNo.HasValue) ? 1 : 0);
            }
            else
            {
                num = 1;
            ...
            if (num == 0)
            {
                MessageBox.Show((LangArEn == 0) ? "لايمكن حذف الموقع .. لانه مرتبط باحد الموظفين" : "can not be deleted This Section .. because it is linked to one of the employee", VarGeneral.ProdectNam, MessageBoxButtons.OK, MessageBoxIcon.Hand);
                return;
            }
            data_this = db.PRojectEmp(DataThis.Project_No);
            try
            {
                db.T_Projects.DeleteOnSubmit(DataThis);
                db.SubmitChanges();
            }
            catch (SqlException)
            {
        ...
        private void DGV_Main_DataBindingComplete(object sender, GridDataBindingCompleteEventArgs e)
        {
            ...
            if (dataMember != null && dataMember == "T_Project")
            {
        ...
        private void PropBranchPanel(GridPanel panel)
        {
            ...
            panel.Columns["Project_No"].Width = 120;
            panel.Columns["Project_No"].Visible = columns_Names_visible["Project_No"].IfDefault;
        ...
        private void Button_ExportTable2_Click(object sender, EventArgs e)
        {
            try
            {
                ExportExcel.ExportToExcel(DGV_Main, "تقرير مـواقــع العمــل - المشــاريع");
            }
            catch
            {
            }
        ...
        public void Button_Print_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                Fields = " T_Project.Project_No as No, T_Project.NameA as NmA, T_Project.NameE as NmE,(select T_SYSSETTING.LogImg from T_SYSSETTING) as LogImg ";
        ...
        private void InitializeComponent()
        {
            ...
            this.textBox_BossName = new System.Windows.Forms.TextBox();
            ...
            this.panelEx2.MinimumSize = new System.Drawing.Size(649, 286);
            this.panelEx2.Name = "panelEx2";
            this.panelEx2.Size = new System.Drawing.Size(649, 286);
            ...
            this.ribbonBar1.Controls.Add(this.textBox_BossName);
            ...
            this.ribbonBar1.Size = new System.Drawing.Size(649, 235);
            ...
            // textBox_BossName
            // 
            this.textBox_BossName.BorderStyle = System.Windows.Forms.BorderStyle.FixedSingle;
            this.textBox_BossName.Location = new System.Drawing.Point(68, 17);
            this.textBox_BossName.MaxLength = 30;
            this.textBox_BossName.Name = "textBox_BossName";
            this.netResize1.SetResizeTextBoxMultiline(this.textBox_BossName, false);
            this.textBox_BossName.Size = new System.Drawing.Size(189, 20);
            this.textBox_BossName.TabIndex = 2;
            // 
            // label2
            // 
            ...
            this.label2.TabIndex = 6681;
            this.label2.Text = "إسم المدير :";
            // 
            // textBox_Note
            // 
            ...
            this.textBox_Note.Size = new System.Drawing.Size(510, 43);
            ...
            this.textBox_Note.WatermarkText = "ملاحظـــــــات المــــوقــع";
            // 
            // label5
            // 
            ...
            this.label40.Text = "إسم المــوقع - انجليزي :";
            // 
            // textBox_NameA
            // 
            ...
            this.label36.Text = "إسم المــوقع - عربـــي :";
            // 
            // textBox_ID
            // 
            ...
            this.textBox_Fax.Location = new System.Drawing.Point(68, 134);
            ...
            this.textBox_Fax.Size = new System.Drawing.Size(123, 20);
            this.textBox_Fax.TabIndex = 6;
            // 
            // ribbonBar_Tasks
            // 
            ...
            this.ribbonBar_Tasks.Location = new System.Drawing.Point(0, 235);
            ...
            this.panel1.Size = new System.Drawing.Size(649, 299);
            ...
            this.barBottomDockSite.Location = new System.Drawing.Point(0, 299);
            ...
            this.barLeftDockSite.Size = new System.Drawing.Size(0, 299);
            ...
            this.barRightDockSite.Size = new System.Drawing.Size(0, 299);
            ...
            this.dockSite1.Size = new System.Drawing.Size(0, 299);
            ...
            this.dockSite2.Size = new System.Drawing.Size(0, 299);
            ...
            this.Text = "كــــــرت مواقع العمــل - المشــــاريع";
