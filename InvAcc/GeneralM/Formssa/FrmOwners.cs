...
namespace InvAcc.Forms
{
    public partial class FrmOwners : Form
    {
        ...
        private TextBox textBox_IdentSource;
        private Label label5;
        private Label label3;
        private TextBox textBox_Ident;
        ...
        private MaskedTextBox textBox_IdentDate;
        ...
        {
            DGV_Main.PrimaryGrid.VirtualMode = false;
            List<T_Owner> list = db.FillOwner_2(textBox_search.TextBox.Text).ToList();
        ...
        public void FillHDGV(IEnumerable<T_Owner> new_data_enum)
        {
            ...
            DGV_Main.PrimaryGrid.DataMember = "T_Owner";
        ...
        {
            PKeys.Clear();
            var qkeys = db.T_Owners.Select((T_Owner item) => new
            {
                Code = item.Owner_No + string.Empty
            });
            int count = 0;
        ...
        public FrmOwners()
        {
            ...
            controls.Add(textBox_Ident);
            controls.Add(textBox_IdentDate);
            controls.Add(textBox_IdentSource);
            ...
            textBox_Ident.Click += Button_Edit_Click;
            textBox_IdentDate.Click += Button_Edit_Click;
            textBox_IdentSource.Click += Button_Edit_Click;
            textBox_Mobile.Click += Button_Edit_Click;
            textBox_Tel.Click += Button_Edit_Click;
            CmbNationality.Click += Button_Edit_Click;
        ...
        {
            ComponentResourceManager resources = new ComponentResourceManager(typeof(FrmOwners));
            if (VarGeneral.CurrentLang.ToString() == "0" || VarGeneral.CurrentLang.ToString() == string.Empty)
            {
        ...
        private void RibunButtons()
        {
            if (VarGeneral.CurrentLang.ToString() == "0" || VarGeneral.CurrentLang.ToString() == string.Empty)
            {
                ...
                label38.Text = "رقم المالك :";
                label36.Text = "الإسم - عربي :";
                label40.Text = "الإسم - إنجليزي :";
                label4.Text = "العنـــــــوان :";
                label21.Text = "الجنسيـــــة :";
                label2.Text = "جوال المالك :";
                label1.Text = "هاتف المالك :";
                label17.Text = "رقم الهوية :";
                label5.Text = "مصدر الهوية :";
                label3.Text = "تاريخهــــــــا :";
                Text = "كرت المــــلا\u064bك";
            }
            else
            {
        ...
        public void FillCombo()
        {
            ...
            CmbNationality.DataSource = listNation;
            CmbNationality.DisplayMember = ((LangArEn == 0) ? "NameA" : "NameE");
            CmbNationality.ValueMember = "Nation_No";
        }
        ...
        private void textBox_ID_TextChanged(object sender, EventArgs e)
        {
            ...
            try
            {
                T_Owner newData = db.OwnerEmp(no);
                if (newData == null || newData.Owner_No == 0)
                {
                    if (!Button_Add.Visible || !Button_Add.Enabled)
                    {
                        ...
                        try
                        {
                            textBox_ID.Text = data_this.Owner_No.ToString();
                        }
                        catch
                        {
                        }
                ...
                {
                    DataThis = newData;
                    int indexA = PKeys.IndexOf(string.Concat(newData.Owner_No));
                    indexA++;
                    TextBox_Index.InputTextChanged -= TextBox_Index_InputTextChanged;
        ...
        public void SetData(T_Owner value)
        {
            try
            {
                State = FormState.Saved;
                ...
                textBox_Ident.Text = value.OwnerIdent;
                try
                {
                    if (VarGeneral.CheckDate(value.OwnerIdentDate))
                    {
                        textBox_IdentDate.Text = Convert.ToDateTime(value.OwnerIdentDate).ToString("yyyy/MM/dd");
                    }
                    else
                    {
                        textBox_IdentDate.Text = string.Empty;
                    }
                }
                catch
                {
                ...
                textBox_IdentSource.Text = value.OwnerIdentSource;
                textBox_Mobile.Text = value.Mobile;
                textBox_Tel.Text = value.Tel;
                if (value.Nationalty.HasValue)
                {
                    CmbNationality.SelectedIndex = value.Nationalty.Value;
                }
                textBox_ID.Tag = value.Owner_ID;
            }
            catch (Exception error)
            {
        ...
        private T_Owner GetData()
        {
            textBox_ID.Focus();
            try
            {
                data_this.Owner_No = int.Parse(textBox_ID.Text);
            }
            catch
            {
            }
            ...
            try
            {
                data_this.Address = textBox_Address.Text;
            }
            catch
            {
            }
            try
            {
                data_this.Mobile = textBox_Mobile.Text;
            }
            catch
            {
            }
            try
            {
                ...
                {
                    data_this.Nationalty = int.Parse(CmbNationality.SelectedValue.ToString());
                }
                else
                {
            ...
            try
            {
                data_this.OwnerIdent = textBox_Ident.Text;
            }
            catch
            {
            }
            try
            {
                if (VarGeneral.CheckDate(textBox_IdentDate.Text))
                {
                    data_this.OwnerIdentDate = textBox_IdentDate.Text;
                }
                else
                {
                    data_this.OwnerIdentDate = string.Empty;
                }
            }
            catch
            {
            ...
            try
            {
                data_this.OwnerIdentSource = textBox_IdentSource.Text;
            }
            catch
            {
            }
        ...
        private void Button_Save_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (State == FormState.New)
                {
                    ...
                    try
                    {
                        db.T_Owners.InsertOnSubmit(data_this);
                        db.SubmitChanges();
                    }
                ...
                State = FormState.Saved;
                RefreshPKeys();
                TextBox_Index.TextBox.Text = string.Concat(PKeys.IndexOf(string.Concat(data_this.Owner_No)) + 1);
                SetReadOnly = true;
            }
            catch (Exception error)
            {
        ...
        private void Button_Delete_Click(object sender, EventArgs e)
        {
            ...
            if (data_this != null && data_this.Owner_No != 0 && ifOkDelete)
            {
                data_this = db.OwnerEmp(DataThis.Owner_No);
                try
                {
                    db.T_Owners.DeleteOnSubmit(DataThis);
                    db.SubmitChanges();
                }
                catch (SqlException)
                {
        ...
        private void DGV_Main_DataBindingComplete(object sender, GridDataBindingCompleteEventArgs e)
        {
            ...
            if (dataMember != null && dataMember == "T_Owner")
            {
        ...
        private void PropBranchPanel(GridPanel panel)
        {
            ...
            panel.Columns["Owner_No"].Width = 120;
            panel.Columns["Owner_No"].Visible = columns_Names_visible["Owner_No"].IfDefault;
            panel.ReadOnly = true;
        }
        ...
        private void Button_ExportTable2_Click(object sender, EventArgs e)
        {
            try
            {
                ExportExcel.ExportToExcel(DGV_Main, "تقرير المــــل\u064eاك");
            }
            catch
            {
            }
        ...
        public void Button_Print_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                Fields = " T_Owner.Owner_No as No, T_Owner.NameA as NmA, T_Owner.NameE as NmE,(select T_SYSSETTING.LogImg from T_SYSSETTING) as LogImg ";
        ...
        private void textBox_Tel_Click(object sender, EventArgs e)
        {
            textBox_Tel.SelectAll();
        }
        private void textBox_Ident_Click(object sender, EventArgs e)
        {
            textBox_Ident.SelectAll();
        }
        private void textBox_IdentDate_Click(object sender, EventArgs e)
        {
            textBox_IdentDate.SelectAll();
        }
        ...
        private void textBox_Ident_KeyPress(object sender, KeyPressEventArgs e)
        {
            if (!char.IsNumber(e.KeyChar) & (e.KeyChar != '\b'))
            {
                e.Handled = true;
        ...
        private void textBox_IdentDate_Leave(object sender, EventArgs e)
        {
            try
            {
                if (VarGeneral.CheckDate(textBox_IdentDate.Text))
                {
                    textBox_IdentDate.Text = Convert.ToDateTime(textBox_IdentDate.Text).ToString("yyyy/MM/dd");
                }
                else
                {
                    textBox_IdentDate.Text = string.Empty;
        ...
        private void button_AddNewNation_Click(object sender, EventArgs e)
        {
            ...
            if (CmbNationality.SelectedIndex > 0)
            {
                vList = CmbNationality.SelectedValue.ToString();
            }
            frm.TopMost = true;
            frm.ShowDialog();
            ...
            CmbNationality.DataSource = null;
            CmbNationality.DataSource = list;
            CmbNationality.DisplayMember = ((LangArEn == 0) ? "NameA" : "NameE");
            CmbNationality.ValueMember = "Nation_No";
            if (vList != string.Empty)
            {
                for (int i = 0; i < CmbNationality.Items.Count; i++)
                {
                    ...
                    if (CmbNationality.SelectedValue.ToString() == vList)
                    {
                        break;
                    }
                }
        ...
        private void InitializeComponent()
        {
            ...
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(InvAcc.Forms.FrmOwners));
            ...
            button_AddNewNation = new DevComponents.DotNetBar.ButtonX();
            textBox_IdentDate = new System.Windows.Forms.MaskedTextBox();
            label21 = new System.Windows.Forms.Label();
            CmbNationality = new System.Windows.Forms.ComboBox();
            textBox_IdentSource = new System.Windows.Forms.TextBox();
            label5 = new System.Windows.Forms.Label();
            label3 = new System.Windows.Forms.Label();
            textBox_Ident = new System.Windows.Forms.TextBox();
            label4 = new System.Windows.Forms.Label();
            textBox_Address = new System.Windows.Forms.TextBox();
            label2 = new System.Windows.Forms.Label();
            textBox_Tel = new System.Windows.Forms.TextBox();
            label1 = new System.Windows.Forms.Label();
            textBox_Mobile = new System.Windows.Forms.TextBox();
            ...
            panelEx2.MinimumSize = new System.Drawing.Size(649, 302);
            ...
            ribbonBar1.Controls.Add(button_AddNewNation);
            ribbonBar1.Controls.Add(textBox_IdentDate);
            ribbonBar1.Controls.Add(label21);
            ribbonBar1.Controls.Add(CmbNationality);
            ribbonBar1.Controls.Add(textBox_IdentSource);
            ribbonBar1.Controls.Add(label5);
            ribbonBar1.Controls.Add(label3);
            ribbonBar1.Controls.Add(textBox_Ident);
            ribbonBar1.Controls.Add(label4);
            ribbonBar1.Controls.Add(textBox_Address);
            ribbonBar1.Controls.Add(label2);
            ribbonBar1.Controls.Add(textBox_Tel);
            ribbonBar1.Controls.Add(label1);
            ribbonBar1.Controls.Add(textBox_Mobile);
            ...
            button_AddNewNation.AccessibleRole = System.Windows.Forms.AccessibleRole.PushButton;
            button_AddNewNation.Checked = true;
            button_AddNewNation.ColorTable = DevComponents.DotNetBar.eButtonColor.OrangeWithBackground;
            resources.ApplyResources(button_AddNewNation, "button_AddNewNation");
            button_AddNewNation.Name = "button_AddNewNation";
            button_AddNewNation.Style = DevComponents.DotNetBar.eDotNetBarStyle.StyleManagerControlled;
            button_AddNewNation.Symbol = "\uf067";
            button_AddNewNation.SymbolSize = 11f;
            button_AddNewNation.TextColor = System.Drawing.Color.SteelBlue;
            button_AddNewNation.Click += new System.EventHandler(button_AddNewNation_Click);
            textBox_IdentDate.BackColor = System.Drawing.Color.WhiteSmoke;
            resources.ApplyResources(textBox_IdentDate, "textBox_IdentDate");
            textBox_IdentDate.Name = "textBox_IdentDate";
            textBox_IdentDate.Leave += new System.EventHandler(textBox_IdentDate_Leave);
            textBox_IdentDate.Click += new System.EventHandler(textBox_IdentDate_Click);
            resources.ApplyResources(label21, "label21");
            label21.Name = "label21";
            CmbNationality.AutoCompleteSource = System.Windows.Forms.AutoCompleteSource.ListItems;
            CmbNationality.DropDownStyle = System.Windows.Forms.ComboBoxStyle.DropDownList;
            resources.ApplyResources(CmbNationality, "CmbNationality");
            CmbNationality.FormattingEnabled = true;
            CmbNationality.Items.AddRange(new object[6]
            {
                resources.GetString("CmbNationality.Items"),
                resources.GetString("CmbNationality.Items1"),
                resources.GetString("CmbNationality.Items2"),
                resources.GetString("CmbNationality.Items3"),
                resources.GetString("CmbNationality.Items4"),
                resources.GetString("CmbNationality.Items5")
            });
            CmbNationality.Name = "CmbNationality";
            resources.ApplyResources(textBox_IdentSource, "textBox_IdentSource");
            textBox_IdentSource.Name = "textBox_IdentSource";
            resources.ApplyResources(label5, "label5");
            label5.Name = "label5";
            resources.ApplyResources(label3, "label3");
            label3.Name = "label3";
            resources.ApplyResources(textBox_Ident, "textBox_Ident");
            textBox_Ident.Name = "textBox_Ident";
            textBox_Ident.Click += new System.EventHandler(textBox_Ident_Click);
            textBox_Ident.KeyPress += new System.Windows.Forms.KeyPressEventHandler(textBox_Ident_KeyPress);
            ...
            textBox_Tel.Click += new System.EventHandler(textBox_Tel_Click);
            textBox_Tel.KeyPress += new System.Windows.Forms.KeyPressEventHandler(textBox_Mobile_KeyPress);
            resources.ApplyResources(label1, "label1");
            label1.Name = "label1";
            resources.ApplyResources(textBox_Mobile, "textBox_Mobile");
            textBox_Mobile.Name = "textBox_Mobile";
            textBox_Mobile.Click += new System.EventHandler(textBox_Mobile_Click);
            textBox_Mobile.KeyPress += new System.Windows.Forms.KeyPressEventHandler(textBox_Mobile_KeyPress);
            ...
            base.Name = "FrmOwners";
            base.Load += new System.EventHandler(FrmOwners_Load);
