    ...
    public partial class FrmPrinters : Form
    {
        ...
        private bool SaveData1()
        {
            try
            {
                ...
                string ntyp = "10";
                ntyp = (checkBox_previewPrint.Checked ? (ntyp + "0") : (ntyp + "1"));
        ...
        private void BindData1()
        {
            if (this.DesignMode == false)
            {
                try
                {
                    ...
                    if (_InvSetting1.nTyp.Substring(2, 1) == "0")
                    {
        ...
        Stock_DataDataContext dprep = new Stock_DataDataContext();
        ...
        private void BindData2()
        {
            try
            {
                ...
                //    for (int iiCnt = 0; iiCnt < listInvSetting2.Count; iiCnt++)
                {
                    ...
                    if (_InvSetting2.nTyp.Substring(1, 1) == "0")
                    {
                    ...
                    else if (_InvSetting2.nTyp.Substring(1, 1) == "1")
                    {
                        RadInvPointer.Checked = false;
                        RadInvA4.Checked = false;
        ...
        private bool SaveData3()
        {
            try
            {
                ...
                if (RadInvA4.Checked)
                    ...
                    c = "2";
                ntyp += c;
                ntyp = (checkBox_previewPrint3.Checked ? (ntyp + "0") : (ntyp + "1"));
