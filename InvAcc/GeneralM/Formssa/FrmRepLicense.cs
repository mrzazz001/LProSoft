...
{
    public partial class FrmRepLicense : Form
    {
        ...
        {
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(InvAcc.Forms.FrmRepLicense));
            ...
            base.Name = "FrmRepLicense";
            base.Load += new System.EventHandler(FrmRepLicense_Load);
            base.KeyPress += new System.Windows.Forms.KeyPressEventHandler(FrmRepLicense_KeyPress);
            base.KeyDown += new System.Windows.Forms.KeyEventHandler(FrmRepLicense_KeyDown);
        ...
        private void RibunButtons()
        {
            ...
            else
            {
                ...
                Text = "License Report of Employee";
            }
        }
        private void FrmRepLicense_Load(object sender, EventArgs e)
        {
            try
            {
                ComponentResourceManager resources = new ComponentResourceManager(typeof(FrmRepLicense));
                if (VarGeneral.CurrentLang.ToString() == "0" || VarGeneral.CurrentLang.ToString() == string.Empty)
                {
                ...
                var q = (from t in db.T_Emps
                         orderby t.ID_Date, t.License_DateEnd
                         where t.ID_Date != string.Empty
                         select new
                         {
                             t.License_Date,
                             t.License_DateEnd
                ...
                if (q.Count() == 0)
                {
                    ...
                    dateTimeInput_EndVacationFrom.Text = string.Empty;
                    dateTimeInput_EndVacationTo.Text = string.Empty;
                }
                else
                {
                    dateTimeInput_StartVacationFrom.Text = Convert.ToDateTime(q.First().License_Date).ToString("yyyy/MM/dd");
                    dateTimeInput_EndVacationFrom.Text = Convert.ToDateTime(q.Last().License_Date).ToString("yyyy/MM/dd");
                    dateTimeInput_StartVacationTo.Text = Convert.ToDateTime(q.First().License_DateEnd).ToString("yyyy/MM/dd");
                    dateTimeInput_EndVacationTo.Text = Convert.ToDateTime(q.Last().License_DateEnd).ToString("yyyy/MM/dd");
                }
            }
        ...
        private void FrmRepLicense_KeyPress(object sender, KeyPressEventArgs e)
        {
            if (e.KeyChar == '\r')
            {
                SendKeys.Send("{Tab}");
        ...
        private void FrmRepLicense_KeyDown(object sender, KeyEventArgs e)
        {
        ...
        private string GetSqlWhere()
        {
            ...
            {
                QStr = QStr + " AND ( License_Date >= '" + Convert.ToDateTime(dateTimeInput_StartVacationFrom.Text).ToString("yyyy/MM/dd") + "' ) ";
            }
            if (dateTimeInput_StartVacationTo.Text != "    /  /" && dateTimeInput_StartVacationTo.Text.Length == 10)
            {
                QStr = QStr + " AND ( License_Date <= '" + Convert.ToDateTime(dateTimeInput_StartVacationTo.Text).ToString("yyyy/MM/dd") + "' ) ";
            }
            if (dateTimeInput_EndVacationFrom.Text != "    /  /" && dateTimeInput_EndVacationFrom.Text.Length == 10)
            {
                QStr = QStr + " AND ( License_DateEnd >= '" + Convert.ToDateTime(dateTimeInput_EndVacationFrom.Text).ToString("yyyy/MM/dd") + "' ) ";
            }
            if (dateTimeInput_EndVacationTo.Text != "    /  /" && dateTimeInput_EndVacationTo.Text.Length == 10)
            {
                QStr = QStr + " AND ( License_DateEnd <= '" + Convert.ToDateTime(dateTimeInput_EndVacationTo.Text).ToString("yyyy/MM/dd") + "' ) ";
            }
            return QStr;
        }
