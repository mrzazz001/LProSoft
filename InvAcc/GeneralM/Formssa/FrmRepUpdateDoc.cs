...
{
    public partial class FrmRepUpdateDoc : Form
    {
        ...
        private void RibunButtons()
        {
            ...
            else
            {
                ...
                Text = "Update Documents Report";
            }
        }
        private void FrmRepUpdateDoc_Load(object sender, EventArgs e)
        {
            try
            {
                ComponentResourceManager resources = new ComponentResourceManager(typeof(FrmRepUpdateDoc));
                if (VarGeneral.CurrentLang.ToString() == "0" || VarGeneral.CurrentLang.ToString() == "")
                {
        ...
        public void FillCombo()
        {
            ...
            comboBox_DocType.Items.Add((LangArEn == 0) ? "الكل" : "All");
            comboBox_DocType.Items.Add((LangArEn == 0) ? "وثائق الهوية فقط" : "ID");
            comboBox_DocType.Items.Add((LangArEn == 0) ? "وثائق الجواز فقط" : "Passport");
            comboBox_DocType.Items.Add((LangArEn == 0) ? "وثائق الرخص فقط" : "Licenses");
            comboBox_DocType.Items.Add((LangArEn == 0) ? "وثائق التأمين فقط" : "Allownces");
        ...
        private void FrmRepUpdateDoc_KeyPress(object sender, KeyPressEventArgs e)
        {
            if (e.KeyChar == '\r')
            {
                SendKeys.Send("{Tab}");
        ...
        private void FrmRepUpdateDoc_KeyDown(object sender, KeyEventArgs e)
        {
        ...
        private string GetSqlWhere()
        {
            ...
            if (comboBox_DocType.SelectedIndex == 1)
            {
                QStr += " AND T_UpdateDoc.DocTyp = 0 ";
            }
            else if (comboBox_DocType.SelectedIndex == 2)
            {
                QStr += " AND T_UpdateDoc.DocTyp = 1 ";
            }
            else if (comboBox_DocType.SelectedIndex == 3)
            {
                QStr += " AND T_UpdateDoc.DocTyp = 2 ";
            }
            else if (comboBox_DocType.SelectedIndex == 4)
            {
                QStr += " AND T_UpdateDoc.DocTyp = 3 ";
            }
            return QStr;
        }
        ...
        {
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(InvAcc.Forms.FrmRepUpdateDoc));
            ...
            groupBox_Date.Controls.Add(comboBox_DocType);
            resources.ApplyResources(groupBox_Date, "groupBox_Date");
            groupBox_Date.ForeColor = System.Drawing.Color.Maroon;
            ...
            base.Name = "FrmRepUpdateDoc";
            base.Load += new System.EventHandler(FrmRepUpdateDoc_Load);
            base.KeyPress += new System.Windows.Forms.KeyPressEventHandler(FrmRepUpdateDoc_KeyPress);
            base.KeyDown += new System.Windows.Forms.KeyEventHandler(FrmRepUpdateDoc_KeyDown);
