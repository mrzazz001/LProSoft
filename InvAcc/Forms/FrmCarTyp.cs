...
#pragma warning disable CS0414 // The field 'FrmCarTyp.FlagUpdate' is assigned but its value is never used
        private string FlagUpdate = "";
#pragma warning restore CS0414 // The field 'FrmCarTyp.FlagUpdate' is assigned but its value is never used
        ...
        {
            ComponentResourceManager resources = new ComponentResourceManager(typeof(FrmCarTyp));
...
#pragma warning disable CS0169 // The field 'FrmCarTyp.PanelSpecialContainer' is never used
        private Panel PanelSpecialContainer;
#pragma warning restore CS0169 // The field 'FrmCarTyp.PanelSpecialContainer' is never used
        ...
        private void FrmCarTyp_Load(object sender, EventArgs e)
        {
            try
            {
                ComponentResourceManager resources = new ComponentResourceManager(typeof(FrmCarTyp));
        ...
        private void Button_Delete_Click(object sender, EventArgs e)
        {
            ...
            if (returned != null)
            {
                ...
                num = ((carType.GetValueOrDefault() == 0 && carType.HasValue) ? 1 : 0);
            }
            else
            {
                num = 1;
