...
{
    public partial  class FMPaymentVoucher : Form
    { void avs(int arln)

{ 
 label12.Text=   (arln == 0 ? "  رقم الفاتورة :  " : "  invoice number :") ; label10.Text=   (arln == 0 ? "  البيان - إنجليزي :  " : "  Statement - English:") ; label7.Text=   (arln == 0 ? "  رقم المرجع :  " : "  reference number :") ; Label2.Text=   (arln == 0 ? "  التاريــــــــخ :  " : "  date:") ; Label1.Text=   (arln == 0 ? "  رقم السند :  " : "  Bond No :") ; label5.Text=   (arln == 0 ? "  رقم الشيك  " : "  check number") ; label8.Text=   (arln == 0 ? "  أصرفوا لـــ :  " : "  spend for:") ; label3.Text=   (arln == 0 ? "  قيمة المدين  " : "  Debit value") ; label17.Text=   (arln == 0 ? "  الرصيد  " : "  Balance") ; Label21.Text=   (arln == 0 ? "  قيمة الدائن  " : "  creditor value") ; Label9.Text=   (arln == 0 ? "  البيان - عـــربي :  " : "  Statement - Arabic:") ; label6.Text=   (arln == 0 ? "  الحســــاب :  " : "  Account:") ; label19.Text=   (arln == 0 ? "  العملة :  " : "  the currency :") ; label18.Text=   (arln == 0 ? "  المنـــــدوب :  " : "  The delegate:") ; label15.Text=   (arln == 0 ? "  مركز التكلفــة :  " : "  cost center:") ; label4.Text=   (arln == 0 ? "  حساب الدائن :  " : "  creditor account:") ; superTabControl_Main1.Text=   (arln == 0 ? "  superTabControl3  " : "  superTabControl3") ; button_Repetition.Text=   (arln == 0 ? "  تكرار القيد  " : "  Repetition of entry") ; Button_Close.Text=   (arln == 0 ? "  إغلاق  " : "  Close") ; /*buttonItem_Print.Text=   (arln == 0 ? "  طباعة  " : "  Print") ;*/ printersettings.Text=   (arln == 0 ? "  اعدادات الطابعه  " : "  printer settings") ; Button_Search.Text=   (arln == 0 ? "  بحث  " : "  Search") ; Button_Delete.Text=   (arln == 0 ? "  حذف  " : "  delete") ; Button_Save.Text=   (arln == 0 ? "  حفظ  " : "  save") ; Button_Add.Text=   (arln == 0 ? "  إضافة  " : "  addition") ; superTabControl_Main2.Text=   (arln == 0 ? "  superTabControl1  " : "  superTabControl1") ; Button_First.Text=   (arln == 0 ? "  الأول  " : "  the first") ; Button_Prev.Text=   (arln == 0 ? "  السابق  " : "  the previous") ; lable_Records.Text=   (arln == 0 ? "  ---  " : "  ---") ; Button_Next.Text=   (arln == 0 ? "  التالي  " : "  next one") ; Button_Last.Text=   (arln == 0 ? "  الأخير  " : "  the last one") ; ToolStripMenuItem_Rep.Text=   (arln == 0 ? "  إظهار التقرير  " : "  Show report") ; panelEx2.Text=   (arln == 0 ? "  Click to collapse  " : "  Click to collapse") ; ToolStripMenuItem_Det.Text=   (arln == 0 ? "  إظهار التفاصيل  " : "  Show details") ; panelEx3.Text=   (arln == 0 ? "  Fill Panel  " : "  Fill Panel") ; DGV_Main.Text=   (arln == 0 ? "    " : "    ") ; DGV_Main.Text=   (arln == 0 ? "  جميــع السجــــلات  " : "  All records") ; DGV_Main.Text=   (arln == 0 ? "    " : "    ") ; superTabControl_DGV.Text=   (arln == 0 ? "  superTabControl1  " : "  superTabControl1") ; textBox_search.Text=   (arln == 0 ? "  ...  " : "  ...") ; Button_ExportTable2.Text=   (arln == 0 ? "  تصدير  " : "  Export") ; /*Button_PrintTable.Text=   (arln == 0 ? "  طباعة  " : "  Print") ; */Button_PrintTableMulti.Text=   (arln == 0 ? "  طباعة السندات المحددة  " : "  Print selected bonds") ; Text = "سند صرف";this.Text=   (arln == 0 ? "  سند صرف  " : "  receipt") ;}
...
#pragma warning disable CS0414 // The field 'FMPaymentVoucher.indColumn' is assigned but its value is never used
        private int indColumn = 0;
#pragma warning restore CS0414 // The field 'FMPaymentVoucher.indColumn' is assigned but its value is never used
#pragma warning disable CS0169 // The field 'FMPaymentVoucher.cellValue' is never used
        private string cellValue;
#pragma warning restore CS0169 // The field 'FMPaymentVoucher.cellValue' is never used
#pragma warning disable CS0414 // The field 'FMPaymentVoucher.ifAcc1F' is assigned but its value is never used
        private bool ifAcc1F = false;
#pragma warning restore CS0414 // The field 'FMPaymentVoucher.ifAcc1F' is assigned but its value is never used
#pragma warning disable CS0414 // The field 'FMPaymentVoucher.ifAcc2F' is assigned but its value is never used
        private bool ifAcc2F = false;
#pragma warning restore CS0414 // The field 'FMPaymentVoucher.ifAcc2F' is assigned but its value is never used
#pragma warning disable CS0414 // The field 'FMPaymentVoucher.ifAccCF' is assigned but its value is never used
        private bool ifAccCF = false;
#pragma warning restore CS0414 // The field 'FMPaymentVoucher.ifAccCF' is assigned but its value is never used
       ...
       // private IContainer components = null;
        ...
        public void buttonItem_Print_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (!_InvSetting.InvpRINTERInfo.ISPOINTERType)
                {
        ...
        private void Button_ExportTable2_Click(object sender, EventArgs e)
        {
            try
            {
                ExportExcel.ExportToExcel(DGV_Main, "تقرير سندات الصرف");
            }
            catch
            {
            }
...
#pragma warning disable CS0219 // The variable 'AccCrdt' is assigned but its value is never used
            string AccCrdt = "";
#pragma warning restore CS0219 // The variable 'AccCrdt' is assigned but its value is never used
#pragma warning disable CS0219 // The variable 'AccDbt' is assigned but its value is never used
            string AccDbt = "";
#pragma warning restore CS0219 // The variable 'AccDbt' is assigned but its value is never used
            try
            {
                IDatabase db_ = Database.GetDatabase(VarGeneral.BranchCS);
                if (State == FormState.New)
        ...
        private void RibunButtons()
        {
            if (VarGeneral.CurrentLang.ToString() == "0" || VarGeneral.CurrentLang.ToString() == "")
            {
                ...
                label17.Text = "الرصيد";
                label8.Text = "أصرفوا لـــ :";
                label4.Text = "حساب الدائن :";
                Text = "سند صرف";
        ...
        private void prnt_doc_BeginPrint(object sender, PrintEventArgs e)
        {
            ...
            RepShow _RepShow = new RepShow();
            _RepShow.Tables = "T_GDDET LEFT OUTER JOIN T_GDHEAD ON T_GDDET.gdID = T_GDHEAD.gdhead_ID LEFT OUTER JOIN T_INVSETTING ON T_GDHEAD.gdTyp = T_INVSETTING.InvID  LEFT OUTER JOIN T_Curency ON T_GDHEAD.CurTyp = T_Curency.Curency_ID LEFT OUTER JOIN T_CstTbl ON T_GDHEAD.gdCstNo = T_CstTbl.Cst_ID LEFT OUTER JOIN T_Mndob ON T_GDHEAD.gdMnd = T_Mndob.Mnd_ID LEFT OUTER JOIN T_AccDef ON T_GDDET.AccNo = T_AccDef.AccDef_No LEFT OUTER JOIN T_SYSSETTING ON T_GDHEAD.CompanyID = T_SYSSETTING.SYSSETTING_ID ";
            string Fields = " CASE WHEN T_GDDET.gdValue > 0 THEN T_GDDET.gdValue ELSE 0 END as DebitBala , CASE WHEN T_GDDET.gdValue < 0 THEN Abs(T_GDDET.gdValue) ELSE 0 END as CreditBala , T_Curency.Arb_Des as Arb_Cur , T_Curency.Eng_Des as Eng_Cur , T_Curency.Rate, T_CstTbl.Arb_Des as Arb_Cst, T_CstTbl.Eng_Des as Eng_Cst , T_Mndob.Arb_Des as Arb_Mnd, T_Mndob.Eng_Des as Eng_Mnd , T_GDHEAD.* , T_GDDET.AccNo as AccDef_No,T_AccDef.Arb_Des ,T_AccDef.Eng_Des ,T_GDDET.gdDes,T_GDDET.gdDesE,T_SYSSETTING.LogImg,(select InvNamA from T_INVSETTING where T_GDHEAD.gdTyp = T_INVSETTING.InvID ) as InvNamA,(select InvNamE from T_INVSETTING where T_GDHEAD.gdTyp = T_INVSETTING.InvID ) as InvNamE,T_GDHEAD.gdMem as InvTypA0 ,T_CstTbl.Cst_No,(select T_AccDef.Arb_Des from T_AccDef where T_AccDef.AccDef_No = (select (x.AccNo) from T_GDDET as x where x.gdID = (T_GDDET.gdID) and x.Lin = 1 )) as ch,(select T_AccDef.Eng_Des from T_AccDef where T_AccDef.AccDef_No = (select (x.AccNo) from T_GDDET as x where x.gdID = (T_GDDET.gdID) and x.Lin = 1 )) as tm,(select T_AccDef.Arb_Des from T_AccDef where T_AccDef.AccDef_No = (select (x.AccNo) from T_GDDET as x where x.gdID = (T_GDDET.gdID) and x.Lin = 0 )) as dt,(select T_AccDef.Eng_Des from T_AccDef where T_AccDef.AccDef_No = (select (x.AccNo) from T_GDDET as x where x.gdID = (T_GDDET.gdID) and x.Lin = 0 )) as curr,(select max(T_AccDef.Arb_Des) from T_AccDef where AccDef_No = (select max(x.AccNo) from T_GDDET x where x.gdID = (T_GDDET.gdID) and Lin = 1)) as CusVenNm,(select max(T_AccDef.Eng_Des) from T_AccDef where AccDef_No = (select max(x.AccNo) from T_GDDET x where x.gdID = (T_GDDET.gdID) and Lin = 1)) as CusVenNmE,(select max(T_AccDef.PersonalNm) from T_AccDef where AccDef_No = (select max(x.AccNo) from T_GDDET x where x.gdID = (T_GDDET.gdID) and Lin = 1)) as PersonalNm,(select max(T_AccDef.City) from T_AccDef where AccDef_No = (select max(x.AccNo) from T_GDDET x where x.gdID = (T_GDDET.gdID) and Lin = 1)) as City,(select max(T_AccDef.Email) from T_AccDef where AccDef_No = (select max(x.AccNo) from T_GDDET x where x.gdID = (T_GDDET.gdID) and Lin = 1)) as Email,(select max(T_AccDef.Mobile) from T_AccDef where AccDef_No = (select max(x.AccNo) from T_GDDET x where x.gdID = (T_GDDET.gdID) and Lin = 1)) as Mobile";
            VarGeneral.HeaderRep[0] = Text;
            VarGeneral.HeaderRep[1] = "";
            VarGeneral.HeaderRep[2] = "";
            _RepShow.Rule = " where T_GDHEAD.gdhead_ID = " + data_this.gdhead_ID + " Order by T_GDDET.Lin ";
        ...
        private void button_SrchInvNo_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                MessageBox.Show((LangArEn == 0) ? ("لا يوجد لـ " + c1FlexGrid1.GetData(1, 2).ToString() + " فواتير مشتريات آجلة غير مسد\u0651دة") : ("There is no" + c1FlexGrid1.GetData(1, 3).ToString() + "Outstanding unpaid bills"), VarGeneral.ProdectNam, MessageBoxButtons.OK, MessageBoxIcon.Hand);
                goto end_IL_0054;
            IL_01ea:
                if (VarGeneral._GaidInv.Count <= 0)
                {
                ...
                columns_Names_visible2.Add("Puyaid", new ColumnDictinary("المتبقي له", "Remming", ifDefault: true, ""));
                columns_Names_visible2.Add("Remming", new ColumnDictinary("صر\u0651ف له", "Puaid", ifDefault: true, ""));
        ...
        private void printersettings_Click(object sender, EventArgs e)
        {
            ...
            f.TopMost = true;
            f.ShowDialog();
            _InvSetting.InvpRINTERInfo.Repl_ntyp =  ProShared. DroBoxSync.Frm_PrinterShow.PLSetting;
        }
