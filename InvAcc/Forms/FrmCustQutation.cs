...
{
    public partial  class FrmCustQutation : Form
    { void avs(int arln)

{ 
 label6.Text=   (arln == 0 ? "   الجوال :  " : "   cell phone :") ; label25.Text=   (arln == 0 ? "  الوحدة  " : "  Unit") ; label22.Text=   (arln == 0 ? "  سعر اخر عرض سعر  " : "  Last price quote") ; label23.Text=   (arln == 0 ? "  أخر تكلفة  " : "  latest cost") ; label24.Text=   (arln == 0 ? "  متوسط التكلفة  " : "  average cost") ; superTabItem_items.Text=   (arln == 0 ? "  م.الصنف  " : "  M. Category") ; superTabControl_CostSts.Text=   (arln == 0 ? "  superTabControl3  " : "  superTabControl3") ; label34.Text=   (arln == 0 ? "  الدائـــــن :  " : "  creditor:") ; label35.Text=   (arln == 0 ? "  المـــدين :  " : "  Debtor:") ; checkBox_CostGaidTax.Text=   (arln == 0 ? "  سند محاسبي  " : "  accounting document") ; label36.Text=   (arln == 0 ? "  بالريــــال  " : "  in riyals") ; superTabItem_Tax.Text=   (arln == 0 ? "  الضـــرائب  " : "  taxes") ; label31.Text=   (arln == 0 ? "  إجمالي القيمة  " : "  Total value") ; label37.Text=   (arln == 0 ? "  الدائـــــن :  " : "  creditor:") ; label38.Text=   (arln == 0 ? "  المـــدين :  " : "  Debtor:") ; label39.Text=   (arln == 0 ? "  بالريــــال  " : "  in riyals") ; checkBox_GaidDis.Text=   (arln == 0 ? "  سند محاسبي  " : "  accounting document") ; superTabItem_Dis.Text=   (arln == 0 ? "  الخصـــــم  " : "  discount ال") ; labelItem_TaxByNetPer.Text=   (arln == 0 ? "  %  " : "  %") ; superTabItem_Gaids.Text=   (arln == 0 ? "  القيود  " : "  limitations") ; superTabItem_Note.Text=   (arln == 0 ? "  ملاحظات  " : "  Notes") ; label_LockeName.Text=   (arln == 0 ? "  --  " : "  --") ; label27.Text=   (arln == 0 ? "  المستخدم :  " : "  the user :") ; label28.Text=   (arln == 0 ? "  الربح :  " : "  profit:") ; label30.Text=   (arln == 0 ? "  إجمالي الكمية :  " : "  Total Quantity:") ; label_Curr.Text=   (arln == 0 ? "  العملة  " : "  the currency") ; superTabItem_Detiles.Text=   (arln == 0 ? "  تفاصيل  " : "  details") ; labelC1.Text=   (arln == 0 ? "  الدائـــن :  " : "  creditor:") ; labelD1.Text=   (arln == 0 ? "  المـــدين :  " : "  Debtor:") ; label16.Text=   (arln == 0 ? "  نقــداٌ :  " : "  cash:") ; superTabItem_Pay.Text=   (arln == 0 ? "  السند المحاسبي  " : "  Accounting bond") ; label12.Text=   (arln == 0 ? "  هاتف :  " : "  Telephone :") ;  checkBox_NetWork.Text=   (arln == 0 ? "  شبكـــة  " : "Network") ; checkBox_Credit.Text=   (arln == 0 ? "  أجـــل  " : "Credit") ; checkBox_Chash.Text=   (arln == 0 ? "  نقـــدي  " : "Cach") ; label5.Text=   (arln == 0 ? "  السعر المعتمــد :  " : "  Approved price:") ; label15.Text=   (arln == 0 ? "  مركز التكلفـــــة :  " : "  cost center:") ; label10.Text=   (arln == 0 ? "  اسم العميـــــل :  " : "  Client name:") ; label4.Text=   (arln == 0 ? "  حساب العميــل :  " : "  Customer account:") ; label13.Text=   (arln == 0 ? "  عنوان العميل :  " : "  Customer address:") ; label19.Text=   (arln == 0 ? "  العملــــــــة :  " : "  work:") ; label18.Text=   (arln == 0 ? "  المنـــــدوب :  " : "  The delegate:") ; label7.Text=   (arln == 0 ? "  رقم المرجع :  " : "  reference number :") ; Label2.Text=   (arln == 0 ? "  التاريــــــــخ :  " : "  date:") ; Label1.Text=   (arln == 0 ? "  رقم الفاتورة :  " : "  invoice number :") ; label8.Text=   (arln == 0 ? "  نسبة الخصم  " : "  discount percentage") ; label33.Text=   (arln == 0 ? "  الضريبة VAT:  " : "  VAT:") ; Label26.Text=   (arln == 0 ? "  قيمة الخصم  " : "  discount value") ; label3.Text=   (arln == 0 ? "  بالريــال  " : "  in riyals") ; label9.Text=   (arln == 0 ? "  صافي الفاتورة :  " : "  net bill:") ; label17.Text=   (arln == 0 ? "  قيمة الفاتـــورة :  " : "  Invoice value:") ; superTabControl_Main1.Text=   (arln == 0 ? "  superTabControl3  " : "  superTabControl3") ; button_Repetition.Text=   (arln == 0 ? "  تكرار  " : "  Repetition") ; Button_Close.Text=   (arln == 0 ? "  إغلاق  " : "  Close") ; /*buttonItem_Print.Text=   (arln == 0 ? "  طباعة  " : "  Print") ;*/ printersettings.Text=   (arln == 0 ? "  اعدادات الطابعه  " : "  printer settings") ; Button_Search.Text=   (arln == 0 ? "  بحث  " : "  Search") ; Button_Delete.Text=   (arln == 0 ? "  حذف  " : "  delete") ; Button_Save.Text=   (arln == 0 ? "  حفظ  " : "  save") ; Button_Add.Text=   (arln == 0 ? "  إضافة  " : "  addition") ; superTabControl_Main2.Text=   (arln == 0 ? "  superTabControl1  " : "  superTabControl1") ; Button_First.Text=   (arln == 0 ? "  الأول  " : "  the first") ; Button_Prev.Text=   (arln == 0 ? "  السابق  " : "  the previous") ; lable_Records.Text=   (arln == 0 ? "  ---  " : "  ---") ; Button_Next.Text=   (arln == 0 ? "  التالي  " : "  next one") ; Button_Last.Text=   (arln == 0 ? "  الأخير  " : "  the last one") ; ToolStripMenuItem_Rep.Text=   (arln == 0 ? "  إظهار التقرير  " : "  Show report") ; panelEx3.Text=   (arln == 0 ? "  Fill Panel  " : "  Fill Panel") ; DGV_Main.Text=   (arln == 0 ? "    " : "    ") ; DGV_Main.Text=   (arln == 0 ? "  جميــع السجــــلات  " : "  All records") ; DGV_Main.Text=   (arln == 0 ? "    " : "    ") ; superTabControl_DGV.Text=   (arln == 0 ? "  superTabControl1  " : "  superTabControl1") ; textBox_search.Text=   (arln == 0 ? "  ...  " : "  ...") ; Button_ExportTable2.Text=   (arln == 0 ? "  تصدير  " : "  Export") ; /*Button_PrintTable.Text=   (arln == 0 ? "  طباعة  " : "  Print") ; */panelEx2.Text=   (arln == 0 ? "  Click to collapse  " : "  Click to collapse") ; ToolStripMenuItem_Det.Text=   (arln == 0 ? "  إظهار التفاصيل  " : "  Show details") ; Text = "عرض سعر للعملاء";this.Text=   (arln == 0 ? "  عرض سعر للعملاء  " : "  Quotation for customers") ;}
        private void langloads(object sender, EventArgs e)
        {
              avs(ProShared. GeneralM.VarGeneral.currentintlanguage);; netResize1.SetResizeControl(superTabControl_Info, true);
            netResize1.FormCenter();
        }
...
#pragma warning disable CS0414 // The field 'FrmCustQutation.UnitAOld' is assigned but its value is never used
        private string UnitAOld = "";
#pragma warning restore CS0414 // The field 'FrmCustQutation.UnitAOld' is assigned but its value is never used
#pragma warning disable CS0414 // The field 'FrmCustQutation.UnitEOld' is assigned but its value is never used
        private string UnitEOld = "";
#pragma warning restore CS0414 // The field 'FrmCustQutation.UnitEOld' is assigned but its value is never used
#pragma warning disable CS0414 // The field 'FrmCustQutation.PriceOld' is assigned but its value is never used
        private double PriceOld = 0.0;
#pragma warning restore CS0414 // The field 'FrmCustQutation.PriceOld' is assigned but its value is never used
...
#pragma warning disable CS0169 // The field 'FrmCustQutation.FrmRezie' is never used
        clsResize FrmRezie; SplitContainer splitContainer1 = new SplitContainer();
#pragma warning restore CS0169 // The field 'FrmCustQutation.FrmRezie' is never used
        private void frmload(object sender, EventArgs e)
        {
            //  FrmRezie._get_initial_size();
        }
#pragma warning disable CS0414 // The field 'FrmCustQutation.ksa' is assigned but its value is never used
#pragma warning disable CS0414 // The field 'FrmCustQutation.comdfa' is assigned but its value is never used
        int ksa = 1; int comdfa = 0;
#pragma warning restore CS0414 // The field 'FrmCustQutation.comdfa' is assigned but its value is never used
#pragma warning restore CS0414 // The field 'FrmCustQutation.ksa' is assigned but its value is never used
        ...
        {
            ComponentResourceManager resources = new ComponentResourceManager(typeof(FrmCustQutation));
            if (VarGeneral.CurrentLang.ToString() == "0" || VarGeneral.CurrentLang.ToString() == "")
            {
        ...
        private bool SaveData()
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    dbHead.AddParameter("PriceIncludTax", DbType.Boolean, data_this.IS_ServiceBill);
...
#pragma warning disable CS0414 // The field 'FrmCustQutation.convertflag' is assigned but its value is never used
   int     convertflag=0;
#pragma warning restore CS0414 // The field 'FrmCustQutation.convertflag' is assigned but its value is never used
...
#pragma warning disable CS0414 // The field 'FrmCustQutation.tl' is assigned but its value is never used
        double ta = 0.0, tl = 0.0;
#pragma warning restore CS0414 // The field 'FrmCustQutation.tl' is assigned but its value is never used
...
#pragma warning disable CS0414 // The field 'FrmCustQutation.keychtax' is assigned but its value is never used
        bool keychtax = false;
#pragma warning restore CS0414 // The field 'FrmCustQutation.keychtax' is assigned but its value is never used
#pragma warning disable CS0414 // The field 'FrmCustQutation.keyishNo' is assigned but its value is never used
        bool keyishNo = false;
#pragma warning restore CS0414 // The field 'FrmCustQutation.keyishNo' is assigned but its value is never used
   ...
   int r, int c, int f)
        ...
        private void FlxInv_AfterEdit(object sender, RowColEventArgs e)
        {
            ...
            if (e.Col == 1)
            {
                BindDataOfItem(); if (FlxInv.GetData(e.Row, 1) != null)
...
#pragma warning restore CS0219 // The variable 'ItmPri' is assigned but its value is never used
            ...
            BindDataOfStkQty(_Items.Itm_No.Trim()); PriceLoc = (double)FlxInv.GetData(FlxInv.Row, 8); without = PriceLoc; pricel = PriceLoc; lastprice = 0; ta = (double)FlxInv.GetData(FlxInv.Row, 31); BindDataOfStkQty(_Items.Itm_No.Trim());
        ...
        private void printersettings_Click(object sender, EventArgs e)
        {
            ...
            buttonItem_Print.Text = (_InvSetting.ISdirectPrinting ? (LangArEn == 0 ? "طباعة" : "Print") : (LangArEn == 0 ? "عرض" : "Preview"));buttonItem_Print.Text = (_InvSetting.ISdirectPrinting ? (LangArEn == 0 ? "طباعة" : "Print") : (LangArEn == 0 ? "عرض" : "Preview"));
        
        }
        private void Button_Next_Click_1(object sender, EventArgs e)
        {
        }
#pragma warning disable CS0414 // The field 'FrmCustQutation.enterflag' is assigned but its value is never used
#pragma warning disable CS0414 // The field 'FrmCustQutation.modefiy' is assigned but its value is never used
        int kk = 0; bool enterflag = false, edit = false, modefiy = false;
#pragma warning restore CS0414 // The field 'FrmCustQutation.modefiy' is assigned but its value is never used
#pragma warning restore CS0414 // The field 'FrmCustQutation.enterflag' is assigned but its value is never used
...
#pragma warning disable CS0414 // The field 'FrmCustQutation.tt' is assigned but its value is never used
#pragma warning disable CS0414 // The field 'FrmCustQutation.pt' is assigned but its value is never used
        double pt = 0, tt = 0;
#pragma warning restore CS0414 // The field 'FrmCustQutation.pt' is assigned but its value is never used
#pragma warning restore CS0414 // The field 'FrmCustQutation.tt' is assigned but its value is never used
