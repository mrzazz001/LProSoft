...
{ 
 ToolStripMenuItem_Det.Text=   (arln == 0 ? "  إظهار التفاصيل  " : "  Show details") ; ToolStripMenuItem_Rep.Text=   (arln == 0 ? "  إظهار التقرير  " : "  Show report") ; panelEx2.Text=   (arln == 0 ? "  Click to collapse  " : "  Click to collapse") ; label27.Text=   (arln == 0 ? "  الــرقم الضريبـــي :  " : "  Tax number:") ; label97.Text=   (arln == 0 ? "  رقم التأمين :  " : "  Insurance number :") ; label88.Text=   (arln == 0 ? "  تاريخها :  " : "  Its history:") ; label95.Text=   (arln == 0 ? "  المصدر :  " : "  Source :") ; label92.Text=   (arln == 0 ? "  إنتهائها :  " : "  Ending:") ; label5.Text=   (arln == 0 ? "  تاريخها :  " : "  Its history:") ; label18.Text=   (arln == 0 ? "  المصدر :  " : "  Source :") ; label21.Text=   (arln == 0 ? "  رقم الجواز :  " : "  Passport number:") ; label22.Text=   (arln == 0 ? "  إنتهائها :  " : "  Ending:") ; label25.Text=   (arln == 0 ? "  رقم الهوية :  " : "  ID Number :") ; label23.Text=   (arln == 0 ? "  تاريخها :  " : "  Its history:") ; label24.Text=   (arln == 0 ? "  المصدر :  " : "  Source :") ; label26.Text=   (arln == 0 ? "  إنتهائها :  " : "  Ending:") ; label70.Text=   (arln == 0 ? "  الراتب والبدلات :  " : "  Salary and allowances:") ; label53.Text=   (arln == 0 ? "  تاريخ التعـــــيين :  " : "  Appointment date:") ; label20.Text=   (arln == 0 ? "  الرمز البريدي :  " : "  Postal code :") ; label6.Text=   (arln == 0 ? "  العنوان :  " : "  Address :") ; label7.Text=   (arln == 0 ? "  الإيميل :  " : "  Email:") ; label8.Text=   (arln == 0 ? "  البلد :  " : "  Country :") ; label12.Text=   (arln == 0 ? "  الفاكس :  " : "  Fax:") ; label13.Text=   (arln == 0 ? "  الجوال :  " : "  cell phone :") ; label9.Text=   (arln == 0 ? "  الهاتف :  " : "  the phone :") ; label11.Text=   (arln == 0 ? "  ص . ب :  " : "  s . B :") ; label10.Text=   (arln == 0 ? "  عمر الدين :  " : "  Omar Eddin:") ; label16.Text=   (arln == 0 ? "  حد المديونية :  " : "  Debt Limit:") ; label15.Text=   (arln == 0 ? "  الرصيد الحالي :  " : "  current balance :") ; label14.Text=   (arln == 0 ? "  دائن :  " : "  Creditor :") ; label17.Text=   (arln == 0 ? "  مدين :  " : "  Debit :") ; label19.Text=   (arln == 0 ? "  إسم المسؤول :  " : "  Name of the manager :") ; label3.Text=   (arln == 0 ? "  حساب الأب :  " : "  Father's account:") ; label4.Text=   (arln == 0 ? "  رقم الموظف :  " : "  Employee number :") ; label2.Text=   (arln == 0 ? "  الإسم الإنجليزي :  " : "  English name:") ; label1.Text=   (arln == 0 ? "  الإسم العربي :  " : "  Arabic name:") ; line3.Text=   (arln == 0 ? "  line3  " : "  line3") ; superTabItem1.Text=   (arln == 0 ? "  superTabItem2  " : "  superTabItem2") ; superTabControl_Main1.Text=   (arln == 0 ? "  superTabControl3  " : "  superTabControl3") ; Button_Close.Text=   (arln == 0 ? "  إغلاق  " : "  Close") ; Button_Search.Text=   (arln == 0 ? "  بحث  " : "  Search") ; Button_Delete.Text=   (arln == 0 ? "  حذف  " : "  delete") ; Button_Save.Text=   (arln == 0 ? "  حفظ  " : "  save") ; Button_Add.Text=   (arln == 0 ? "  إضافة  " : "  addition") ; superTabControl_Main2.Text=   (arln == 0 ? "  superTabControl1  " : "  superTabControl1") ; Button_First.Text=   (arln == 0 ? "  الأول  " : "  the first") ; Button_Prev.Text=   (arln == 0 ? "  السابق  " : "  the previous") ; lable_Records.Text=   (arln == 0 ? "  ---  " : "  ---") ; Button_Next.Text=   (arln == 0 ? "  التالي  " : "  next one") ; Button_Last.Text=   (arln == 0 ? "  الأخير  " : "  the last one") ; panelEx3.Text=   (arln == 0 ? "  Fill Panel  " : "  Fill Panel") ; DGV_Main.Text=   (arln == 0 ? "    " : "    ") ; DGV_Main.Text=   (arln == 0 ? "  جميــع السجــــلات  " : "  All records") ; DGV_Main.Text=   (arln == 0 ? "    " : "    ") ; superTabControl_DGV.Text=   (arln == 0 ? "  superTabControl1  " : "  superTabControl1") ; textBox_search.Text=   (arln == 0 ? "  ...  " : "  ...") ; Button_ExportTable2.Text=   (arln == 0 ? "  تصدير  " : "  Export") ; /*Button_PrintTable.Text=   (arln == 0 ? "  طباعة  " : "  Print") ; */Text = "الموظفين";this.Text=   (arln == 0 ? "  الموظفين  " : "  employees") ;}
...
#pragma warning disable CS0414 // The field 'FrmEmployees.FlagUpdate' is assigned but its value is never used
        private string FlagUpdate = "";
#pragma warning restore CS0414 // The field 'FrmEmployees.FlagUpdate' is assigned but its value is never used
       ...
       // private IContainer components = null;
        ...
        private TextBox textBox_ID_From;
        ...
        private TextBox textBox_Insurance_From;
        ...
        private TextBox textBox_Passport_From;
        ...
        public T_User Permmission
        {
            ...
            set
            {
                ...
                {
                    permission = value;
                    if (!VarGeneral.TString.ChkStatShow(value.FilStr, 41))
                    {
                        IfAdd = false;
                    }
                    else
                    ...
                    if (!VarGeneral.TString.ChkStatShow(value.FilStr, 42))
                    {
                        CanEdit = false;
                    }
                    else
                    ...
                    if (!VarGeneral.TString.ChkStatShow(value.FilStr, 43))
                    {
                        IfDelete = false;
                    }
                    else
        ...
        public void RefreshPKeys()
        {
            ...
            var qkeys = from item in db.T_AccDefs
                        where item.Lev == (int?)4 && item.AccCat == (int?)6
        ...
        public FrmEmployees()
        {
            ...
            textBox_ID_From.MouseDown += Button_Edit_Click;
            textBox_Passport_From.MouseDown += Button_Edit_Click;
            textBox_Insurance_From.MouseDown += Button_Edit_Click;
            ...
            if (VarGeneral.TString.ChkStatShow(VarGeneral.Settings_Sys.Seting, 49))
            {
                ...
                textBox_MainSal.DisplayFormat = VarGeneral.DicemalMask;
            }
        }
        ...
        {
            DGV_Main.PrimaryGrid.VirtualMode = false;
            List<T_AccDef> list = db.FillAccDef_2(textBox_search.TextBox.Text, 4, 6).ToList();
            if (list.Count() > 0)
            {
        ...
        public void SetData(T_AccDef value)
        {
            try
            {
                ...
                textBox_ID_From.Text = value.ID_From;
                textBox_Passport_From.Text = value.Passport_From;
                textBox_Insurance_From.Text = value.Insurance_From;
                textBox_ID_No.Text = value.ID_No;
                textBox_Insurance_No.Text = value.Insurance_No;
                if (value.MainSal.HasValue)
                {
                    textBox_MainSal.Value = value.MainSal.Value;
                }
                else
                {
                    textBox_MainSal.Value = 0.0;
                }
                ...
                try
                {
                    ...
                    {
                        dateTimeInput_Insurance_Date.Text = "";
                    }
                }
                catch
                {
                ...
                try
                {
                    ...
                    {
                        dateTimeInput_Insurance_DateEnd.Text = "";
                    }
                }
                catch
                {
                ...
                try
                {
                    ...
                    {
                        dateTimeInput_Passport_DateEnd.Text = "";
                    }
                }
                catch
                {
        ...
        private T_AccDef GetData()
        {
            ...
            data_this.ID_From = textBox_ID_From.Text;
            data_this.Passport_From = textBox_Passport_From.Text;
            data_this.Insurance_From = textBox_Insurance_From.Text;
        ...
        private void Button_Add_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                try
                {
                    T_AccDef q = db.StockAccDefWithOutBalance("2023");
                    if (q != null && !string.IsNullOrEmpty(q.AccDef_No))
                    {
                        txtMainAccNo.Text = "2023";
                    }
                }
                catch
                {
        ...
        private void Button_Save_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show((LangArEn == 0) ? "تأكد من صحة تاريخ التعيين" : "Apponintment Date is Rong", VarGeneral.ProdectNam, MessageBoxButtons.OK, MessageBoxIcon.Hand);
        ...
        private void ADD_Controls()
        {
            try
            {
                ...
                controls.Add(textBox_ID_From);
                controls.Add(textBox_Passport_From);
                controls.Add(textBox_Insurance_From);
            }
            catch (SqlException)
            {
            }
        ...
        public void Button_Print_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                _RepShow.Rule = " Where 1 = 1 and T_AccDef.AccCat = '6' and T_AccDef.Lev = 4 ";
        ...
        private void textBox_ID_From_Click(object sender, EventArgs e)
        {
            textBox_ID_From.SelectAll();
        }
        private void textBox_Passport_From_Click(object sender, EventArgs e)
        {
            textBox_Passport_From.SelectAll();
        }
        private void textBox_Insurance_From_Click(object sender, EventArgs e)
        {
            textBox_Insurance_From.SelectAll();
        }
        ...
        {
            textBox_ID_No.SelectAll();
        }
        private void textBox_Passport_No_Click(object sender, EventArgs e)
        {
            textBox_Passport_No.SelectAll();
        }
        private void textBox_Insurance_No_Click(object sender, EventArgs e)
        {
            textBox_Insurance_No.SelectAll();
        }
    }
}
