            ...
            try
            {
                ...
                if (vTy_ == 0)
                {
                    ...
                    LAccDef2 = (from t in db.T_AccDefs
                                ...
                                where (!string.IsNullOrEmpty(txtSearchMobile.Text.Trim()) && checkBox_ByMobile.Checked) ? t.Mobile.StartsWith(txtSearchMobile.Text.Trim()) : ((!string.IsNullOrEmpty(txtSearchMobile.Text.Trim()) && checkBox_ByName.Checked) ? ((LangArEn == 0) ? t.Arb_Des.Contains(txtSearchMobile.Text.Trim()) : t.Eng_Des.Contains(txtSearchMobile.Text.Trim())) : true)
                                orderby t.AccDef_No
                                select t).ToList();
                    if (LAccDef2.Count() > 0)
                    {
