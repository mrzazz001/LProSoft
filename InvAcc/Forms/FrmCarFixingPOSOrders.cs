...
{ 
 ToolStripMenuItem_Rep.Text=   (arln == 0 ? "  إظهار التقرير  " : "  Show report") ; panelEx3.Text=   (arln == 0 ? "  Fill Panel  " : "  Fill Panel") ; DGV_Main.Text=   (arln == 0 ? "    " : "    ") ; DGV_Main.Text=   (arln == 0 ? "  جميــع السجــــلات  " : "  All records") ; DGV_Main.Text=   (arln == 0 ? "    " : "    ") ; superTabControl_DGV.Text=   (arln == 0 ? "  superTabControl1  " : "  superTabControl1") ; textBox_search.Text=   (arln == 0 ? "  ...  " : "  ...") ; Button_ExportTable2.Text=   (arln == 0 ? "  تصدير  " : "  Export") ; /*Button_PrintTable.Text=   (arln == 0 ? "  طباعة  " : "  Print") ; */panelEx2.Text=   (arln == 0 ? "  Click to collapse  " : "  Click to collapse") ; label15.Text=   (arln == 0 ? "  مركز التكلفـــــة   " : "  cost center") ;  checkBox_NetWork.Text=   (arln == 0 ? "  شبكـــة  " : "Network") ; checkBox_Credit.Text=   (arln == 0 ? "  أجـــل  " : "Credit") ; checkBox_Chash.Text=   (arln == 0 ? "  نقـــدي  " : "Cach") ; label25.Text=   (arln == 0 ? "  الوحدة  " : "  Unit") ; label22.Text=   (arln == 0 ? "  سعر اخر عرض سعر  " : "  Last price quote") ; label19.Text=   (arln == 0 ? "  العملــــــــة :  " : "  work:") ; label23.Text=   (arln == 0 ? "  أخر تكلفة  " : "  latest cost") ; label24.Text=   (arln == 0 ? "  متوسط التكلفة  " : "  average cost") ; superTabItem_items.Text=   (arln == 0 ? "  م.الصنف  " : "  M. Category") ; label_LockeName.Text=   (arln == 0 ? "  --  " : "  --") ; label27.Text=   (arln == 0 ? "  المستخدم :  " : "  the user :") ; label28.Text=   (arln == 0 ? "  الربح :  " : "  profit:") ; label30.Text=   (arln == 0 ? "  إجمالي الكمية :  " : "  Total Quantity:") ; label_Curr.Text=   (arln == 0 ? "  العملة  " : "  the currency") ; superTabItem_Detiles.Text=   (arln == 0 ? "  تفاصيل  " : "  details") ; labelC1.Text=   (arln == 0 ? "  الدائـــن :  " : "  creditor:") ; labelD1.Text=   (arln == 0 ? "  المـــدين :  " : "  Debtor:") ; label16.Text=   (arln == 0 ? "  نقــداٌ :  " : "  cash:") ; superTabItem_Pay.Text=   (arln == 0 ? "  السند المحاسبي  " : "  Accounting bond") ; superTabControl_CostSts.Text=   (arln == 0 ? "  superTabControl3  " : "  superTabControl3") ; label34.Text=   (arln == 0 ? "  الدائـــــن :  " : "  creditor:") ; label35.Text=   (arln == 0 ? "  المـــدين :  " : "  Debtor:") ; checkBox_CostGaidTax.Text=   (arln == 0 ? "  سند محاسبي  " : "  accounting document") ; label36.Text=   (arln == 0 ? "  بالريــــال  " : "  in riyals") ; superTabItem_Tax.Text=   (arln == 0 ? "  الضـــرائب  " : "  taxes") ; label31.Text=   (arln == 0 ? "  إجمالي القيمة  " : "  Total value") ; label37.Text=   (arln == 0 ? "  الدائـــــن :  " : "  creditor:") ; label38.Text=   (arln == 0 ? "  المـــدين :  " : "  Debtor:") ; label39.Text=   (arln == 0 ? "  بالريــــال  " : "  in riyals") ; checkBox_GaidDis.Text=   (arln == 0 ? "  سند محاسبي  " : "  accounting document") ; superTabItem_Dis.Text=   (arln == 0 ? "  الخصـــــم  " : "  discount ال") ; labelItem_TaxByNetPer.Text=   (arln == 0 ? "  %  " : "  %") ; superTabItem_Gaids.Text=   (arln == 0 ? "  القيود  " : "  limitations") ; superTabItem_Note.Text=   (arln == 0 ? "  ملاحظات  " : "  Notes") ; label7.Text=   (arln == 0 ? "  رقم المرجع :  " : "  reference number :") ; label9.Text=   (arln == 0 ? "  صافي الفاتورة :  " : "  net bill:") ; label3.Text=   (arln == 0 ? "  بالريــال  " : "  in riyals") ; label33.Text=   (arln == 0 ? "  الضريبة VAT:  " : "  VAT:") ; label17.Text=   (arln == 0 ? "  قيمة الفاتـــورة :  " : "  Invoice value:") ; Label26.Text=   (arln == 0 ? "  قيمة الخصم  " : "  discount value") ; label8.Text=   (arln == 0 ? "  نسبة الخصم  " : "  discount percentage") ; label5.Text=   (arln == 0 ? "  السعر المعتمــد :  " : "  Approved price:") ; Label1.Text=   (arln == 0 ? "  رقم الفاتورة :  " : "  invoice number :") ; Label2.Text=   (arln == 0 ? "  التاريــــــــخ :  " : "  date:") ; label18.Text=   (arln == 0 ? "  المنـــــدوب :  " : "  The delegate:") ; label11.Text=   (arln == 0 ? "  الايميل  " : "  email") ; label12.Text=   (arln == 0 ? "  هاتف :  " : "  Telephone :") ; label4.Text=   (arln == 0 ? "  حساب العميــل :  " : "  Customer account:") ; label10.Text=   (arln == 0 ? "  اسم العميـــــل :  " : "  Client name:") ; label13.Text=   (arln == 0 ? "  عنوان العميل :  " : "  Customer address:") ; label6.Text=   (arln == 0 ? "   الجوال :  " : "   cell phone :") ; label42.Text=   (arln == 0 ? "  شركة المركبة  " : "  vehicle company") ; label14.Text=   (arln == 0 ? "  اللون  " : "  the color") ; label20.Text=   (arln == 0 ? "  رقم الهيكل  " : "  Structure No") ; label21.Text=   (arln == 0 ? "  رقم المركبة  " : "  Vehicle ID") ; label29.Text=   (arln == 0 ? "  نوع المركبة:  " : "  the type of the vehicle:") ; label32.Text=   (arln == 0 ? "  الموديل  " : "  Model") ; label40.Text=   (arln == 0 ? "  رقم اللوحة  " : "  Plate Number") ; label41.Text=   (arln == 0 ? "  تاريخ التسليم  " : "  delivery date") ; superTabControl_Main1.Text=   (arln == 0 ? "  superTabControl3  " : "  superTabControl3") ; button_Repetition.Text=   (arln == 0 ? "  تكرار  " : "  Repetition") ; Button_Close.Text=   (arln == 0 ? "  إغلاق  " : "  Close") ; /*buttonItem_Print.Text=   (arln == 0 ? "  طباعة  " : "  Print") ;*/ printersettings.Text=   (arln == 0 ? "  اعدادات الطابعه  " : "  printer settings") ; Button_Search.Text=   (arln == 0 ? "  بحث  " : "  Search") ; Button_Delete.Text=   (arln == 0 ? "  حذف  " : "  delete") ; Button_Save.Text=   (arln == 0 ? "  حفظ  " : "  save") ; Button_Add.Text=   (arln == 0 ? "  إضافة  " : "  addition") ; superTabControl_Main2.Text=   (arln == 0 ? "  superTabControl1  " : "  superTabControl1") ; buttonShowKiewd.Text=   (arln == 0 ? "  القيود  " : "  limitations") ; Button_First.Text=   (arln == 0 ? "  الأول  " : "  the first") ; Button_Prev.Text=   (arln == 0 ? "  السابق  " : "  the previous") ; lable_Records.Text=   (arln == 0 ? "  ---  " : "  ---") ; Button_Next.Text=   (arln == 0 ? "  التالي  " : "  next one") ; Button_Last.Text=   (arln == 0 ? "  الأخير  " : "  the last one") ; comboItem1.Text=   (arln == 0 ? "  تحت التنفيذ  " : "  Under implementation") ; comboItem2.Text=   (arln == 0 ? "  تم التنفيذ  " : "  done") ; ToolStripMenuItem_Det.Text=   (arln == 0 ? "  إظهار التفاصيل  " : "  Show details") ; Text = "امر طلب";this.Text=   (arln == 0 ? "  امر طلب  " : "  order order") ;}
...
#pragma warning disable CS0414 // The field 'FrmCarFixingPOSOrders.UnitAOld' is assigned but its value is never used
        private string UnitAOld = "";
#pragma warning restore CS0414 // The field 'FrmCarFixingPOSOrders.UnitAOld' is assigned but its value is never used
#pragma warning disable CS0414 // The field 'FrmCarFixingPOSOrders.UnitEOld' is assigned but its value is never used
        private string UnitEOld = "";
#pragma warning restore CS0414 // The field 'FrmCarFixingPOSOrders.UnitEOld' is assigned but its value is never used
#pragma warning disable CS0414 // The field 'FrmCarFixingPOSOrders.PriceOld' is assigned but its value is never used
        private double PriceOld = 0.0;
#pragma warning restore CS0414 // The field 'FrmCarFixingPOSOrders.PriceOld' is assigned but its value is never used
        private int DefPack = 0;
        private double Pack = 0.0;
        private double PriceLoc = 0.0;
       static int xs = 0;
        public static int LangArEn
        {
            set
            {
                xs = value;
                VarGeneral.UserLang = value;
            }
            get
            {
                return
...
#pragma warning restore CS0219 // The variable 'pack' is assigned but its value is never used
        ...
        private void FrmCustQutation_KeyUp(object sender, System.Windows.Forms.KeyEventArgs e)
        {
            if (e.KeyCode == Keys.ControlKey)
            {
                label24.Visible = false;
...
#pragma warning restore CS0162 // Unreachable code detected
        ...
        private void FlxInv_KeyDown(object sender, System.Windows.Forms.KeyEventArgs e)
        {
        ...
        private void FlxDat_KeyDown(object sender, System.Windows.Forms.KeyEventArgs e)
        {
...
#pragma warning restore CS0219 // The variable 'i' is assigned but its value is never used
        ...
        public  FrmCarPOSLog frmpos;

        private void FrmCarFixingPOSOrders_SizeChanged(object sender, EventArgs e)
        {
