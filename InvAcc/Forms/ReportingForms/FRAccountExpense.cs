...
{ 
  groupBox4.Text=   (arln == 0 ? "  حسب التاريخ  " : "  by date") ; label1.Text=   (arln == 0 ? "  مـــــن :  " : "  from:") ; label2.Text=   (arln == 0 ? "  إلـــــى :  " : "  to:") ; txtLegateName.Text=   (arln == 0 ? "  `  " : "  `") ; txtFromAccName.Text=   (arln == 0 ? "  `  " : "  `") ; txtUserName.Text=   (arln == 0 ? "  `  " : "  `") ; label9.Text=   (arln == 0 ? "  المستخـــدم :  " : "  User:") ; label7.Text=   (arln == 0 ? "  المنـــــدوب :  " : "  The delegate:") ; label5.Text=   (arln == 0 ? "  من حساب :  " : "  from account :") ; groupBox3.Text=   (arln == 0 ? "  الرصيــــد  " : "  balance") ; label3.Text=   (arln == 0 ? "  مـــــن :  " : "  from:") ; label4.Text=   (arln == 0 ? "  أصغر من " : "  Younger than") ; label8.Text=   (arln == 0 ? "  مركز التكلفة :  " : "  cost center:") ; groupBox2.Text=   (arln == 0 ? "  `  " : "  `") ; RButShort.Text=   (arln == 0 ? "  مختصر  " : "  short") ; RButDet.Text=   (arln == 0 ? "  تفصيلي  " : "  detailed") ;}
