...
{
    public partial  class OFrmInvPuchaes : Form
    { void avs(int arln)
...
#pragma warning disable CS0414 // The field 'OFrmInvPuchaes.y' is assigned but its value is never used
        int y = 0;
#pragma warning restore CS0414 // The field 'OFrmInvPuchaes.y' is assigned but its value is never used
...
#pragma warning disable CS0414 // The field 'OFrmInvPuchaes.x' is assigned but its value is never used
        int x = 0;
#pragma warning restore CS0414 // The field 'OFrmInvPuchaes.x' is assigned but its value is never used
        ...
        public OFrmInvPuchaes()
        {
            InitializeComponent();this.Load += langloads;
            xGmesures1.Visible = false;
        ...
        {
            ComponentResourceManager resources = new ComponentResourceManager(typeof(OFrmInvPuchaes));
            if (VarGeneral.CurrentLang.ToString() == "0" || VarGeneral.CurrentLang.ToString() == "")
            {
...
#pragma warning disable CS1998 // This async method lacks 'await' operators and will run synchronously. Consider using the 'await' operator to await non-blocking API calls, or 'await Task.Run(...)' to do CPU-bound work on a background thread.
        private async  void  OFrmInvPuchaes_Load(object sender, EventArgs e)
#pragma warning restore CS1998 // This async method lacks 'await' operators and will run synchronously. Consider using the 'await' operator to await non-blocking API calls, or 'await Task.Run(...)' to do CPU-bound work on a background thread.
        ...
        private void OFrmInvPuchaes_KeyUp(object sender, KeyEventArgs e)
        {
            if (e.KeyCode == Keys.ControlKey)
            {
                label24.Visible = false;
