...
#pragma warning disable CS0169 // The field 'FrmGenAttend.T' is never used
        private string T;
#pragma warning restore CS0169 // The field 'FrmGenAttend.T' is never used
...
#pragma warning restore CS0219 // The variable 'vState' is assigned but its value is never used
        ...
        private void SaveMenual(bool value)
        {
            ...
            List<int> iRows = new List<int>();
            List<T_Attend> attend = new List<T_Attend>();
#pragma warning disable CS0219 // The variable 'vLoop' is assigned but its value is never used
            bool vLoop = false;
#pragma warning restore CS0219 // The variable 'vLoop' is assigned but its value is never used
            DateTime dt;
            for (int i = 0; i < pkeys.Count; i++)
            {
                string query = "SELECT * FROM [dbo].[T_Emp] as [t0] WHERE EmpState = " + 1 + " AND Emp_No = " + pkeys[i] + QStr + " ORDER BY [Emp_No]";
