...
{ 
 panelEx2.Text=   (arln == 0 ? "  Click to collapse  " : "  Click to collapse") ; label36.Text=   (arln == 0 ? "  المعقـــب :  " : "  Commentator:") ; label_lblDaysOfMonth.Text=   (arln == 0 ? "  يخصم من راتب شهر :  " : "  Deducted from one month's salary:") ; label9.Text=   (arln == 0 ? "  الملاحظــــات :  " : "  Notes:") ; label6.Text=   (arln == 0 ? "  الرسوم والأتعاب :  " : "  Fees and fees:") ; label1.Text=   (arln == 0 ? "  نوع المعاملة :  " : "  Type of transaction :") ; label12.Text=   (arln == 0 ? "  الموظف :  " : "  employee:") ; label54.Text=   (arln == 0 ? "  التاريخ :  " : "  Date :") ; label38.Text=   (arln == 0 ? "  الكود :  " : "  Code:") ; superTabControl_Main1.Text=   (arln == 0 ? "  superTabControl3  " : "  superTabControl3") ; Button_Close.Text=   (arln == 0 ? "  إغلاق  " : "  Close") ; Button_Search.Text=   (arln == 0 ? "  بحث  " : "  Search") ; Button_Delete.Text=   (arln == 0 ? "  حذف  " : "  delete") ; Button_Save.Text=   (arln == 0 ? "  حفظ  " : "  save") ; Button_Add.Text=   (arln == 0 ? "  إضافة  " : "  addition") ; superTabControl_Main2.Text=   (arln == 0 ? "  superTabControl1  " : "  superTabControl1") ; Button_First.Text=   (arln == 0 ? "  الأول  " : "  the first") ; Button_Prev.Text=   (arln == 0 ? "  السابق  " : "  the previous") ; lable_Records.Text=   (arln == 0 ? "  ---  " : "  ---") ; Button_Next.Text=   (arln == 0 ? "  التالي  " : "  next one") ; Button_Last.Text=   (arln == 0 ? "  الأخير  " : "  the last one") ; DGV_Main.Text=   (arln == 0 ? " string.Empty " : " string.Empty") ; DGV_Main.Text=   (arln == 0 ? "  جميــع السجــــلات  " : "  All records") ; DGV_Main.Text=   (arln == 0 ? " string.Empty " : " string.Empty") ; panelEx3.Text=   (arln == 0 ? "  Fill Panel  " : "  Fill Panel") ; superTabControl_DGV.Text=   (arln == 0 ? "  superTabControl1  " : "  superTabControl1") ; textBox_search.Text=   (arln == 0 ? "  ...  " : "  ...") ; Button_ExportTable2.Text=   (arln == 0 ? "  تصدير  " : "  Export") ; /*Button_PrintTable.Text=   (arln == 0 ? "  طباعة  " : "  Print") ; */ToolStripMenuItem_Rep.Text=   (arln == 0 ? "  إظهار التقرير  " : "  Show report") ; ToolStripMenuItem_Det.Text=   (arln == 0 ? "  إظهار التفاصيل  " : "  Show details") ; Text = "كــــــرت التعقــــيب";this.Text=   (arln == 0 ? "  كــــــرت التعقــــيب  " : "  Comment card") ;}
       ...
       // private IContainer components = null;
        ...
        private void RibunButtons()
        {
            if (VarGeneral.CurrentLang.ToString() == "0" || VarGeneral.CurrentLang.ToString() == string.Empty)
            {
                ...
                label38.Text = "الكود :";
                textBox_Note.WatermarkText = "ملاحظـــــــات التعقـــيب";
                Text = "كــــــرت التعقــــيب";
            }
            else
            {
        ...
        private void FrmCommentary_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                if (columns_Names_visible.Count == 0)
                {
                    ...
                    columns_Names_visible.Add("warnDate", new ColumnDictinary("التاريخ", "Date", ifDefault: true, string.Empty));
                    ...
                    columns_Names_visible.Add("SalDate", new ColumnDictinary("يخصم من شهر", "Discount From Month", ifDefault: false, string.Empty));
                    columns_Names_visible.Add("Value", new ColumnDictinary("القيمــة", "Value", ifDefault: true, string.Empty));
        ...
        private void Button_ExportTable2_Click(object sender, EventArgs e)
        {
            try
            {
                ExportExcel.ExportToExcel(DGV_Main, "تقرير التعقــيب");
            }
            catch
            {
            }
        ...
        private bool ValidData()
        {
            try
            {
                ...
                {
                    MessageBox.Show((LangArEn == 0) ? "يجب تحديد المعاملة" : "Most Select treatment", VarGeneral.ProdectNam, MessageBoxButtons.OK, MessageBoxIcon.Hand);
