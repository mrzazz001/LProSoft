...
{ 
 label2.Text=   (arln == 0 ? "  إسم المدير :  " : "  Manager name:") ; label5.Text=   (arln == 0 ? "  الفاكــــــــس :  " : "  Fax:") ; label3.Text=   (arln == 0 ? "  الهـــــــــــــــــــــــاتف :  " : "  Phone:") ; label40.Text=   (arln == 0 ? "  إسم الإدارة - انجليزي :  " : "  Department name - English:") ; label36.Text=   (arln == 0 ? "  إسم الإدارة - عربـــي :  " : "  Administration name - Arabic:") ; label38.Text=   (arln == 0 ? "  الرمــــز :  " : "  Code:") ; groupBox1.Text=   (arln == 0 ? "  تأمينات الإدارة الإجتماعية  " : "  social management insurances") ; label_RecordEDate.Text=   (arln == 0 ? "  الرقــــم :  " : "  Number:") ; label_RecordBDate.Text=   (arln == 0 ? "  تاريخ إصدارهــا :  " : "  Release date:") ; label_RecordNo.Text=   (arln == 0 ? "  تاريخ إنتهائهـــا :  " : "  Expiry date:") ; groupBox2.Text=   (arln == 0 ? "  مصلحة الزكاة  " : "  Department of Zakat") ; label1.Text=   (arln == 0 ? "  الرقــــم :  " : "  Number:") ; label4.Text=   (arln == 0 ? "  تاريخ إصدارهــا :  " : "  Release date:") ; label6.Text=   (arln == 0 ? "  تاريخ إنتهائهـــا :  " : "  Expiry date:") ; superTabControl_Main1.Text=   (arln == 0 ? "  superTabControl3  " : "  superTabControl3") ; Button_Close.Text=   (arln == 0 ? "  إغلاق  " : "  Close") ; Button_Search.Text=   (arln == 0 ? "  بحث  " : "  Search") ; Button_Delete.Text=   (arln == 0 ? "  حذف  " : "  delete") ; Button_Save.Text=   (arln == 0 ? "  حفظ  " : "  save") ; Button_Add.Text=   (arln == 0 ? "  إضافة  " : "  addition") ; superTabControl_Main2.Text=   (arln == 0 ? "  superTabControl1  " : "  superTabControl1") ; Button_First.Text=   (arln == 0 ? "  الأول  " : "  the first") ; Button_Prev.Text=   (arln == 0 ? "  السابق  " : "  the previous") ; lable_Records.Text=   (arln == 0 ? "  ---  " : "  ---") ; Button_Next.Text=   (arln == 0 ? "  التالي  " : "  next one") ; Button_Last.Text=   (arln == 0 ? "  الأخير  " : "  the last one") ; panelEx2.Text=   (arln == 0 ? "  Click to collapse  " : "  Click to collapse") ; DGV_Main.Text=   (arln == 0 ? "    " : "    ") ; DGV_Main.Text=   (arln == 0 ? "  جميــع السجــــلات  " : "  All records") ; DGV_Main.Text=   (arln == 0 ? "    " : "    ") ; panelEx3.Text=   (arln == 0 ? "  Fill Panel  " : "  Fill Panel") ; superTabControl_DGV.Text=   (arln == 0 ? "  superTabControl1  " : "  superTabControl1") ; textBox_search.Text=   (arln == 0 ? "  ...  " : "  ...") ; Button_ExportTable2.Text=   (arln == 0 ? "  تصدير  " : "  Export") ; /*Button_PrintTable.Text=   (arln == 0 ? "  طباعة  " : "  Print") ; */ToolStripMenuItem_Rep.Text=   (arln == 0 ? "  إظهار التقرير  " : "  Show report") ; ToolStripMenuItem_Det.Text=   (arln == 0 ? "  إظهار التفاصيل  " : "  Show details") ; Text = "كــــــرت الإدارات";this.Text=   (arln == 0 ? "  كــــــرت الإدارات  " : "  departments card") ;}
...
#pragma warning disable CS0414 // The field 'FrmDept.FlagUpdate' is assigned but its value is never used
        private string FlagUpdate = "";
#pragma warning restore CS0414 // The field 'FrmDept.FlagUpdate' is assigned but its value is never used
       ...
       // private IContainer components = null;
        ...
        private TextBox textBox_ZakaaNo;
        private Label label4;
        private Label label6;
        private MaskedTextBox dateTimeInput_ZakaaBeginDate;
        private MaskedTextBox dateTimeInput_ZakaaEndDate;
        private TextBox textBox_Fax;
        private Label label5;
        private TextBox textBox_Phone;
        private Label label3;
        private TextBoxX textBox_Note;
        private TextBox textBox_BossName;
        ...
        public T_User Permmission
        {
            ...
            set
            {
                ...
                {
                    permission = value;
                    if (!VarGeneral.TString.ChkStatShow(value.Emp_FilStr, 5))
                    {
                        IfAdd = false;
                    }
                    else
                    ...
                    if (!VarGeneral.TString.ChkStatShow(value.Emp_FilStr, 6))
                    {
                        CanEdit = false;
                    }
                    else
                    ...
                    if (!VarGeneral.TString.ChkStatShow(value.Emp_FilStr, 7))
                    {
                        IfDelete = false;
                    }
                    else
        ...
        {
            DGV_Main.PrimaryGrid.VirtualMode = false;
            List<T_Dept> list = db.FillDept_2(textBox_search.TextBox.Text).ToList();
        ...
        public void FillHDGV(IEnumerable<T_Dept> new_data_enum)
        {
            ...
            DGV_Main.PrimaryGrid.DataMember = "T_Dept";
        ...
        {
            PKeys.Clear();
            var qkeys = db.T_Depts.Select((T_Dept item) => new
            {
                Code = item.Dept_No + ""
            });
            int count = 0;
        ...
        public FrmDept()
        {
            ...
            controls.Add(dateTimeInput_ZakaaBeginDate);
            controls.Add(dateTimeInput_ZakaaEndDate);
            controls.Add(textBox_AllownceNo);
            controls.Add(textBox_ZakaaNo);
            controls.Add(textBox_BossName);
            ...
            textBox_BossName.Click += Button_Edit_Click;
            dateTimeInput_AllownceBeginDate.Click += Button_Edit_Click;
            dateTimeInput_AllownceEndDate.Click += Button_Edit_Click;
            dateTimeInput_ZakaaBeginDate.Click += Button_Edit_Click;
            dateTimeInput_ZakaaEndDate.Click += Button_Edit_Click;
            textBox_AllownceNo.Click += Button_Edit_Click;
            textBox_ZakaaNo.Click += Button_Edit_Click;
            ...
            textBox_AllownceNo.Click += textBox_AllownceNo_Click;
            textBox_AllownceNo.KeyPress += textBox_Phone_KeyPress;
            textBox_ZakaaNo.Click += textBox_ZakaaNo_Click;
            textBox_ZakaaNo.KeyPress += textBox_Phone_KeyPress;
            textBox_Note.Click += textBox_Note_Click;
            textBox_BossName.Click += textBox_BossName_Click;
            dateTimeInput_AllownceBeginDate.Click += dateTimeInput_AllownceBeginDate_Click;
            dateTimeInput_AllownceBeginDate.Leave += dateTimeInput_AllownceBeginDate_Leave;
            dateTimeInput_AllownceEndDate.Click += dateTimeInput_AllownceEndDate_Click;
            dateTimeInput_AllownceEndDate.Leave += dateTimeInput_AllownceEndDate_Leave;
            dateTimeInput_ZakaaBeginDate.Click += dateTimeInput_ZakaaBeginDate_Click;
            dateTimeInput_ZakaaBeginDate.Leave += dateTimeInput_ZakaaBeginDate_Leave;
            dateTimeInput_ZakaaEndDate.Click += dateTimeInput_ZakaaEndDate_Click;
            dateTimeInput_ZakaaEndDate.Leave += dateTimeInput_ZakaaEndDate_Leave;
        ...
        {
            ComponentResourceManager resources = new ComponentResourceManager(typeof(FrmDept));
            if (VarGeneral.CurrentLang.ToString() == "0" || VarGeneral.CurrentLang.ToString() == "")
            {
        ...
        private void RibunButtons()
        {
            if (VarGeneral.CurrentLang.ToString() == "0" || VarGeneral.CurrentLang.ToString() == "")
            {
                ...
                label3.Text = "الهاتف :";
                label5.Text = "فاكس :";
                label2.Text = "إسم المدير :";
                textBox_Note.WatermarkText = "ملاحظـــــــات الإدارة";
                Text = "كرت الإدارات";
            }
            else
            {
                ...
                label3.Text = "Phone :";
                label5.Text = "Fax :";
                label2.Text = "Boss Name :";
                textBox_Note.WatermarkText = "Notes";
                Text = "Departments Card";
            }
        }
        private void FrmDept_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    columns_Names_visible.Add("Dept_No", new ColumnDictinary("رقم الإدارة", "Dept No", ifDefault: true, ""));
        ...
        private void textBox_ID_TextChanged(object sender, EventArgs e)
        {
            ...
            try
            {
                T_Dept newData = db.DeptEmp(no);
                if (newData == null || newData.Dept_No == 0 || string.IsNullOrEmpty(newData.Dept_ID))
                {
                    if (!Button_Add.Visible || !Button_Add.Enabled)
                    {
                        ...
                        try
                        {
                            textBox_ID.Text = data_this.Dept_No.ToString();
                        }
                        catch
                        {
                        }
                ...
                {
                    DataThis = newData;
                    int indexA = PKeys.IndexOf(string.Concat(newData.Dept_No));
                    indexA++;
                    TextBox_Index.InputTextChanged -= TextBox_Index_InputTextChanged;
        ...
        public void SetData(T_Dept value)
        {
            try
            {
                State = FormState.Saved;
                ...
                textBox_Phone.Text = value.Phone;
                textBox_Fax.Text = value.Fax;
                textBox_ID.Tag = value.Dept_ID;
                textBox_AllownceNo.Text = value.AllownceNo;
                textBox_ZakaaNo.Text = value.ZakaaNo;
                textBox_BossName.Text = value.BossName;
                try
                {
                ...
                try
                {
                    if (VarGeneral.CheckDate(value.ZakaaBeginDate))
                    {
                        dateTimeInput_ZakaaBeginDate.Text = Convert.ToDateTime(value.ZakaaBeginDate).ToString("yyyy/MM/dd");
                    }
                    else
                    {
                        dateTimeInput_ZakaaBeginDate.Text = "";
                    }
                }
                catch
                {
                ...
                try
                {
                    if (VarGeneral.CheckDate(value.ZakaaEndDate1))
                    {
                        dateTimeInput_ZakaaEndDate.Text = Convert.ToDateTime(value.ZakaaEndDate1).ToString("yyyy/MM/dd");
                    }
                    else
                    {
                        dateTimeInput_ZakaaEndDate.Text = "";
                    }
                }
                catch
                {
        ...
        private T_Dept GetData()
        {
            textBox_ID.Focus();
            try
            {
                data_this.Dept_No = int.Parse(textBox_ID.Text);
            }
            catch
            {
            }
            ...
            try
            {
                data_this.Phone = textBox_Phone.Text;
            }
            catch
            {
            }
            try
            {
                data_this.BossName = textBox_BossName.Text;
            }
            catch
            {
            }
            ...
            try
            {
                data_this.ZakaaNo = textBox_ZakaaNo.Text;
            }
            catch
            {
            }
            ...
            try
            {
                data_this.ZakaaBeginDate = Convert.ToDateTime(dateTimeInput_ZakaaBeginDate.Text).ToString("yyyy/MM/dd");
            }
            catch
            {
                dateTimeInput_ZakaaBeginDate.Text = "";
                data_this.ZakaaBeginDate = "";
            }
            try
            {
                data_this.ZakaaEndDate1 = Convert.ToDateTime(dateTimeInput_ZakaaEndDate.Text).ToString("yyyy/MM/dd");
            }
            catch
            {
                dateTimeInput_ZakaaEndDate.Text = "";
                data_this.ZakaaEndDate1 = "";
            }
            return data_this;
        }
        ...
        private void Button_Save_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (State == FormState.New)
                {
                    ...
                    try
                    {
                        data_this.Dept_ID = textBox_ID.Tag.ToString();
                        db.T_Depts.InsertOnSubmit(data_this);
                        db.SubmitChanges();
                    }
                ...
                State = FormState.Saved;
                RefreshPKeys();
                TextBox_Index.TextBox.Text = string.Concat(PKeys.IndexOf(string.Concat(data_this.Dept_No)) + 1);
                SetReadOnly = true;
            }
            catch (Exception error)
            {
        ...
        private void Button_Delete_Click(object sender, EventArgs e)
        {
            ...
            if (data_this == null || data_this.Dept_No == 0 || string.IsNullOrEmpty(data_this.Dept_ID) || !ifOkDelete)
            {
                return;
            }
            T_Emp returned = db.SelectDeptNoByReturnNo(DataThis.Dept_No);
            int num;
            if (returned != null)
            {
            ...
            if (num == 0)
            {
                MessageBox.Show((LangArEn == 0) ? "لايمكن حذف الإدارة .. لانه مرتبط باحد الموظفين" : "can not be deleted This Department .. because it is linked to one of the employee", VarGeneral.ProdectNam, MessageBoxButtons.OK, MessageBoxIcon.Hand);
                return;
            }
            data_this = db.DeptEmp(DataThis.Dept_No);
            try
            {
                db.T_Depts.DeleteOnSubmit(DataThis);
                db.SubmitChanges();
            }
            catch (SqlException)
            {
        ...
        private void DGV_Main_DataBindingComplete(object sender, GridDataBindingCompleteEventArgs e)
        {
            ...
            if (dataMember != null && dataMember == "T_Dept")
            {
        ...
        private void PropBranchPanel(GridPanel panel)
        {
            ...
            panel.Columns["Dept_No"].Width = 120;
            panel.Columns["Dept_No"].Visible = columns_Names_visible["Dept_No"].IfDefault;
        ...
        private void Button_ExportTable2_Click(object sender, EventArgs e)
        {
            try
            {
                ExportExcel.ExportToExcel(DGV_Main, "تقرير الإدارات");
            }
            catch
            {
            }
        ...
        public void Button_Print_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                string Fields = "";
                Fields = " T_Dept.Dept_No as No, T_Dept.NameA as NmA, T_Dept.NameE as NmE,(select T_SYSSETTING.LogImg from T_SYSSETTING) as LogImg ";
                _RepShow.Rule = "";
        ...
        private void dateTimeInput_ZakaaBeginDate_Click(object sender, EventArgs e)
        {
            dateTimeInput_ZakaaBeginDate.SelectAll();
        }
        private void dateTimeInput_ZakaaEndDate_Click(object sender, EventArgs e)
        {
            dateTimeInput_ZakaaEndDate.SelectAll();
        }
        ...
        private void dateTimeInput_ZakaaBeginDate_Leave(object sender, EventArgs e)
        {
            try
            {
                if (VarGeneral.CheckDate(dateTimeInput_ZakaaBeginDate.Text))
                {
                    dateTimeInput_ZakaaBeginDate.Text = Convert.ToDateTime(dateTimeInput_ZakaaBeginDate.Text).ToString("yyyy/MM/dd");
                }
                else
                {
                    dateTimeInput_ZakaaBeginDate.Text = "";
        ...
        private void dateTimeInput_ZakaaEndDate_Leave(object sender, EventArgs e)
        {
            try
            {
                if (VarGeneral.CheckDate(dateTimeInput_ZakaaEndDate.Text))
                {
                    dateTimeInput_ZakaaEndDate.Text = Convert.ToDateTime(dateTimeInput_ZakaaEndDate.Text).ToString("yyyy/MM/dd");
                }
                else
                {
                    dateTimeInput_ZakaaEndDate.Text = "";
        ...
        private void textBox_ZakaaNo_Click(object sender, EventArgs e)
        {
            textBox_ZakaaNo.SelectAll();
        }
        ...
        private void textBox_BossName_Click(object sender, EventArgs e)
        {
            textBox_BossName.SelectAll();
        }
    }
}
