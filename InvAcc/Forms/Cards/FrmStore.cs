...
{ 
 panelEx2.Text=   (arln == 0 ? "  Click to collapse  " : "  Click to collapse") ; label40.Text=   (arln == 0 ? "  إسم المستودع - انجليزي :  " : "  Warehouse Name - English:") ; label36.Text=   (arln == 0 ? "  إسم المستودع - عربي :  " : "  Warehouse Name - Arabic:") ; label38.Text=   (arln == 0 ? "  الرمـــز :  " : "  Code:") ; label8.Text=   (arln == 0 ? "  ملاحظــــــــــــــات :  " : "  Notes:") ; label7.Text=   (arln == 0 ? "  الفاكس :  " : "  Fax:") ; label6.Text=   (arln == 0 ? "  الهاتــــــــــــف :  " : "  Phone:") ; label5.Text=   (arln == 0 ? "  المدينة :  " : "  City :") ; label4.Text=   (arln == 0 ? "  العنــــــــــــــوان :  " : "  Address:") ; superTabControl_Main1.Text=   (arln == 0 ? "  superTabControl3  " : "  superTabControl3") ; Button_Close.Text=   (arln == 0 ? "  إغلاق  " : "  Close") ; Button_Search.Text=   (arln == 0 ? "  بحث  " : "  Search") ; Button_Delete.Text=   (arln == 0 ? "  حذف  " : "  delete") ; Button_Save.Text=   (arln == 0 ? "  حفظ  " : "  save") ; Button_Add.Text=   (arln == 0 ? "  إضافة  " : "  addition") ; superTabControl_Main2.Text=   (arln == 0 ? "  superTabControl1  " : "  superTabControl1") ; Button_First.Text=   (arln == 0 ? "  الأول  " : "  the first") ; Button_Prev.Text=   (arln == 0 ? "  السابق  " : "  the previous") ; lable_Records.Text=   (arln == 0 ? "  ---  " : "  ---") ; Button_Next.Text=   (arln == 0 ? "  التالي  " : "  next one") ; Button_Last.Text=   (arln == 0 ? "  الأخير  " : "  the last one") ; panelEx3.Text=   (arln == 0 ? "  Fill Panel  " : "  Fill Panel") ; DGV_Main.Text=   (arln == 0 ? " string.Empty " : " string.Empty") ; DGV_Main.Text=   (arln == 0 ? "  جميــع السجــــلات  " : "  All records") ; DGV_Main.Text=   (arln == 0 ? " string.Empty " : " string.Empty") ; superTabControl_DGV.Text=   (arln == 0 ? "  superTabControl1  " : "  superTabControl1") ; textBox_search.Text=   (arln == 0 ? "  ...  " : "  ...") ; Button_ExportTable2.Text=   (arln == 0 ? "  تصدير  " : "  Export") ; /*Button_PrintTable.Text=   (arln == 0 ? "  طباعة  " : "  Print") ; */ToolStripMenuItem_Rep.Text=   (arln == 0 ? "  إظهار التقرير  " : "  Show report") ; ToolStripMenuItem_Det.Text=   (arln == 0 ? "  إظهار التفاصيل  " : "  Show details") ; Text = "كرت المستودعــــات";this.Text=   (arln == 0 ? "  كرت المستودعــــات  " : "  warehouse card") ;}
       ...
       // private IContainer components = null;
        ...
        void ArbEng()
        {
            label4.Text = (LangArEn == 0 ? "العنوان" : "Address:");
            label6.Text = (LangArEn == 0 ? "الهاتف" : "Phone:");
            label8.Text = (LangArEn == 0 ? "الملاحظات" : "Notes:");
            label7.Text = (LangArEn == 0 ? "الفاكس" : "Fax:");
            label5.Text = (LangArEn == 0 ? "المدينة" : "City:");
        }
        public FrmStore()
        {
