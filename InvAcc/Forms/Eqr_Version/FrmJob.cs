...
#pragma warning disable CS0414 // The field 'FrmJob.FlagUpdate' is assigned but its value is never used
        private string FlagUpdate = "";
#pragma warning restore CS0414 // The field 'FrmJob.FlagUpdate' is assigned but its value is never used
        ...
        private void RibunButtons()
        {
            if (VarGeneral.CurrentLang.ToString() == "0" || VarGeneral.CurrentLang.ToString() == "")
            {
                ...
                textBox_Note.WatermarkText = "ملاحظـــــــات الوظيفة";
                Text = "كرت الوظــــــائف";
            }
            else
            {
        ...
        private void FrmJob_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    columns_Names_visible.Add("Job_No", new ColumnDictinary("رقم الوظيفــة", "Job No", ifDefault: true, ""));
        ...
        private void Button_ExportTable2_Click(object sender, EventArgs e)
        {
            try
            {
                ExportExcel.ExportToExcel(DGV_Main, "تقرير الوظائـــــف");
            }
            catch
            {
            }
