...
#pragma warning disable CS0414 // The field 'FrmTel.Pas' is assigned but its value is never used
        private bool Pas;
#pragma warning restore CS0414 // The field 'FrmTel.Pas' is assigned but its value is never used
        private string Ps;
        private int Op;
#pragma warning disable CS0414 // The field 'FrmTel.M' is assigned but its value is never used
        private int M;
#pragma warning restore CS0414 // The field 'FrmTel.M' is assigned but its value is never used
#pragma warning disable CS0169 // The field 'FrmTel.R1' is never used
        private int R1;
#pragma warning restore CS0169 // The field 'FrmTel.R1' is never used
#pragma warning disable CS0169 // The field 'FrmTel.R2' is never used
        private int R2;
#pragma warning restore CS0169 // The field 'FrmTel.R2' is never used
#pragma warning disable CS0169 // The field 'FrmTel.R3' is never used
        private int R3;
#pragma warning restore CS0169 // The field 'FrmTel.R3' is never used
#pragma warning disable CS0414 // The field 'FrmTel.vChk' is assigned but its value is never used
        private bool vChk;
#pragma warning restore CS0414 // The field 'FrmTel.vChk' is assigned but its value is never used
        ...
        private void FrmTel_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    columns_Names_visible.Add("ID", new ColumnDictinary("رقم الفاتورة", "Inv No", ifDefault: true, string.Empty));
                    columns_Names_visible.Add("perno", new ColumnDictinary("رقم النزيل", "Guest No", ifDefault: true, string.Empty));
                    columns_Names_visible.Add("romno", new ColumnDictinary("رقم الغرفة", "Room Np", ifDefault: true, string.Empty));
                    columns_Names_visible.Add("price", new ColumnDictinary("المبلغ المطلوب", "Value", ifDefault: true, string.Empty));
                }
                else
                {
                    Clear();
