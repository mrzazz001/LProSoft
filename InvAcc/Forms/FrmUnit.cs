...
#pragma warning disable CS0414 // The field 'FrmUnit.FlagUpdate' is assigned but its value is never used
        private string FlagUpdate = "";
#pragma warning restore CS0414 // The field 'FrmUnit.FlagUpdate' is assigned but its value is never used
        ...
        {
            DGV_Main.PrimaryGrid.VirtualMode = false;
            List<T_Unit> list = db.FillUnit_2(textBox_search.TextBox.Text).ToList();
        ...
        public void FillHDGV(IEnumerable<T_Unit> new_data_enum)
        {
            ...
            DGV_Main.PrimaryGrid.DataMember = "T_Unit";
        ...
        {
            PKeys.Clear();
            var qkeys = db.T_Units.Select((T_Unit item) => new
            {
                Code = item.Unit_No + ""
            });
            int count = 0;
        ...
        {
            ComponentResourceManager resources = new ComponentResourceManager(typeof(FrmUnit));
            if (VarGeneral.CurrentLang.ToString() == "0" || VarGeneral.CurrentLang.ToString() == "")
            {
        ...
        private void FrmUnit_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    columns_Names_visible.Add("Unit_No", new ColumnDictinary("رقم الوحدة", "Unit No", ifDefault: true, ""));
        ...
        private void textBox_ID_TextChanged(object sender, EventArgs e)
        {
            ...
            try
            {
                T_Unit newData = db.StockUnit(no.ToString());
                if (newData == null || newData.Unit_ID == 0)
                {
                    if (!Button_Add.Visible || !Button_Add.Enabled)
                    {
                        ...
                        try
                        {
                            textBox_ID.Text = data_this.Unit_No;
                        }
                        catch
                        {
                        }
                ...
                {
                    DataThis = newData;
                    int indexA = PKeys.IndexOf(newData.Unit_No ?? "");
                    indexA++;
                    TextBox_Index.InputTextChanged -= TextBox_Index_InputTextChanged;
        ...
        public void SetData(T_Unit value)
        {
            try
            {
                State = FormState.Saved;
                Button_Save.Enabled = false;
                textBox_ID.Tag = value.Unit_ID;
        ...
        private T_Unit GetData()
        {
            textBox_ID.Focus();
            try
            {
                data_this.Unit_No = textBox_ID.Text;
            }
            catch
            {
            }
        ...
        private void Button_Save_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (State == FormState.New)
                {
                    ...
                    try
                    {
                        db.T_Units.InsertOnSubmit(data_this);
                        db.SubmitChanges();
                    }
                    catch (SqlException ex3)
                    {
                        ...
                        data_this.Unit_No = string.Concat(max);
                        Button_Save_Click(sender, e);
                    }
                    catch (Exception)
                    {
                ...
                State = FormState.Saved;
                RefreshPKeys();
                TextBox_Index.TextBox.Text = string.Concat(PKeys.IndexOf(data_this.Unit_No ?? "") + 1);
                SetReadOnly = true;
            }
            catch (Exception error)
            {
        ...
        private void Button_Delete_Click(object sender, EventArgs e)
        {
            ...
            if (data_this == null || data_this.Unit_ID == 0 || !ifOkDelete)
            {
                return;
            }
            T_Item returned = db.SelectUnitNoByReturnNo(DataThis.Unit_ID);
            ...
            data_this = db.StockUnit(DataThis.Unit_No.ToString());
            try
            {
                db.T_Units.DeleteOnSubmit(DataThis);
                db.SubmitChanges();
            }
            catch (SqlException)
            {
        ...
        private void DGV_Main_DataBindingComplete(object sender, GridDataBindingCompleteEventArgs e)
        {
            ...
            if (dataMember != null && dataMember == "T_Unit")
            {
        ...
        private void PropBranchPanel(GridPanel panel)
        {
            ...
            panel.Columns["Unit_No"].Width = 200;
            panel.Columns["Unit_No"].Visible = columns_Names_visible["Unit_No"].IfDefault;
            panel.ReadOnly = true;
        }
        ...
        private void Button_ExportTable2_Click(object sender, EventArgs e)
        {
            try
            {
                ExportExcel.ExportToExcel(DGV_Main, "تقرير الوحدات");
            }
            catch
            {
            }
        ...
        public void Button_Print_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                _RepShow.Tables = " T_Unit left join T_SYSSETTING on T_SYSSETTING.SYSSETTING_ID = T_Unit.CompanyID ";
                string Fields = "";
                Fields = " T_Unit.Unit_No as No, T_Unit.Arb_Des as NmA, T_Unit.Eng_Des as NmE,T_SYSSETTING.LogImg ";
                _RepShow.Rule = "";
        ...
        {
            superTabControl_Main1.Font = new System.Drawing.Font("Tahoma", 8F); superTabControl_Main2.Font = new System.Drawing.Font("Tahoma", 8F);
        }
