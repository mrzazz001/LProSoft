...
#pragma warning disable CS0414 // The field 'FrmTransferOut.UnitAOld' is assigned but its value is never used
        private string UnitAOld = "";
#pragma warning restore CS0414 // The field 'FrmTransferOut.UnitAOld' is assigned but its value is never used
#pragma warning disable CS0414 // The field 'FrmTransferOut.UnitEOld' is assigned but its value is never used
        private string UnitEOld = "";
#pragma warning restore CS0414 // The field 'FrmTransferOut.UnitEOld' is assigned but its value is never used
#pragma warning disable CS0414 // The field 'FrmTransferOut.PriceOld' is assigned but its value is never used
        private double PriceOld = 0.0;
#pragma warning restore CS0414 // The field 'FrmTransferOut.PriceOld' is assigned but its value is never used
 ...
 dbHead.ExecuteNonQuery(storedProcedure: true, "S_T_INVHED_UPDATE");
        ...
        private void Save_Reverse()
        {
            try
            {
                ...
                data_this_Revers.EngTaf = ScriptNumber1.TafEng(decimal.Parse(VarGeneral.TString.TEmpty(txtDueAmountLoc.Text ?? "")));
