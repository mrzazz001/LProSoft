...
{ 
 label_lblDaysOfMonth.Text=   (arln == 0 ? "  يخصم من راتب شهر :  " : "  Deducted from one month's salary:") ; label9.Text=   (arln == 0 ? "  الملاحظــــات :  " : "  Notes:") ; label6.Text=   (arln == 0 ? "  قيمة المكالمة :  " : "  Call value:") ; label12.Text=   (arln == 0 ? "  الموظـــــــــف :  " : "  The employee:") ; label54.Text=   (arln == 0 ? "  التاريخ :  " : "  Date :") ; label38.Text=   (arln == 0 ? "  الكود :  " : "  Code:") ; superTabControl_Main1.Text=   (arln == 0 ? "  superTabControl3  " : "  superTabControl3") ; Button_Close.Text=   (arln == 0 ? "  إغلاق  " : "  Close") ; Button_Search.Text=   (arln == 0 ? "  بحث  " : "  Search") ; Button_Delete.Text=   (arln == 0 ? "  حذف  " : "  delete") ; Button_Save.Text=   (arln == 0 ? "  حفظ  " : "  save") ; Button_Add.Text=   (arln == 0 ? "  إضافة  " : "  addition") ; superTabControl_Main2.Text=   (arln == 0 ? "  superTabControl1  " : "  superTabControl1") ; Button_First.Text=   (arln == 0 ? "  الأول  " : "  the first") ; Button_Prev.Text=   (arln == 0 ? "  السابق  " : "  the previous") ; lable_Records.Text=   (arln == 0 ? "  ---  " : "  ---") ; Button_Next.Text=   (arln == 0 ? "  التالي  " : "  next one") ; Button_Last.Text=   (arln == 0 ? "  الأخير  " : "  the last one") ; panelEx2.Text=   (arln == 0 ? "  Click to collapse  " : "  Click to collapse") ; DGV_Main.Text=   (arln == 0 ? "    " : "    ") ; DGV_Main.Text=   (arln == 0 ? "  جميــع السجــــلات  " : "  All records") ; DGV_Main.Text=   (arln == 0 ? "    " : "    ") ; panelEx3.Text=   (arln == 0 ? "  Fill Panel  " : "  Fill Panel") ; superTabControl_DGV.Text=   (arln == 0 ? "  superTabControl1  " : "  superTabControl1") ; textBox_search.Text=   (arln == 0 ? "  ...  " : "  ...") ; Button_ExportTable2.Text=   (arln == 0 ? "  تصدير  " : "  Export") ; /*Button_PrintTable.Text=   (arln == 0 ? "  طباعة  " : "  Print") ; */ToolStripMenuItem_Rep.Text=   (arln == 0 ? "  إظهار التقرير  " : "  Show report") ; ToolStripMenuItem_Det.Text=   (arln == 0 ? "  إظهار التفاصيل  " : "  Show details") ; Text = "كــــــرت المكالمات الهاتفيـــــة";this.Text=   (arln == 0 ? "  كــــــرت المكالمات الهاتفيـــــة  " : "  Card phone calls") ;}
...
#pragma warning disable CS0414 // The field 'FrmCallPhone.FlagUpdate' is assigned but its value is never used
        private string FlagUpdate = "";
#pragma warning restore CS0414 // The field 'FrmCallPhone.FlagUpdate' is assigned but its value is never used
