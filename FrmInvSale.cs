...
{
    public partial  class FrmInvSale : Binv
    { 
...
#pragma warning restore CS1998 // This async method lacks 'await' operators and will run synchronously. Consider using the 'await' operator to await non-blocking API calls, or 'await Task.Run(...)' to do CPU-bound work on a background thread.
        {
            ...
            if (VarGeneral.SSSLev == "B" || VarGeneral.SSSLev == "F" || VarGeneral.SSSLev == "S" || VarGeneral.SSSLev == "C")
            {
                ...
                if (VarGeneral.SSSLev == "F")
                {
                    ...
                    label40.Visibility = DevExpress.XtraLayout.Utils.LayoutVisibility.Never;
                }
            }
            else
            {
                CmbCostC.Visible = true;
                label15.Visibility = DevExpress.XtraLayout.Utils.LayoutVisibility.Always;
...
#pragma warning restore CS1998 // This async method lacks 'await' operators and will run synchronously. Consider using the 'await' operator to await non-blocking API calls, or 'await Task.Run(...)' to do CPU-bound work on a background thread.
        {
...

           {
                ...
                if (VarGeneral.SSSTyp == 0)
                {
                    ...
                    {
                        label4.Visibility = DevExpress.XtraLayout.Utils.LayoutVisibility.Never;
        ...
        private void MaintenanceCars()
        {
            ...
            label12.Visibility = DevExpress.XtraLayout.Utils.LayoutVisibility.Never;
        ...
        {
            label5.Visibility = DevExpress.XtraLayout.Utils.LayoutVisibility.Never;
